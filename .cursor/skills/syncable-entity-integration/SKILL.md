...
description: Wire syncable entity services into NestJS modules, create service layer and resolvers for BeeAX entities. Use when registering builders, validators, and action handlers in modules, creating business services, or exposing entities via GraphQL API with proper exception handling.
---
