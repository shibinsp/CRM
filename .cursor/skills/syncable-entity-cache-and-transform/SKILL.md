...
description: Create cache services and transformation utilities for syncable entities in BeeAX. Use when implementing entity-to-flat conversions, input DTO transpilation to universal flat entities, or cache recomputation for syncable entities.
---
...
import { WorkspaceCache } from 'src/engine/beeax-orm/decorators/workspace-cache.decorator';
...
```typescript
import { v4 } from 'uuid';
import { sanitizeString } from 'beeax-shared/string';
