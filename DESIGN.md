# BeeAX Website — DESIGN.md

> Visual system for the BeeAX marketing site. Distilled from `packages/beeax-website/src/theme/`. Loaded by every `impeccable` invocation alongside PRODUCT.md.
