...
import { DEFAULT_API_URL_NAME } from 'beeax-shared/application';
...
import twentyClientTemplateSource from './beeax-client-template.ts?raw';
...
// an installed beeax-client-sdk package (dist/core.mjs and dist/core.cjs).
