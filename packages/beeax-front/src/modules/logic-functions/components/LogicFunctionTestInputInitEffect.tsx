...
import { jsonSchemaToInputSchema } from 'beeax-shared/logic-function';
import { isDefined } from 'beeax-shared/utils';
import { getFunctionInputFromInputSchema } from 'beeax-shared/workflow';
...
export const LogicFunctionTestInputInitEffect = ({
  ...
  // Prefer the workflow action schema (already in BeeAX's InputSchema form)
