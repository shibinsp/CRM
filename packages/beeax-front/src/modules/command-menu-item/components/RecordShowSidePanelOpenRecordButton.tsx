...
import { CoreObjectNameSingular, AppPath } from 'beeax-shared/types';
...
import { IconBrowserMaximize } from 'beeax-ui/icon';
import { Button } from 'beeax-ui/input';
import { getOsControlSymbol } from 'beeax-ui/utilities';
