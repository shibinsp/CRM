...
import { extractRawVariableNamePart } from 'beeax-shared/workflow';
import { IconChevronLeft, useIcons } from 'beeax-ui/icon';
import { OverflowingTextWithTooltip } from 'beeax-ui/surfaces';
import { MenuItemSelect } from 'beeax-ui/navigation';
