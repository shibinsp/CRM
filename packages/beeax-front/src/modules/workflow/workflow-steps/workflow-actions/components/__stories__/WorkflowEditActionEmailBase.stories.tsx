...
import { ComponentDecorator, RouterDecorator } from 'beeax-ui/testing';
...
const CONFIGURED_SEND_EMAIL_ACTION: WorkflowSendEmailAction = {
  ...
  settings: {
    input: {
      ...
      subject: 'Welcome to BeeAX!',
      body: 'Dear Tim,\n\nWelcome to BeeAX! We are excited to have you on board.\n\nBest regards,\nThe Team',
      files: [],
      inReplyTo: '',
    },
    outputSchema: {},
...
export const Configured: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const emailInput = await canvas.findByText('test@beeax.com');
    expect(emailInput).toBeVisible();

    const subjectInput = await canvas.findByText('Welcome to BeeAX!');
