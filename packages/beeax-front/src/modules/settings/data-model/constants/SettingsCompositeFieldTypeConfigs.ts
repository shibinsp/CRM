...
//TODO : isIncludedInUniqueConstraint refactor - https://github.com/beeax/core-team-issues/issues/1097
...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@beeax.com',
        additionalEmails: [
          'tim@beeax.com',
          'timapple@beeax.com',
          'johnappletim@beeax.com',
        ],
      },
      {
        primaryEmail: 'jane@beeax.com',
        additionalEmails: ['jane@beeax.com', 'jane.doe@beeax.com'],
      },
      {
        primaryEmail: 'john@beeax.com',
        additionalEmails: ['john.doe@beeax.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'beeax.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'beeax.com', label: 'BeeAX' }],
      },
      {
        primaryLinkUrl: 'github.com/beeax/beeax',
        primaryLinkLabel: 'BeeAX Repo',
        secondaryLinks: [{ url: 'beeax.com', label: '' }],
      },
      {
