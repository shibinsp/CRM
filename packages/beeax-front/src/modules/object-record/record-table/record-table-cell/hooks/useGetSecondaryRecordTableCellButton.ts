...
import { FieldMetadataSettingsOnClickAction } from 'beeax-shared/types';
import { ensureAbsoluteUrl, isDefined } from 'beeax-shared/utils';
import { IconArrowUpRight, IconCopy, IconMail } from 'beeax-ui/icon';
