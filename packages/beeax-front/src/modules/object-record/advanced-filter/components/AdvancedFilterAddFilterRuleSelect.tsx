...
import { RecordFilterGroupLogicalOperator } from 'beeax-shared/types';
import { getFilterTypeFromFieldType, isDefined } from 'beeax-shared/utils';
import { IconLibraryPlus, IconPlus } from 'beeax-ui/icon';
