...
import { CoreObjectNameSingular, FieldMetadataType } from 'beeax-shared/types';
...
import { CustomError, isDefined } from 'beeax-shared/utils';
import { IconForbid, IconPencil } from 'beeax-ui/icon';
