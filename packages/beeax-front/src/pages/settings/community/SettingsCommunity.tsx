    ...
    >
      <SettingsPageContainer>
        ...
        <Section>
          <H2Title
            title={t`Partners`}
            description={t`Hire a partner to help you implement and customize BeeAX.`}
          />
          <StyledCardLink
            href="https://beeax.com/partners/list"
            target="_blank"
            rel="noopener noreferrer"
          >
            <SettingsCard
