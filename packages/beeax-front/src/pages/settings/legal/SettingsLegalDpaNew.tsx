...
export const SettingsLegalDpaNew = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await downloadFile(
        result.downloadUrl,
        `BeeAX-DPA-${result.agreement.templateVersion}-${safeLegalEntityName}.pdf`,
      );
      ...
      <SettingsPageContainer>
        ...
        <Section>
          <H2Title
            ...
            description={t`The PDF is pre-signed by BeeAX and executed with your legal entity and authorized signatory.`}
          />
          <SettingsTextInput
