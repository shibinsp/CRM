...
import { ModalContent } from 'beeax-ui/surfaces';
import { useHotkeysOnFocusedElement } from '@/ui/utilities/hotkey/hooks/useHotkeysOnFocusedElement';
import { t } from '@lingui/core/macro';
import { AppPath, ConnectedAccountProvider } from 'beeax-shared/types';
import { IconGoogle, IconMicrosoft } from 'beeax-ui/icon';
import { MainButton } from 'beeax-ui/input';
import { ClickToActionLink } from 'beeax-ui/navigation';
...
export const SyncEmails = () => {
  ...
  return (
    <ModalContent isVerticallyCentered isHorizontallyCentered>
      ...
      <SubTitle>
        {t`Sync your Emails and Calendar with BeeAX. Choose your privacy settings.`}
      </SubTitle>
