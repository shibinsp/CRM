# BeeAX Helm Chart - Quick Install
...
- Create the PostgreSQL database "beeax" and schema "core" automatically
...
```bash
kubectl get secret tokens -n beeaxcrm -o jsonpath='{.data.accessToken}' | base64 --decode && echo
```
...
```bash
helm uninstall my-beeax -n beeaxcrm
kubectl delete namespace beeaxcrm
```
