    ...
    <SectionShell rhythm="hero" scheme="light">
      <HeaderStack>
        ...
        <Heading as="h1" size="lg" weight="light">
          {i18n._(msg`Find your *BeeAX partner*`)}
        </Heading>
        <HeaderBody>
          <Body muted size="md">
            {i18n._(
              msg`BeeAX's certified partners help teams migrate, customise, and operate the open source CRM across regions, languages, and deployment models. Browse profiles and book a call.`,
            )}
          </Body>
        </HeaderBody>
      </HeaderStack>
