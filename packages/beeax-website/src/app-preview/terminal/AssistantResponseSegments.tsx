...
const buildCustomerParagraph = (
  ...
  text(
    ' object that ships with BeeAX, so accounts, domain favicons, and the People relation work for free. ',
  ),
...
const WRAPUP_PARAGRAPH: StreamingSegment[] = [
  ...
  text(', and '),
  node('w-dev', <InlineCode>yarn beeax dev --once</InlineCode>),
  text('. Reference: '),
  node(
    'w-docs',
    <ReferenceLink
      href="https://beeax.com/developers"
      onClick={(event) => event.preventDefault()}
    >
      BeeAX app-building docs
    </ReferenceLink>,
  ),
  text('.'),
];
