...
export const DIFF_FILES: DiffFile[] = [
  {
    ...
    path: '…my-beeax-app/src/constants/schema-identifiers.ts',
    added: 84,
    removed: 0,
    chunks: [
      {
  ...
  {
    id: 'launch-object',
    path: '…my-beeax-app/src/objects/launch.object.ts',
    added: 237,
    removed: 0,
    chunks: [
      {
  ...
  {
    id: 'payload-object',
    path: '…my-beeax-app/src/objects/payload.object.ts',
    added: 198,
    removed: 0,
    chunks: [
      {
  ...
  {
    id: 'rocket-object',
    path: '…my-beeax-app/src/objects/rocket.object.ts',
    added: 28,
    removed: 32,
    chunks: [
  ...
  },
  {
    ...
    path: '…my-beeax-app/src/views/upcoming-launches.view.ts',
    added: 82,
    removed: 0,
    chunks: [
      {
  ...
  },
  {
    ...
    path: '…my-beeax-app/src/__tests__/schema.integration-test.ts',
    added: 412,
    removed: 40,
    chunks: [
