...
// old editor-data (30 files of authored beeax-sdk source fiction).
...
const rocketObjectSource = `import { defineObject, FieldType, RelationType } from 'beeax-sdk/define';
...
export default defineObject({
  ...
  fields: [
    ...
    },
    {
      ...
      // Customer object — we reuse what ships with BeeAX).
...
const launchSiteObjectSource = `import { defineObject, FieldType, RelationType } from 'beeax-sdk/define';
...
const launchesViewSource = `import { defineView, ViewKey } from 'beeax-sdk/define';
...
const rocketsViewSource = `import { defineView, ViewKey } from 'beeax-sdk/define';
...
const payloadsViewSource = `import { defineView, ViewKey } from 'beeax-sdk/define';
...
const launchSitesViewSource = `import { defineView, ViewKey } from 'beeax-sdk/define';
...
const applicationConfigSource = `import { defineApplication } from 'beeax-sdk/define';
