...
const DEFAULT_IMAGE_FILE_NAME = 'beeax-logo.svg';
const DEFAULT_IMAGE_LABEL = 'BeeAX image';
const REACT_EXPORT_SETTING_OPTIONS: Array<{
  ...
  },
  {
    ...
    description:
      'Wraps the mount node with a StyledVisualMount using @linaria/react and keeps the BeeAX-ready mount shape.',
  },
  {
    key: 'includeUseClientDirective',
    label: "Add 'use client'",
    description:
      'Prepends the Next.js client directive so the exported component can be dropped into the BeeAX website directly.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Exports both a named component and a default export to match the current BeeAX illustration import pattern.',
  },
  {
    key: 'includeRegistryComment',
    label: 'Add BeeAX header comment',
    description:
