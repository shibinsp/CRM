...
describe('halftone export naming', () => {
  ...
  it('sanitizes generated React component identifiers for the default BeeAX export', () => {
...
describe('halftone react export presets', () => {
  it('emits a BeeAX-ready GLB export with Draco support and no torus fallback', () => {
    const output = HALFTONE_EXPORTERS.generateReactComponent(
      DEFAULT_HALFTONE_SETTINGS,
      IMPORTED_GLB_SHAPE,
      'PartnerConnect',
  ...
  it('emits a BeeAX-ready image export without model loaders', () => {
  ...
  it('parses BeeAX exports with header comments and named/default exports', () => {
    const output = HALFTONE_EXPORTERS.generateReactComponent(
      DEFAULT_HALFTONE_SETTINGS,
      IMPORTED_GLB_SHAPE,
      'PartnerConnect',
