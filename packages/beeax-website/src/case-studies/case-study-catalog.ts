...
export const CASE_STUDY_CATALOG: readonly CaseStudyCatalogEntry[] = [
  {
    ...
    summary: msg`Nine Dots put BeeAX at the center of Homeseller's stack with APIs, automation, and AI on top of WhatsApp-heavy operations.`,
    date: msg`Jul 2025`,
    readingTime: '9 min',
  ...
  },
  {
    ...
    title: msg`From Salesforce to self-hosted BeeAX`,
    summary: msg`Alternative Partners replaced Salesforce with self-hosted BeeAX, using agentic AI to compress migration work.`,
    date: msg`2025`,
    readingTime: '7 min',
  ...
  },
  {
    ...
    summary: msg`NetZero uses BeeAX as a modular CRM across product lines and countries, with a roadmap into AI-assisted workflows.`,
    date: msg`2025`,
    readingTime: '8 min',
  ...
  },
  {
    ...
    summary: msg`AC&T and Flycoder moved from a dead vendor export to self-hosted BeeAX, with over 90% lower CRM cost and full control.`,
    date: msg`2025`,
    readingTime: '7 min',
  ...
  },
  {
    ...
    summary: msg`W3villa shipped W3Grads on BeeAX for AI interviews, scoring, and institution-scale workflows without rebuilding CRM plumbing.`,
    date: msg`2025`,
    readingTime: '8 min',
  ...
  },
  {
    ...
    title: msg`BeeAX as the API backbone of a go-to-market stack`,
    summary: msg`Elevate Consulting uses BeeAX as the API backbone connecting billing, Teams, resourcing, and a custom front end around client and opportunity data.`,
    date: msg`Jun 2025`,
    readingTime: '8 min',
