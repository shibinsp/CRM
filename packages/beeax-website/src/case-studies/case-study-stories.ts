...
export const CASE_STUDY_STORIES: Record<string, CaseStudyStory> = {
  '9dots': {
    meta: {
      title: msg`Homeseller, WhatsApp, and a CRM built around the business | Nine Dots & BeeAX`,
      description: msg`How Nine Dots Ventures rebuilt a Singapore real estate agency on BeeAX with APIs, n8n, Grafana, and AI on top of 2,000+ WhatsApp messages a day.`,
    },
    ...
    sections: [
      {
        ...
        callout: {
          text: msg`BeeAX lets us build a CRM around the business and not the business around the CRM.`,
          author: 'Mike Babiy',
      ...
      },
      {
        ...
        paragraphs: [
          msg`Nine Dots rebuilt Homeseller's operations on BeeAX, with a custom data model shaped around their sales flow. Because BeeAX is open and everything is accessible via API, they connected it to what the business actually needed: n8n for automated workflows (in-app workflows were not available at that time), Grafana for live dashboards fed from BeeAX, and a custom AI layer to parse and extract structured insights from more than 2,000 WhatsApp messages a day.`,
        ...
        callout: {
          text: msg`BeeAX is the heart of the system. Everything branches from it.`,
  ...
  'alternative-partners': {
    meta: {
      title: msg`From Salesforce to self-hosted BeeAX, powered by AI | Alternative Partners`,
      description: msg`How Alternative Partners migrated from Salesforce to self-hosted BeeAX using agentic AI in the implementation loop: fast migration, durable ownership.`,
    },
    ...
    sections: [
      {
        ...
        paragraphs: [
          msg`Alternative Partners is a consulting firm that moved from Salesforce to a self-hosted BeeAX instance. Benjamin Reynolds led the migration. He had already become a BeeAX expert implementing BeeAX for one of BeeAX's first cloud customers.`,
  ...
  netzero: {
    meta: {
      title: msg`A CRM that grows with you | NetZero & BeeAX`,
      description: msg`How NetZero uses BeeAX across carbon credits, agricultural products, and franchised industrial systems with a modular CRM and a roadmap toward AI-assisted workflows.`,
    },
    ...
    sections: [
      {
        ...
        callout: {
          text: msg`BeeAX delivers on what CRMs should have always been: fairly priced software with a fully modular and customizable model, a clean and modern UI, granular permissions, automations, enterprise features. A compelling solution with high potential to rightfully disrupt the CRM market.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          msg`With BeeAX, when a new need appears, he can address it himself: no developer required, no support ticket.`,
        ],
        callout: {
      ...
      },
      {
        ...
        paragraphs: [
          msg`Olivier recognizes that NetZero's current use of BeeAX is still relatively simple: workflows and integrations are not yet as deep as he eventually wants, because he prioritized getting foundations right first.`,
          msg`What is planned is significant. NetZero has a data lake, online forms, and multiple internal systems that he wants to connect to BeeAX. The pipes are there; the next step is automations that tie them together.`,
      ...
      },
      {
        ...
        paragraphs: [
          msg`While NetZero still runs a second CRM in parallel for WhatsApp-heavy operations with farmers in Brazil, they expect to migrate all of it to BeeAX as features and the ecosystem grow. Already, their structured, multinational pipeline is powered by BeeAX.`,
  ...
  'act-education': {
    meta: {
      title: msg`Burned by vendor lock-in, AC&T built a CRM they actually own | BeeAX`,
      description: msg`How AC&T Education Migration and Flycoder replaced a shuttered vendor CRM with self-hosted BeeAX, with 90%+ lower cost and full ownership.`,
    },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          msg`Because everything is built on BeeAX's open foundation, Flycoder could wire the exact logic AC&T needed without fighting the platform.`,
        ],
      },
      {
        eyebrow: msg`The result`,
  ...
  w3villa: {
    meta: {
      title: msg`When your CRM is the product: W3Grads on BeeAX | W3villa Technologies`,
      description: msg`How W3villa Technologies shipped W3Grads, an AI mock interview platform for institutions, on BeeAX as the operational backbone.`,
    },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          msg`W3villa built W3Grads (w3grads.com), an AI-powered mock interview platform for universities and training institutes, using BeeAX as its operational backbone.`,
          msg`The key decision was not to build everything from scratch. BeeAX covers the data model, permissions, authentication, and workflow engine, the parts that would have taken months to rebuild, so the team could focus on product-specific logic.`,
      ...
      },
      {
        ...
        callout: {
          text: msg`BeeAX gave us the flexibility to model the entire interview lifecycle as custom objects and workflows. We could build something genuinely complex without fighting the platform to do it.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          msg`Zero manual work at the core. Full automation. Built on BeeAX.`,
        ],
      },
    ],
    tableOfContents: [
  ...
  'elevate-consulting': {
    meta: {
      title: msg`BeeAX as the API backbone of a go-to-market stack | Elevate Consulting`,
      description: msg`How Elevate Consulting moved off documents and spreadsheets to BeeAX as the API-connected CRM at the center of their stack.`,
    },
    heroTitle: msg`BeeAX as the\n*API backbone* of a go-to-market stack`,
    sections: [
      {
        ...
        paragraphs: [
          ...
          msg`In June 2025, Justin learned BeeAX v1 had shipped. Within two or three days, the CEO asked him to look into setting up a CRM. The shift came from the potential of what could be built on top of fully open APIs. The timing was perfect.`,
        ],
        callout: {
          text: msg`It is just such a nicer experience than dealing with a Salesforce or a HubSpot. My mission has been to get every tool API-accessible, so everything talks to each other. BeeAX made that possible in a way older CRM platforms simply do not.`,
      ...
      },
      {
        ...
        paragraphs: [
          msg`Justin's broader mission at Elevate has been to move the company off static documents and onto tools with API access. By the end of 2025, that was in place: time billing, resource planning, Microsoft Teams, and project management were all accessible via API, with BeeAX at the center holding client and opportunity data. Team members could use that information strategically instead of re-keying it.`,
          msg`That opened the door to something more powerful. Justin built a custom front end that pulls live data from those systems into a single view, tailored to each role. When a proposal is won, what used to require four separate people manually setting up instances across four different tools now happens in a single click, drawing on data collected in BeeAX across the full opportunity lifecycle. It is another shift toward higher-value work for clients.`,
          msg`BeeAX is not only where CRM data lives. It is the API backbone that makes the rest of the stack possible.`,
        ],
        callout: {
          text: msg`Because BeeAX's API is fully open, I could connect it to every other tool in our stack. When a proposal is won, what used to take four people manually setting things up across four different tools now happens in a single click. That is the kind of time saving that only becomes possible when everything is connected.`,
          author: 'Justin Beadle',
          role: msg`Director of Digital and Information, Elevate Consulting`,
        },
      },
      ...
      },
      {
        ...
        paragraphs: [
          msg`Elevate's CEO was so impressed with BeeAX he started recommending it to clients before the internal setup was even complete. The team is exploring bringing BeeAX to client projects as part of their consulting practice, including as the backend for custom-built products tailored to specific operational needs.`,
