...
export const FAQ_QUESTIONS: readonly FaqQuestion[] = [
  {
    question: msg`Is BeeAX really open-source?`,
    answer: msg`Yes. BeeAX is the #1 Open Source CRM on GitHub. You can self-host to fully own your infrastructure, or run it on our managed cloud for a zero-ops setup.`,
  },
  {
  ...
  {
    question: msg`Do I need a developer to customize BeeAX?`,
    answer: msg`No. Build custom objects, fields, views, and no-code workflows straight from Settings. Unlimited, no extra charge.`,
  },
  {
    question: msg`Can developers extend BeeAX with code?`,
    answer: msg`Yes, with our Apps framework. Scaffold an extension with \`npx create-beeax-app\` and ship custom objects, server-side logic functions, React components that render inside BeeAX’s UI, AI skills and agents, views, and navigation, all in TypeScript, deployable to any workspace.`,
  },
  {
    question: msg`Does BeeAX work with Claude, ChatGPT, and Cursor?`,
  ...
  {
    question: msg`What does BeeAX cost?`,
