...
export const MENU: {
  ...
  navItems: [
    { href: '/why-beeax', label: msg`Why` },
    {
      label: msg`Resources`,
      children: [
        {
          label: msg`User Guide`,
          description: msg`Learn how to use BeeAX`,
          href: SITE_URLS.docsUserGuide,
          external: true,
          icon: IconBook,
          preview: {
            image: '/images/menu/user-guide.webp',
            imageAlt: msg`BeeAX user guide preview`,
            title: msg`Master every corner of BeeAX`,
        ...
        },
        {
          ...
          description: msg`Create apps on BeeAX`,
          ...
          preview: {
            ...
            description: msg`APIs, SDKs and webhooks to extend BeeAX and ship apps on top of your CRM data.`,
          },
        },
        {
          label: msg`Partners`,
          description: msg`Find a BeeAX partner`,
          href: '/partners',
          icon: IconUsers,
          preview: {
            image: '/images/menu/partners.webp',
            imageAlt: msg`BeeAX partner ecosystem`,
            imagePosition: 'center',
            title: msg`Team up with a BeeAX expert`,
            description: msg`Meet the certified agencies and consultants implementing BeeAX for teams worldwide.`,
          },
        },
        {
          label: msg`Releases`,
          ...
          preview: {
            ...
            imageAlt: msg`BeeAX release ${LATEST_RELEASE.release} — ${LATEST_RELEASE.title}`,
            imageScale: 1.04,
