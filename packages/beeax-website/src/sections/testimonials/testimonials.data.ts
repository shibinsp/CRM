...
export const TESTIMONIALS: readonly TestimonialRecord[] = [
  ...
  {
    quote: msg`It is just such a nicer experience than dealing with a Salesforce or a HubSpot. My mission has been to get every tool API-accessible, so everything talks to each other. BeeAX made that possible in a way older CRM platforms simply do not.`,
    author: {
