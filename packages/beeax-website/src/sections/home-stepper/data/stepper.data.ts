...
export const STEPPER_STEPS: readonly StepperStep[] = [
  ...
  },
  {
    ...
    body: msg`Don't get locked into someone else's ecosystem. BeeAX's developer experience looks like normal software, with local setup, real data, live testing, and no proprietary tooling.`,
  },
];
