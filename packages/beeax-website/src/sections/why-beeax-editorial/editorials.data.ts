...
export const WHY_TWENTY_EDITORIALS: readonly WhyTwentyEditorial[] = [
  {
    ...
    id: 'shift',
    paragraphs: [
      msg`For beeax years, CRM meant the same thing: a place to log calls, track deals, and pull reports on Friday. The real work happened in people's heads, in Slack threads, in hallway conversations. The CRM kept score. Nobody expected more from it.`,
