...
export const HELPED_CARDS: readonly HelpedCardRecord[] = [
  {
    wordmark: 'W3villa',
    heading: msg`Ship a product on BeeAX`,
    body: msg`W3villa built W3Grads for AI mock interviews at scale, with BeeAX as the operational backbone.`,
    illustration: 'target',
  ...
  },
  {
    ...
    body: msg`AC&T replaced a shuttered vendor CRM with self-hosted BeeAX and cut CRM costs by more than 90%.`,
  ...
  },
  {
    ...
    body: msg`NetZero runs a modular BeeAX setup across carbon credits, ag products, and industrial systems.`,
    illustration: 'money',
