...
import { WHY_TWENTY_HERO } from './why-beeax-visual-config';

// The /why-beeax hero: a textured backdrop with the halftone "20" floating
    ...
    <VisualFrame aria-hidden>
      <BackgroundLayer>
        <NextImage
          ...
          priority
          sizes="100vw"
          src="/images/why-beeax/hero/background.webp"
        />
      </BackgroundLayer>
      <ForegroundLayer>
        <HalftoneModel
