...
export const ILLUSTRATION_CARDS: readonly IllustrationCardRecord[] = [
  {
    ...
    body: msg`W3villa used BeeAX as a production-grade framework for the data model, permissions, authentication, and workflow engine they would otherwise have rebuilt themselves.`,
    attribution: {
  ...
  },
  {
    ...
    body: msg`AC&T moved to a self-hosted BeeAX instance with no vendor risk, no forced migration, and CRM costs reduced by more than 90%.`,
    attribution: {
