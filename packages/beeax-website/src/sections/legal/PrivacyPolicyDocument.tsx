...
export function PrivacyPolicyDocument() {
  return (
    <>
      ...
      <p>
        {'BeeAX operates the website '}
        <ExternalLink href="https://beeax.com">
          https://beeax.com
        </ExternalLink>
      ...
      <ul>
        <li>
          <p>
            <strong>Service</strong>
            {' – means the BeeAX website ('}
            <ExternalLink href="https://beeax.com">
              https://beeax.com
            </ExternalLink>
            ) and any related services or applications operated by BeeAX.com
            PBC.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            {
              ' – means a person or organization who (alone or jointly with others) determines the purposes and means of processing Personal Data. For the purposes of this Privacy Policy, BeeAX is the Data Controller for Personal Data we collect directly from you.'
            }
          </p>
        </li>
        <li>
          <p>
            ...
            {
              ' – means a person or organization which processes Personal Data on behalf of the Data Controller. We may use the services of various third-party service providers to process your data more effectively. When you use BeeAX’s cloud-based CRM, BeeAX acts as a Data Processor for the Customer Data you input into our platform on behalf of your organization (see '
            }
      ...
      <p>
        ...
        {
          ' If you are using BeeAX’s cloud-based CRM application, you may input or upload personal information about third parties (such as your customers, leads, or contacts) into our Service. This '
        }
        <strong>Customer Data</strong>
        {
          ' may include names, contact details, communications, transaction histories, and other information relevant to customer relationship management. In these cases, you (or your organization) act as the Data Controller for such Customer Data, and BeeAX acts as a Data Processor on your behalf. We process this data solely to provide our CRM services to you and in accordance with your instructions. '
        }
        <strong>If you use BeeAX in a self-hosted environment,</strong>
        {
      ...
      <p>
        BeeAX uses the collected information for various purposes in order to
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            {
              ' To provide you with news about BeeAX, special offers, or general information about our products and services, but only where you have an existing relationship with us or have otherwise consented to receive such communications. You have the right to opt out of marketing messages at any time.'
            }
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>
            ...
            <ExternalLink href="https://trust.beeax.com/">
              Trust Center
            </ExternalLink>
            .
          </p>
      ...
      <p>
        As mentioned, BeeAX uses cookies and similar tracking technologies to
      ...
      <p>
        ...
        have certain rights regarding your Personal Data. BeeAX is committed to
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <strong>BeeAX does not sell your personal information</strong>
            {
      ...
      <p>
        {
          'Additionally, California\'s "Shine the Light" law (Civil Code Section 1798.83) permits users of our Service who are California residents to request certain information regarding our disclosure of personal information to third parties for their direct marketing purposes. We do not disclose personal information to third parties for direct marketing without consent, so this provision is generally not applicable to BeeAX’s practices.'
        }
      </p>
      ...
      <p>
        BeeAX is based in the United States but data is currently hosted in
      ...
      <p>
        ...
        treated securely and in accordance with this Privacy Policy. BeeAX
      ...
      <p>
        ...
        operated by BeeAX (for example, a link to an article, a partner’s
      ...
      <ul>
        <li>
          <p>
            ...
            <a href="mailto:privacy@beeax.com">privacy@beeax.com</a>
          </p>
        </li>
      </ul>
      ...
      <p>
        Thank you for trusting BeeAX with your data. Your privacy is important
