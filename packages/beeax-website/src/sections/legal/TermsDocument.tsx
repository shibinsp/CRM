  ...
  return (
    <>
      ...
      <p>
        ...
        contact@beeax.com so we can try to find a solution. These Terms apply
      ...
      <p>
        ...
        renew under the exact same conditions unless you cancel it or BeeAX.com
        PBC cancels it. You may cancel your Subscription renewal either through
        your online account management page or by contacting BeeAX.com PBC
        customer support team.
      </p>
      <p>
        A valid payment method, including credit card, is required to process
        the payment for your subscription. You shall provide BeeAX.com PBC with
        ...
        authorize BeeAX.com PBC to charge all Subscription fees incurred
        through your account to any such payment instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason, BeeAX.com PBC
      ...
      <h2>Free Trial</h2>
      <p>
        BeeAX.com PBC may, at its sole discretion, offer a Subscription with a
      ...
      <p>
        ...
        you will not be charged by BeeAX.com PBC until Free Trial has expired.
      ...
      <p>
        At any time and without notice, BeeAX.com PBC reserves the right to (i)
      ...
      <h2>Fee changes</h2>
      <p>
        BeeAX.com PBC, in its sole discretion and at any time, may modify
      ...
      <p>
        BeeAX.com PBC will provide you with a reasonable prior notice of any
      ...
      <p>
        BeeAX.com PBC has the right but not the obligation to monitor and edit
      ...
      <p>
        ...
        BeeAX.com PBC and its licensors. Service is protected by copyright,
        ...
        the prior written consent of BeeAX.com PBC.
      </p>

      <h2>Error Reporting and Feedback</h2>
      <p>
        You may provide us either directly at contact@beeax.com or via third
      ...
      <p>
        ...
        are not owned or controlled by BeeAX.com PBC.
      </p>
      <p>
        BeeAX.com PBC has no control over, and assumes no responsibility for
      ...
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT BEEAX SHALL NOT BE RESPONSIBLE
      ...
      <p>
        By email: <a href="mailto:contact@beeax.com">contact@beeax.com</a>.
      </p>
    </>
  );
}
