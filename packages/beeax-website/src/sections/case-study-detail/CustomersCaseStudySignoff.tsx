...
export function CustomersCaseStudySignoff() {
  ...
  return (
    <Signoff
      body={i18n._(
        msg`Join the teams that chose to own their CRM. Start building with BeeAX today.`,
      )}
      heading={i18n._(msg`Ready to grow *with BeeAX?*`)}
      scheme="muted"
    >
      <Button
        href="https://app.beeax.com/welcome"
