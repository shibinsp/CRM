...
describe('ImportVisual', () => {
  it('renders the imported-data and beeax-fields columns', () => {
    renderVisual();

    expect(screen.getByText('Imported data')).toBeInTheDocument();
    expect(screen.getByText('BeeAX fields')).toBeInTheDocument();
  });
  ...
  it('maps the imported columns onto BeeAX fields', () => {
    renderVisual();
