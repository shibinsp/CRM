...
const nextConfig: LinariaConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/',
        has: [{ type: 'host', value: 'www.beeax.com' }],
        destination: 'https://beeax.com/',
        permanent: true,
      },
      {
        source: '/:path*',
        has: [{ type: 'host', value: 'www.beeax.com' }],
        destination: 'https://beeax.com/:path*',
        permanent: true,
      },
      {
        source: '/',
        has: [{ type: 'host', value: 'www.beeax-main.com' }],
        destination: 'https://beeax-main.com/',
        permanent: true,
      },
      {
        source: '/:path*',
        has: [{ type: 'host', value: 'www.beeax-main.com' }],
        destination: 'https://beeax-main.com/:path*',
        permanent: true,
      },
      ...
      {
        source: '/user-guide',
        destination: 'https://docs.beeax.com/user-guide/introduction',
        permanent: true,
      },
      {
        source: '/user-guide/section/:folder/:slug*',
        destination: 'https://docs.beeax.com/user-guide/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/developers',
        destination: 'https://docs.beeax.com/developers/introduction',
        permanent: true,
      },
      {
        source: '/developers/section/:folder/:slug*',
        destination: 'https://docs.beeax.com/developers/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/beeax-ui',
        destination: 'https://docs.beeax.com/beeax-ui/introduction',
        permanent: true,
      },
      {
        source: '/beeax-ui/section/:folder/:slug*',
        destination: 'https://docs.beeax.com/beeax-ui/:folder/:slug*',
        permanent: true,
      },
      {
        source: '/beeax-ui/:folder/:slug*',
        destination: 'https://docs.beeax.com/beeax-ui/:folder/:slug*',
        permanent: true,
      },
      {
        source: '/resources/why-beeax',
        destination: '/why-beeax',
        permanent: true,
      },
      {
        source: '/story',
