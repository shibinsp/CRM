...
describe('parseWorkspaceIdFromAwsSesResourceArn', () => {
  ...
  it.each([
    {
      ...
      arn: 'arn:aws:ses:us-east-1:123456789012:tenant/beeax-workspace-ws1/9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d',
    },
    {
      label: 'configuration-set ARN (single segment after resource type)',
      arn: 'arn:aws:ses:us-east-1:123456789012:configuration-set/beeax-workspace-ws1',
    },
    {
      label: 'identity ARN (single segment after resource type)',
      arn: 'arn:aws:ses:us-east-1:123456789012:identity/beeax-workspace-ws1',
    },
  ...
  it('preserves the workspaceId verbatim when it is a UUID', () => {
    expect(
      parseWorkspaceIdFromAwsSesResourceArn(
        'arn:aws:ses:us-east-1:123456789012:tenant/beeax-workspace-20202020-cb1b-4e35-b50f-2bbd09c3b1ee/9b1deb4d',
      ),
  ...
  // (resource named exactly "beeax-workspace-") would otherwise produce a
  ...
  it.each([
    ...
    },
    {
      ...
      arn: 'arn:aws:ses:us-east-1:123456789012:tenant/beeax-workspace-/abc',
    },
    {
