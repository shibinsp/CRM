...
import { BaseWorkspaceEntity } from 'src/engine/beeax-orm/base.workspace-entity';
import { type CustomWorkspaceEntity } from 'src/engine/beeax-orm/custom.workspace-entity';
