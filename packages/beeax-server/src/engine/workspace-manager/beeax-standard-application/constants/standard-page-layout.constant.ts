...
import { type StandardRecordPageLayouts } from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout-config/standard-page-layout-config.type';
