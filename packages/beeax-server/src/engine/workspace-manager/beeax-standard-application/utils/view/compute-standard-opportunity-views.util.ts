import { AggregateOperations, ViewType, ViewKey } from 'beeax-shared/types';
...
} from 'src/engine/workspace-manager/beeax-standard-application/utils/view/create-standard-view-flat-metadata.util';
