...
import { STANDARD_COMMAND_MENU_ITEMS } from 'src/engine/workspace-manager/beeax-standard-application/constants/standard-command-menu-item.constant';
import { createStandardCommandMenuItemFlatMetadata } from 'src/engine/workspace-manager/beeax-standard-application/utils/command-menu-item/create-standard-command-menu-item-flat-metadata.util';
