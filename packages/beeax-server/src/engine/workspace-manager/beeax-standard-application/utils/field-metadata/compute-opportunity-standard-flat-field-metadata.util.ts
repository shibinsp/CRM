...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  aiScore: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'aiScore',
      type: FieldMetadataType.NUMBER,
      label: i18nLabel(msg`AI Score`),
      description: i18nLabel(msg`AI-computed win-likelihood score (0-100)`),
      icon: 'IconSparkles',
      isNullable: true,
      isUIEditable: false,
    },
  ...
  aiScoreReason: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'aiScoreReason',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`AI Score Reason`),
      description: i18nLabel(msg`Explanation behind the AI score`),
      icon: 'IconRobot',
      isNullable: true,
      isUIEditable: false,
    },
