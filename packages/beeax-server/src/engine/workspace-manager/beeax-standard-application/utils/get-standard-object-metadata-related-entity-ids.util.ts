...
import { type AllStandardObjectViewGroupName } from 'src/engine/workspace-manager/beeax-standard-application/types/all-standard-object-view-group-name.type';
