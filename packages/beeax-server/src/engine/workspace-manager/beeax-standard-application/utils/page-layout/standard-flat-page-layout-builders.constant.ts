...
import { type StandardPageLayoutConfig } from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout-config';
...
} from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout/create-standard-page-layout-flat-metadata.util';
