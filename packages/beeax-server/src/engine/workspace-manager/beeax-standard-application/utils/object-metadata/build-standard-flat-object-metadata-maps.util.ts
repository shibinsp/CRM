...
import { STANDARD_FLAT_OBJECT_METADATA_BUILDERS_BY_OBJECT_NAME } from 'src/engine/workspace-manager/beeax-standard-application/utils/object-metadata/create-standard-flat-object-metadata.util';
import { type CreateStandardObjectArgs } from 'src/engine/workspace-manager/beeax-standard-application/utils/object-metadata/create-standard-object-flat-metadata.util';
