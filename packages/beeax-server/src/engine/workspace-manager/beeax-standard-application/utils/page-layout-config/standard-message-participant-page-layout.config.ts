...
import {
  TAB_PROPS,
  WIDGET_PROPS,
} from 'src/engine/workspace-manager/beeax-standard-application/constants/standard-page-layout-tabs.template';
import {
  type StandardPageLayoutConfig,
  type StandardPageLayoutTabConfig,
} from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout-config/standard-page-layout-config.type';
