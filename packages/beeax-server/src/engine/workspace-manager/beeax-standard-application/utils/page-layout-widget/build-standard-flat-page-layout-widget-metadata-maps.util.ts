...
import { STANDARD_RECORD_PAGE_LAYOUTS } from 'src/engine/workspace-manager/beeax-standard-application/constants/standard-page-layout.constant';
...
import { type StandardRecordPageLayoutConfig } from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout-config/standard-page-layout-config.type';
import { computeMyFirstDashboardWidgets } from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout-widget/compute-my-first-dashboard-widgets.util';
import {
...
} from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout-widget/create-standard-page-layout-widget-flat-metadata.util';
import { findObjectNameByUniversalIdentifier } from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout/create-standard-page-layout-flat-metadata.util';
