import { type PageLayoutTabLayoutMode } from 'beeax-shared/types';
import { isDefined } from 'beeax-shared/utils';

import { type FlatPageLayoutTab } from 'src/engine/metadata-modules/flat-page-layout-tab/types/flat-page-layout-tab.type';
import { PageLayoutType } from 'src/engine/metadata-modules/page-layout/enums/page-layout-type.enum';
import { STANDARD_PAGE_LAYOUTS } from 'src/engine/workspace-manager/beeax-standard-application/constants/standard-page-layout.constant';
...
import { type StandardPageLayoutMetadataRelatedEntityIds } from 'src/engine/workspace-manager/beeax-standard-application/utils/get-standard-page-layout-metadata-related-entity-ids.util';
import { type StandardPageLayoutTabConfig } from 'src/engine/workspace-manager/beeax-standard-application/utils/page-layout-config';
