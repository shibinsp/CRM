...
import { type AllStandardSkillName } from 'src/engine/workspace-manager/beeax-standard-application/types/all-standard-skill-name.type';
import {
  type CreateStandardSkillArgs,
  createStandardSkillFlatMetadata,
} from 'src/engine/workspace-manager/beeax-standard-application/utils/skill-metadata/create-standard-skill-flat-metadata.util';
...
## Calling BeeAX Tools from Python (MCP Bridge)

**A \`beeax\` variable is already bound in your code's scope.** Do NOT write
\`import beeax\` — there is no Python package by that name. The helper is an
...
Call \`beeax.list_tools()\` to discover exact names. Catalog tools are routed
...
# Update a record
beeax.call_tool('update_one_person', {
    'id': 'person-uuid-here',
    'jobTitle': 'CEO',
})
\`\`\`
