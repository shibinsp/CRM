...
import { v4 } from 'uuid';
import { type AggregateOperations } from 'beeax-shared/types';
...
import { type AllStandardObjectFieldName } from 'src/engine/workspace-manager/beeax-standard-application/types/all-standard-object-field-name.type';
...
import { type AllStandardObjectViewFieldGroupName } from 'src/engine/workspace-manager/beeax-standard-application/types/all-standard-object-view-field-group-name.type';
import { type AllStandardObjectViewFieldName } from 'src/engine/workspace-manager/beeax-standard-application/types/all-standard-object-view-field-name.type';
import { type AllStandardObjectViewName } from 'src/engine/workspace-manager/beeax-standard-application/types/all-standard-object-view-name.type';
import { type StandardBuilderArgs } from 'src/engine/workspace-manager/beeax-standard-application/types/metadata-standard-buillder-args.type';
