...
import { type ViewFilterOperand } from 'beeax-shared/types';
...
import { type AllStandardObjectViewFilterName } from 'src/engine/workspace-manager/beeax-standard-application/types/all-standard-object-view-filter-name.type';
