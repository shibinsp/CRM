...
import { computeStandardOpportunityViewGroups } from 'src/engine/workspace-manager/beeax-standard-application/utils/view-group/compute-standard-opportunity-view-groups.util';
import { type CreateStandardViewGroupArgs } from 'src/engine/workspace-manager/beeax-standard-application/utils/view-group/create-standard-view-group-flat-metadata.util';
import { computeStandardTaskViewGroups } from 'src/engine/workspace-manager/beeax-standard-application/utils/view-group/compute-standard-task-view-groups.util';
