...
// TODO completely deprecate this file once we've created the beeax-standard beeax-app manifest
@Injectable()
  ...
  async synchronizeTwentyStandardApplicationOrThrow({
    ...
    if (validateAndBuildResult.status === 'fail') {
      throw new WorkspaceMigrationBuilderException(
        ...
        'Multiple validation errors occurred while synchronizing beeax-standard application',
      );
    }
  }
}
