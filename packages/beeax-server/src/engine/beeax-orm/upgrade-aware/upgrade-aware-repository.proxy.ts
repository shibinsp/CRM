...
import { type UpgradeAwareRepositoryState } from 'src/engine/beeax-orm/upgrade-aware/upgrade-aware-repository-state';
import { UpgradeUnavailableEntityWriteException } from 'src/engine/beeax-orm/upgrade-aware/exceptions/upgrade-unavailable-entity-write.exception';
