...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/beeax-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/beeax-orm/entity-manager/utils/get-entity-target';
...
import { type GlobalWorkspaceDataSource } from 'src/engine/beeax-orm/global-workspace-datasource/global-workspace-datasource';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/beeax-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/beeax-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/beeax-orm/repository/workspace.repository';
import { getWorkspaceContext } from 'src/engine/beeax-orm/storage/orm-workspace-context.storage';
import { type RolePermissionConfig } from 'src/engine/beeax-orm/types/role-permission-config';
import { computePermissionIntersection } from 'src/engine/beeax-orm/utils/compute-permission-intersection.util';
