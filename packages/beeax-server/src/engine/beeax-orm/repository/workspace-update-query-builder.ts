...
import { QUERY_MAX_RECORDS } from 'beeax-shared/constants';
...
import { type WorkspaceInternalContext } from 'src/engine/beeax-orm/interfaces/workspace-internal-context.interface';

import { DatabaseEventAction } from 'src/engine/api/graphql/graphql-query-runner/enums/database-event-action';
import { type WorkspaceAuthContext } from 'src/engine/core-modules/auth/types/workspace-auth-context.type';
import { type QueryDeepPartialEntityWithNestedRelationFields } from 'src/engine/beeax-orm/entity-manager/types/query-deep-partial-entity-with-nested-relation-fields.type';
import { type RelationConnectQueryConfig } from 'src/engine/beeax-orm/entity-manager/types/relation-connect-query-config.type';
import { type RelationDisconnectQueryFieldsByEntityIndex } from 'src/engine/beeax-orm/entity-manager/types/relation-nested-query-fields-by-entity-index.type';
import { type WorkspaceEntityManager } from 'src/engine/beeax-orm/entity-manager/workspace-entity-manager';
import { computeTwentyORMException } from 'src/engine/beeax-orm/error-handling/compute-beeax-orm-exception';
import {
  TwentyORMException,
  TwentyORMExceptionCode,
} from 'src/engine/beeax-orm/exceptions/beeax-orm.exception';
import { FilesFieldSync } from 'src/engine/beeax-orm/field-operations/files-field-sync/files-field-sync';
import { RelationNestedQueries } from 'src/engine/beeax-orm/field-operations/relation-nested-queries/relation-nested-queries';
import { validateQueryIsPermittedOrThrow } from 'src/engine/beeax-orm/repository/permissions.utils';
import { type WorkspaceDeleteQueryBuilder } from 'src/engine/beeax-orm/repository/workspace-delete-query-builder';
import { WorkspaceSelectQueryBuilder } from 'src/engine/beeax-orm/repository/workspace-select-query-builder';
import { type WorkspaceSoftDeleteQueryBuilder } from 'src/engine/beeax-orm/repository/workspace-soft-delete-query-builder';
import { applyRowLevelPermissionPredicates } from 'src/engine/beeax-orm/utils/apply-row-level-permission-predicates.util';
import { applyTableAliasOnWhereCondition } from 'src/engine/beeax-orm/utils/apply-table-alias-on-where-condition';
import { computeEventSelectQueryBuilder } from 'src/engine/beeax-orm/utils/compute-event-select-query-builder.util';
import { formatData } from 'src/engine/beeax-orm/utils/format-data.util';
import { formatResult } from 'src/engine/beeax-orm/utils/format-result.util';
import { formatTwentyOrmEventToDatabaseBatchEvent } from 'src/engine/beeax-orm/utils/format-beeax-orm-event-to-database-batch-event.util';
import { getObjectMetadataFromEntityTarget } from 'src/engine/beeax-orm/utils/get-object-metadata-from-entity-target.util';
import { validateRLSPredicatesForRecords } from 'src/engine/beeax-orm/utils/validate-rls-predicates-for-records.util';
