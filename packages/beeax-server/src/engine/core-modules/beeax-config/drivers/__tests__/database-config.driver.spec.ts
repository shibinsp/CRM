...
import { type ConfigVariables } from 'src/engine/core-modules/beeax-config/config-variables';
...
jest.mock(
  'src/engine/core-modules/beeax-config/utils/is-env-only-config-var.util',
  () => ({
