...
import { ConfigValueConverterService } from 'src/engine/core-modules/beeax-config/conversion/config-value-converter.service';
...
import * as typeTransformersModule from 'src/engine/core-modules/beeax-config/utils/type-transformers.registry';
import { TypedReflect } from 'src/utils/typed-reflect';

jest.mock(
  'src/engine/core-modules/beeax-config/utils/type-transformers.registry',
  () => {
