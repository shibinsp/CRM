...
`,
  ...
  // beeax-sdk is build-time only and beeax-client-sdk is injected at runtime
  // by BeeAX (Lambda SDK layer / server-served modules), so neither needs to
  ...
  private async removeBuildTimeSdkFromDependencies(
    ...
    const packagesToRemove = ['beeax-sdk', 'beeax-client-sdk'];
