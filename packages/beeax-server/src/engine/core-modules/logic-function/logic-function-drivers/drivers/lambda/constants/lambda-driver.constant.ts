...
export const COMMON_LAYER_NAME_PREFIX = 'beeax-common-layer';
export const YARN_INSTALL_FUNCTION_NAME_PREFIX = 'beeax-yarn-install';
export const BUILDER_FUNCTION_NAME_PREFIX = 'beeax-builder';

export const SDK_LAYER_PREFIX_IN_ZIP = 'nodejs/node_modules/beeax-client-sdk';

export const LAMBDA_PREBUILT_BUNDLE_CHECKSUM_TAG = 'beeax:bundle-checksum';
