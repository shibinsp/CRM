...
import { OBJECTS_WITH_CHANNEL_VISIBILITY_CONSTRAINTS } from 'beeax-shared/constants';
import {
  FieldMetadataType,
  FileFolder,
  ObjectRecord,
} from 'beeax-shared/types';
import { getLogoUrlFromDomainName, isDefined } from 'beeax-shared/utils';
...
import { resolveRolePermissionConfig } from 'src/engine/beeax-orm/utils/resolve-role-permission-config.util';
