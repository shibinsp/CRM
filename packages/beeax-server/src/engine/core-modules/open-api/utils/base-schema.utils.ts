...
access to your workspace is the **BeeAX MCP server**, not this OpenAPI schema.
...
\`\`\`bash
curl -H 'Authorization: Bearer <token>' \\
  ${serverUrl}/rest/open-api/${schemaName} > beeax-${schemaName}.json
\`\`\`
`,
      termsOfService:
        'https://github.com/beeax/beeax?tab=coc-ov-file#readme',
      contact: {
        email: 'felix@beeax.com',
      },
      license: {
        name: 'AGPL-3.0',
        url: 'https://github.com/beeax/beeax?tab=License-1-ov-file#readme',
      },
      version: API_Version,
    },
    // Testing purposes
    ...
    externalDocs: {
      description: 'Find out more about **BeeAX**',
      url: 'https://beeax.com',
    },
