  ...
  return {
    post: {
      ...
      parameters: [
        {
          in: 'header',
          name: 'X-BeeAX-Webhook-Signature',
          schema: {
            type: 'string',
          },
          description:
            'HMAC SHA256 signature of the request payload using the webhook secret. To compute the signature:\n' +
            '1. Concatenate `X-BeeAX-Webhook-Timestamp`, a colon (:), and the JSON string of the request payload.\n' +
        ...
        {
          in: 'header',
          name: 'X-BeeAX-Webhook-Timestamp',
          schema: {
            type: 'string',
          },
          description:
