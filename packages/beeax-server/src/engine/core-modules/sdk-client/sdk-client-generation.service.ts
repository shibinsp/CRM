...
import { replaceCoreClient } from 'beeax-client-sdk/generate';
...
const SDK_CLIENT_ARCHIVE_NAME = 'beeax-client-sdk.zip';
...
export class SdkClientGenerationService {
  ...
  private async generateAndStore({
    ...
    try {
      ...
      const tempPackageRoot = join(sourceTemporaryDir, 'beeax-client-sdk');
