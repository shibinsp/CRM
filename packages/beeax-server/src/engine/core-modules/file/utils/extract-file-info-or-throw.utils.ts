...
import { TWENTY_MIME_POLICY } from 'src/engine/core-modules/file/constants/beeax-mime-policy.constant';
...
export const extractFileInfoOrThrow = async ({
  ...
  if (isNonEmptyString(ext)) {
    // BeeAX policy wins over the ext-based fallback for the (small) set of
