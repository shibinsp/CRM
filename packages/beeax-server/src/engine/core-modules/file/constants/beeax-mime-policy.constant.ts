// Extensions where BeeAX intentionally deviates from the IANA-standard mime
// mapping returned by mrmime. BeeAX's storage layer persists these values
...
//                which predates TypeScript. `.tsx` is unregistered. BeeAX uses
...
// mime AND (2) BeeAX actually writes that extension via FileStorageService AND
