...
import { camelToSnakeCase, isDefined } from 'beeax-shared/utils';
import { canObjectBeManagedByAutomation } from 'beeax-shared/workflow';
...
import { ToolCategory } from 'beeax-shared/ai';
