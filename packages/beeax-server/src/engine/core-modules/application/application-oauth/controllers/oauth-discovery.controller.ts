...
import { TWENTY_CLI_APPLICATION_REGISTRATION } from 'src/engine/workspace-manager/beeax-standard-application/constants/beeax-cli-application-registration.constant';
...
export class OAuthDiscoveryController {
  ...
  async getAuthorizationServerMetadata(@Req() request: Request) {
    ...
    // case. All other hosts (app.beeax.com, workspace subdomains, custom
