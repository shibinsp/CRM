...
jest.mock(
  'src/engine/beeax-orm/utils/build-row-level-permission-record-filter.util',
  () => ({
...
jest.mock(
  'src/engine/beeax-orm/utils/is-record-matching-rls-row-level-permission-predicate.util',
  () => ({
...
} = require('src/engine/beeax-orm/utils/build-row-level-permission-record-filter.util');
const {
  isRecordMatchingRLSRowLevelPermissionPredicate,
} = require('src/engine/beeax-orm/utils/is-record-matching-rls-row-level-permission-predicate.util');
