...
import { formatColumnNameForRelationField } from 'src/engine/beeax-orm/utils/format-column-name-for-relation-field.util';
  ...
  private async addFiltersFromView({
    ...
    const recordFilterGroups = viewFilterGroups.map((viewFilterGroup) => {
      return {
        ...
        logicalOperator:
          viewFilterGroup.logicalOperator as unknown as RecordFilterGroupLogicalOperator, // TODO - https://github.com/beeax/beeax/issues/14746
