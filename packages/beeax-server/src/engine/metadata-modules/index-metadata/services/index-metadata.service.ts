...
import { compositeTypeDefinitions, RelationType } from 'beeax-shared/types';
...
import { MAX_CUSTOM_INDEXES_PER_OBJECT } from 'beeax-shared/constants';
  ...
  async deleteOne({
    ...
    if (!flatIndexToDelete.isCustom) {
      throw new IndexMetadataException(
        ...
        {
          userFriendlyMessage: msg`System indexes are required for BeeAX to work and cannot be deleted.`,
        },
      );
    }
