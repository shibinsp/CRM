...
export const validateMorphOrRelationFlatFieldMetadata = ({
  ...
  // TODO prastoin refactor FlatFieldMetadataTypeValidator to implement two code flow: create and update https://github.com/beeax/core-team-issues/issues/2044
  if (isDefined(update)) {
    errors.push(
