...
// Usage: GITHUB_TOKEN=xxx GITHUB_REPOSITORY=owner/repo PR_NUMBER=123 npx nx run beeax-server:ts-node-no-deps-transpile-only -- ./scripts/check-blocked-contributors.ts
