...
BeeAX was built to be developer-friendly, offering powerful APIs that adapt to your custom data model. We provide four distinct API types to meet different integration needs.

## Developer-First Approach

BeeAX generates APIs specifically for your data model:
...
<Note>
Your personalized API documentation is available under **Settings → API & Webhooks** after creating an API key. Since BeeAX generates APIs that match your custom data model, the documentation is unique to your workspace.
</Note>
