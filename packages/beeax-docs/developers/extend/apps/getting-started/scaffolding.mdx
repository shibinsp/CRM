---
title: Scaffolding
description: Generate entity files interactively with yarn beeax dev:add — objects, fields, views, logic functions, and more.
...
Each entity type has its own template. For example, `yarn beeax dev:add object` asks for:
