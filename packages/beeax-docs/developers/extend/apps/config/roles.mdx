...
- Predicates can reference objects and fields owned by your app or by BeeAX's standard objects.
...
- See a working example: [`hello-world/src/roles/function-role.ts`](https://github.com/beeax/beeax/blob/main/packages/beeax-apps/hello-world/src/roles/function-role.ts).
