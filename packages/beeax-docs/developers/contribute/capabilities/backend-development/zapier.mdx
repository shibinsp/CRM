...
Effortlessly sync BeeAX with 3000+ apps using [Zapier](https://zapier.com/). Automate tasks, boost productivity, and supercharge your customer relationships!
...
From the `packages/beeax-zapier` folder, run:
