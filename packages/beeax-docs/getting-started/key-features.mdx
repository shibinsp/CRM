---
title: Key Features
description: A tour of everything BeeAX can do — from custom data models to AI-powered automation.
icon: "star"
---

import { CardTitle } from "/snippets/card-title.mdx"

BeeAX is a full-featured CRM platform. Here's what you can build with it.
...
<CardGroup cols={2}>
  ...
  <Card href="/developers/self-host/self-host" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    Run BeeAX on your own infrastructure with a single Docker Compose command.
