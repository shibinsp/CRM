---
title: Quickstart
description: Get BeeAX up and running in under 5 minutes — on the cloud or self-hosted.
icon: "play"
---
...
<Steps>
  <Step title="Create your account">
    Go to [app.beeax.com](https://app.beeax.com) and sign up with Google, Microsoft, or email.
  </Step>
...
Once you're in, three steps to make BeeAX yours:

### 1. Connect your mailbox

Go to **Settings → Accounts** and connect your Google or Microsoft account. BeeAX will import your emails and calendar events, and auto-create contacts from interactions. Using another provider? You can add mailboxes via SMTP or calendars via CalDAV from the same page.
