...
You've been choosing between software that's easy to start but impossible to change, and software that's flexible but takes months to set up. BeeAX is the third option: **a production-ready CRM you can reshape as you go.**


## What makes BeeAX different

BeeAX is a platform you can build on, not a product you configure.
...
<CardGroup cols={2}>
  ...
  <Card img="/images/user-guide/halftone/dev-api.png">
    ...
    React, TypeScript. Your team already knows how to extend BeeAX. No proprietary languages, no gatekeeping.
  </Card>
...
and PostgreSQL. BeeAX opens the CRM market
to you without learning APEX or getting proprietary certifications.

## Who BeeAX is not for


- **Teams that want a CRM they never have to think
  about.** BeeAX rewards teams that want to stay close to
...
<Card title="Ready to get started?" icon="rocket" href="/getting-started/quickstart">
  Set up BeeAX in under 5 minutes — cloud or self-hosted.
</Card>
