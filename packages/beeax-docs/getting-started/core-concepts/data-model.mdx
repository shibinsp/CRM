---
title: Data Model
description: Understand how BeeAX structures your data with objects, fields, and relations.
icon: "database"
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

Everything in BeeAX is built around **objects** and **fields** — the building blocks of your data model.

## Objects

Objects are the tables that hold your data. BeeAX comes with standard objects out of the box:
...
Fields are the properties on each object. BeeAX supports a wide range of field types:
...
Unlike traditional CRMs where you're limited to pre-defined fields on pre-defined objects, BeeAX lets you model your data exactly the way your business works. Custom objects get the same first-class treatment as built-in ones — including API endpoints, views, permissions, and workflow triggers.
