...
description: Sync your email and calendar with BeeAX.
icon: "envelope"
---

BeeAX connects to your existing tools so your CRM stays up to date without manual data entry.
...
- You can send emails directly from BeeAX
...
Beyond email and calendar, BeeAX connects to external tools through:
...
Developers can build full-featured apps on top of BeeAX — adding custom UI, server-side logic, and deep integrations. Apps can be published for the community or kept private.
...
<CardGroup cols={2}>
  ...
  <Card title="API & Extensions" icon="plug" href="/developers/extend/api">
    Build custom integrations with the BeeAX API.
  </Card>
</CardGroup>
