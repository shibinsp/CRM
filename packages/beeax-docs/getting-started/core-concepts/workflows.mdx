---
title: Workflows
description: Automate your business processes with BeeAX's visual workflow builder.
icon: "bolt"
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

Workflows let you automate repetitive tasks and connect BeeAX to external tools — without writing code (though you can if you want to).
...
- Sync data between BeeAX and your billing system
