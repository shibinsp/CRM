...
Après avoir téléversé votre fichier et fait la correspondance des colonnes, BeeAX valide vos données :

1. **Exécution de la validation** — BeeAX vérifie chaque ligne pour détecter des erreurs
...
| ----------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Valeurs en double surlignées en jaune                                         | La valeur existe déjà dans BeeAX ou apparaît deux fois dans votre fichier |
...
**Option 3 : Laisser BeeAX mettre à jour l'enregistrement existant**
...
3. BeeAX mettra à jour l'enregistrement existant au lieu de créer un doublon
...
Tant qu'un identifiant unique correspond, BeeAX met à jour l'enregistrement.
</Note>
...
3. Vérifiez si des enregistrements existent déjà dans BeeAX
...
Cela signifie qu'il n'existe aucune entreprise dans BeeAX avec cet identifiant précis.
...
Vous essayez de lier un enregistrement qui n'existe pas dans BeeAX.
...
Une colonne de votre fichier ne peut pas être mise en correspondance car le champ n'existe pas dans BeeAX.
...
1. **L'utilisateur n'a pas accepté son invitation** — l'utilisateur n'existe pas encore dans BeeAX
2. **Utilisation de l'ID utilisateur de l'ancien système** — BeeAX ne peut pas faire correspondre les ID d'un autre système
3. **Format d'e-mail incorrect** — l'adresse e-mail ne correspond pas au compte BeeAX de l'utilisateur

### Comment corriger

1. Assurez-vous que tous les utilisateurs ont **accepté leur invitation** à votre espace de travail BeeAX
2. Utilisez l'**adresse e-mail** de l'utilisateur (pas son nom ni l'ID de l'ancien système)
3. Utilisez la même adresse e-mail que celle utilisée pour rejoindre BeeAX
...
<Check>Le format de domaine correspond exactement au format de BeeAX</Check>
...
1. **Téléchargez le fichier d'exemple** — voyez le format exact attendu par BeeAX
