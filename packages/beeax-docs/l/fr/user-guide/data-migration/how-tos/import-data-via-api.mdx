...
description: Quand et comment utiliser les API de BeeAX pour des importations de données à grande échelle.
---

## Vue d'ensemble

BeeAX propose des **API GraphQL** et **REST** pour l'importation programmatique de données. Utilisez l'API lorsque l'importation CSV n'est pas pratique pour votre volume de données ou lorsque vous avez besoin d'importations automatisées et récurrentes.
...
BeeAX applique des limites de débit pour garantir la stabilité du système :
...
BeeAX prend en charge deux types d'API :
...
* Vérifiez que les formats correspondent aux exigences de BeeAX (voir [Correspondance des champs](/l/fr/user-guide/data-migration/capabilities/field-mapping))
...
* Vérifiez que les données s'affichent correctement dans BeeAX
...
Contactez-nous à [contact@beeax.com](mailto:contact@beeax.com) ou découvrez nos [services de mise en œuvre](/l/fr/user-guide/getting-started/capabilities/implementation-services).
