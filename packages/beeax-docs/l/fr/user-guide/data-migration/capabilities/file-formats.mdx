...
description: Formats de fichiers pris en charge pour l’importation de données dans BeeAX.
---

## Formats pris en charge

BeeAX prend en charge trois formats de fichiers pour l’importation :
