...
description: Foire aux questions sur les paramètres de BeeAX.
---
...
Pour changer votre adresse e-mail, veuillez contacter [contact@beeax.com](mailto:contact@beeax.com).
</Accordion>
...
* **Sous-domaine** : Utilisez un sous-domaine BeeAX comme `yourcompany.beeax.com`
