...
<AccordionGroup>
<Accordion title="Quels rôles sont inclus par défaut avec BeeAX ?">
BeeAX inclut par défaut les rôles **Admin** et **Member**. Vous pouvez créer des rôles personnalisés supplémentaires selon les besoins de votre équipe (par ex., Représentant commercial, Responsable, Utilisateur en lecture seule).
</Accordion>
...
* **Envoyer des e-mails** : Possibilité d'envoyer des e-mails depuis BeeAX
...
Avec l'approvisionnement JIT, les comptes utilisateur sont automatiquement créés dans BeeAX lorsqu'une personne se connecte via SSO pour la première fois. Le rôle par défaut leur est attribué automatiquement.
</Accordion>
