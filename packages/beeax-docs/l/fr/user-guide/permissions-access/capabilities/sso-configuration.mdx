...
L'authentification unique (SSO) permet aux membres de votre équipe de se connecter à BeeAX en utilisant le fournisseur d'identité de votre organisation. Cela offre :
...
BeeAX prend en charge le SSO avec :
...
* Accès administrateur à l'espace de travail BeeAX

<Note>
**Pour les utilisateurs en auto-hébergement souhaitant configurer le SSO**, contactez contact@beeax.com
</Note>
...
* Retirez-les de l'espace de travail BeeAX
...
* **Correspondance de groupes** : Faites correspondre les groupes IdP aux rôles BeeAX (si disponible)
* **Processus de départ** : Incluez BeeAX dans votre workflow de déprovisionnement
