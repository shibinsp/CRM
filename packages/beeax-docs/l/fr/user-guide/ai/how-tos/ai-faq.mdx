---
title: FAQ sur l'IA
description: Foire aux questions sur les fonctionnalités d'IA dans BeeAX.
---
...
<AccordionGroup>
  ...
  <Accordion title="Quelles capacités d'IA sont prévues ?">
    ...
    1. **AI Chatbot** : Un assistant contextuel capable d'accéder à vos données BeeAX et de vous aider avec vos requêtes
  ...
  <Accordion title="Puis-je utiliser mes propres modèles d'IA ?">
    Dans un premier temps, BeeAX utilisera des modèles d'IA intégrés. La prise en charge de modèles d'IA personnalisés ou externes pourrait être ajoutée dans de prochaines versions en fonction des retours des utilisateurs.
  </Accordion>
