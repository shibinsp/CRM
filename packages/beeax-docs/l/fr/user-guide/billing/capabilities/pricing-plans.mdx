...
description: En savoir plus sur les formules tarifaires de BeeAX et comment passer de l’une à l’autre.
---

## Vue d'ensemble

BeeAX propose une tarification flexible adaptée aux équipes de toute taille, que vous préfériez l’hébergement cloud ou l’auto-hébergement.
...
Hébergez BeeAX sur votre propre infrastructure, sans frais :
