...
description: Suivez un guide étape par étape expliquant comment s'inscrire sur BeeAX, choisir un plan d'abonnement et configurer votre compte.
---
...
1. Allez sur [Inscription à BeeAX](https://app.beeax.com).
...
Pour toute question ou aide, contactez l'équipe de support dédiée à [contact@beeax.com](mailto:contact@beeax.com) ou envoyez un message sur [Discord](https://discord.gg/cx5n4Jzs57).
