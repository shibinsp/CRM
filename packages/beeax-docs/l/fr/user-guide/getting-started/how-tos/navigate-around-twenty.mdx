...
Le menu de commandes vous donne **un accès rapide aux actions** dans BeeAX. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (BeeAX prend en charge les suppressions logiques et définitives)
