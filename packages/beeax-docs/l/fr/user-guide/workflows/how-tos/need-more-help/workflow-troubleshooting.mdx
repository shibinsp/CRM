...
**Pourquoi cela se produit**: BeeAX enregistre tout en temps réel — il n'y a pas de mode "édition" distinct du mode "lecture". Lorsque vous créez un enregistrement, il est enregistré immédiatement, déclenchant l'événement "Record is created" avant que vous ne puissiez remplir des champs supplémentaires.
...
* Testez d'abord l'appel d'API en dehors de BeeAX
