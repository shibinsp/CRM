---
title: Générer un devis ou une facture depuis BeeAX
...
* [Générer un PDF à partir de BeeAX](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — joindre les PDF générés aux enregistrements
