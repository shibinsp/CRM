---
title: Générer un PDF depuis BeeAX
description: Créez un flux de travail pour générer et joindre un PDF (par exemple un devis) à un enregistrement.
---

Générez ou récupérez automatiquement un PDF et joignez-le à un enregistrement dans BeeAX. Cette fonctionnalité est couramment utilisée pour créer des devis, des factures ou des rapports liés aux Entreprises, aux Opportunités ou à d'autres objets.
...
2. Téléversement du fichier dans BeeAX
...
export const main = async (
  ...
  // Replace with your BeeAX GraphQL endpoints (/metadata for metadata and files or /graphql for your records)
  // Cloud: https://api.beeax.com/graphql
  // Self-hosted: https://your-domain.com/graphql

  const metadataGraphqlEndpoint = 'https://api.beeax.com/metadata';
  const dataGraphqlEndpoint = 'https://api.beeax.com/graphql';
...
* [Générer un devis ou une facture depuis BeeAX](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
