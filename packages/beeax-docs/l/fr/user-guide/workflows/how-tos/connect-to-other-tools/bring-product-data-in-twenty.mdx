---
title: Importer les données de produits dans BeeAX
...
Utilisez ce modèle pour garder BeeAX synchronisé avec les données produits de votre entrepôt de données (par ex. Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record** : Créer ou mettre à jour dans BeeAX
