...
Vous souhaitez mentionner un collègue dans une note afin qu'il reçoive une notification pour la relire. À ce jour, BeeAX ne prend pas en charge les @mentions dans les notes ou les tâches.
...
View the note here:
https://yourSubDomain.beeax.com/object/note/{{recordIsUpdated.id}}
...
<Note>
Remplacez `yourSubDomain` par le sous-domaine réel de votre espace de travail BeeAX.
</Note>
