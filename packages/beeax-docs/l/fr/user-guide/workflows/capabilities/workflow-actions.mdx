...
description: Découvrez les actions disponibles dans les workflows de BeeAX.
---
...
<Note>
Vous pouvez uniquement envoyer des e-mails à partir de boîtes aux lettres synchronisées avec votre propre compte BeeAX. L'envoi depuis les boîtes aux lettres d'autres membres de l'équipe (par ex., l'e-mail du propriétaire du compte) est sur la feuille de route.
</Note>
