---
title: Widgets
description: Explorez les types de widgets et les options de visualisation dans BeeAX.
---
...
BeeAX propose différents types de widgets pour visualiser vos données CRM.
