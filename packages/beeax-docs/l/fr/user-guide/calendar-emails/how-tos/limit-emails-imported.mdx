...
description: Contrôlez quels e-mails sont importés dans BeeAX.
---

## Vue d'ensemble

Par défaut, BeeAX synchronise tous les e-mails externes depuis votre boîte aux lettres connectée. Vous pouvez limiter ce qui est importé à l’aide de la **sélection de dossiers** et des **paramètres de visibilité**.
