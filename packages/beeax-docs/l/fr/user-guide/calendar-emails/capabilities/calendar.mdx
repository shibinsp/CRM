---
title: Calendrier
description: Comprendre les fonctionnalités d'intégration du calendrier dans BeeAX.
---
...
BeeAX synchronise automatiquement vos événements de calendrier et les associe aux enregistrements CRM pertinents, vous offrant une vue complète de votre historique de réunions avec les contacts et les entreprises.
