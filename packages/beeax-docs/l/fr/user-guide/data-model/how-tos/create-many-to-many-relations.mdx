...
BeeAX utilise un modèle d'**objet de jonction** pour les relations plusieurs-à-plusieurs. Un objet de jonction se situe entre deux objets et conserve les connexions :
...
Lorsque vous activez la bascule de relation de jonction, BeeAX affiche directement les enregistrements liés au lieu d'afficher les enregistrements de jonction intermédiaires.
