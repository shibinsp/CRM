...
BeeAX inclut des objets standard :
...
Chaque entreprise fonctionne différemment. La personnalisation de votre modèle de données vous permet de façonner BeeAX autour de **vos** processus au lieu de forcer les vôtres dans un système rigide.

BeeAX offre une flexibilité totale :
...
Identifiez les principaux concepts avec lesquels vous travaillez. BeeAX propose déjà :
