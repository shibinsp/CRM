---
title: Objets
description: Découvrez les objets standard et personnalisés dans BeeAX.
---
...
Les objets standard sont des entités prédéfinies dans votre espace de travail pour vous aider à commencer. Ils font partie d'un modèle de données partagé accessible à tous les utilisateurs de BeeAX. Vous pouvez les utiliser tels quels, les personnaliser ou les désactiver.
