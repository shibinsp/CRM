...
Les relations plusieurs-à-plusieurs utilisent un modèle d'**objet de jonction**: un objet intermédiaire qui relie les deux côtés. Avec la fonctionnalité de relation via objet de jonction, BeeAX affiche directement les enregistrements finaux liés, en masquant l'objet intermédiaire dans l'interface utilisateur.
...
BeeAX est livré avec des relations prédéfinies entre des objets standard :
