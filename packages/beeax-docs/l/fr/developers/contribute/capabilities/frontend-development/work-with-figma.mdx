...
info: Apprenez comment vous pouvez collaborer avec le Figma de BeeAX
---
...
1. **Accédez au lien partagé :** Vous pouvez accéder au fichier Figma du projet [ici](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/BeeAX).
...
Sur la barre latérale gauche, vous pouvez accéder aux différentes pages du Figma de BeeAX. Voici comment elles sont organisées :
