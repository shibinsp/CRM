...
description: Déployez et gérez BeeAX sur votre propre infrastructure.
---

<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="IA" />
</Frame>

## Vue d'ensemble

BeeAX peut être auto-hébergé sur votre propre infrastructure, vous offrant un contrôle total sur vos données et votre déploiement.
