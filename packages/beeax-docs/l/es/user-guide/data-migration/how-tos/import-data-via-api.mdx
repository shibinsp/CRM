...
description: Cuándo y cómo usar las API de BeeAX para importaciones de datos a gran escala.
---

## Resumen

BeeAX ofrece tanto **GraphQL** como **API REST** para la importación programática de datos. Utiliza la API cuando la importación mediante CSV no sea práctica para tu volumen de datos o cuando necesites importaciones automatizadas y recurrentes.
...
BeeAX aplica límites de tasa para garantizar la estabilidad del sistema:
...
* Verifica que los formatos cumplan los requisitos de BeeAX (consulta [Asignación de campos](/l/es/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica que los datos aparezcan correctamente en BeeAX
...
Contáctanos en [contact@beeax.com](mailto:contact@beeax.com) o explora nuestros [Servicios de implementación](/l/es/user-guide/getting-started/capabilities/implementation-services).
