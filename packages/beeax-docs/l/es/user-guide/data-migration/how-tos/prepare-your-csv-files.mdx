...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en BeeAX.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que BeeAX espera.
...
BeeAX exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en BeeAX
...
* Debe ser único (sin duplicados en el archivo ni en BeeAX)
...
* Debe ser único dentro de tu archivo y en BeeAX
...
* **Enlaces / Etiqueta del enlace**: `BeeAX`
* **Enlaces / URL del enlace**: `https://beeax.com`
...
* **Opcional**: BeeAX genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en BeeAX
...
## Paso 6: Asegúrate de que los campos existan en BeeAX
