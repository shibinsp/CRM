...
Cuando cargas un archivo, BeeAX analiza las columnas e intenta hacerlas coincidir con los campos existentes.

### Asignación automática

BeeAX intenta hacer coincidir las columnas en función de:
...
<Note>**Consejo rápido:** Exporta algunas filas del objeto que quieres importar. El archivo exportado tendrá los nombres de columna exactos que BeeAX espera, lo que hará que la asignación automática sea fluida durante la importación.</Note>

### Opciones de asignación manual

Para cada columna, puedes:

* **Asignar a un campo**: Selecciona el campo correspondiente de BeeAX desde un menú desplegable
...
Es opcional especificar un `id` durante la importación. BeeAX lo genera automáticamente si no se proporciona.
