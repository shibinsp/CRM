...
BeeAX admite importar relaciones entre objetos durante la importación de CSV. Esto te permite vincular registros (p. ej., adjuntar Personas a Empresas) como parte de tu migración de datos.
...
## Cómo funcionan las relaciones en BeeAX

### De uno a muchos / de muchos a uno

BeeAX admite relaciones estándar en las que un registro se vincula a muchos otros:
...
Antes de importar el lado de "muchos", los registros del lado de "uno" ya deben existir en BeeAX.
...
4. BeeAX vinculará automáticamente cada registro con el padre correspondiente
...
<Note>**Vinculación a Miembros del espacio de trabajo**: Cuando la relación apunta a Miembros del espacio de trabajo (tu equipo que inicia sesión en BeeAX), haz referencia a su **dirección de correo electrónico**, no a su nombre.</Note>
