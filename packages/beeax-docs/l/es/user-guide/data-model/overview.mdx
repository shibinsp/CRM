...
BeeAX incluye objetos estándar:
...
Cada empresa funciona de manera diferente. Personalizar tu modelo de datos significa que puedes adaptar BeeAX a **tus** procesos en lugar de forzar los tuyos en un sistema rígido.

BeeAX ofrece total flexibilidad:
...
Identifica los conceptos principales con los que trabajas. BeeAX ya ofrece:
