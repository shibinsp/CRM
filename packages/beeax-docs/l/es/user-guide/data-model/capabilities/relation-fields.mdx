...
Las relaciones de muchos a muchos usan un patrón de **objeto de unión**: un objeto intermedio que conecta ambos lados. Con la función de relaciones de unión, BeeAX muestra directamente los registros finales vinculados, ocultando el objeto intermedio de la UI.
...
BeeAX incluye relaciones predefinidas entre objetos estándar:
