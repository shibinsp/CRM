...
BeeAX utiliza un patrón de **objeto de unión** para las relaciones de muchos a muchos. Un objeto de unión se sitúa entre dos objetos y contiene las conexiones:
...
Cuando activas el interruptor de relación de unión, BeeAX muestra los registros vinculados directamente en lugar de mostrar los registros intermedios de unión.
