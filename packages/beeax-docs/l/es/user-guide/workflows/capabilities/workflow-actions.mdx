...
description: Conoce las acciones disponibles en los flujos de trabajo de BeeAX.
---
...
<Note>
Solo puede enviar correos desde buzones sincronizados con su propia cuenta de BeeAX. El envío desde los buzones de otros miembros del equipo (p. ej., el correo del propietario de la cuenta) está en la hoja de ruta.
</Note>
