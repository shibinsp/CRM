...
**Por qué sucede esto**: BeeAX guarda todo en tiempo real; no hay un modo separado de "editar" y "lectura". Cuando creas un registro, se guarda de inmediato, lo que activa el evento "Record is created" antes de que puedas completar campos adicionales.
...
* Primero prueba la llamada a la API fuera de BeeAX
