---
title: Generar una cotización o una factura desde BeeAX
...
* [Generar un PDF desde BeeAX](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — adjuntar los PDF generados a los registros
