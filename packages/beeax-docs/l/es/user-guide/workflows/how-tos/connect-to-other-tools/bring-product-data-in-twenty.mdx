---
title: Incorporar datos de productos en BeeAX
description: Sincroniza los datos del catálogo de productos desde un almacén de datos a tu CRM según una programación.
---

Usa este patrón para mantener BeeAX sincronizado con los datos de productos de tu almacén de datos (p. ej., Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Crear o actualizar en BeeAX
