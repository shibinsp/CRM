---
title: Generar un PDF desde BeeAX
description: Cree un flujo de trabajo para generar y adjuntar un PDF (como una cotización) a un registro.
---

Genere u obtenga automáticamente un PDF y adjúntelo a un registro en BeeAX. Esto se usa comúnmente para crear cotizaciones, facturas o informes vinculados a Empresas, Oportunidades u otros objetos.
...
* [Generar una cotización o factura desde BeeAX](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
