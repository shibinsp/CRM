...
En BeeAX, esa huella se almacena como `headerMessageId` en el objeto Message. Tu flujo de trabajo la toma y la pasa al campo In-Reply-To de la acción Send Email.
...
Cada vez que un correo electrónico llega a BeeAX, esto se activa.
...
* **Responder solo a VIPs** — añade una rama que compruebe el dominio del remitente o si existe como Contact en BeeAX
