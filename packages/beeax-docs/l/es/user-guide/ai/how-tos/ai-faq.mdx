...
description: Preguntas frecuentes sobre las funciones de IA en BeeAX.
---
...
<AccordionGroup>
  ...
  <Accordion title="¿Qué capacidades de IA están previstas?">
    ...
    1. **Chatbot de IA**: Un asistente con conocimiento del contexto que puede acceder a tus datos de BeeAX y ayudarte con consultas
  ...
  <Accordion title="¿Puedo usar mis propios modelos de IA?">
    Inicialmente, BeeAX utilizará modelos de IA integrados. El soporte para modelos de IA personalizados o externos podría añadirse en versiones futuras según los comentarios de los usuarios.
  </Accordion>
