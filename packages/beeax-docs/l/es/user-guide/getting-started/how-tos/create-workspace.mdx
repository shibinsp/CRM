...
description: Siga una guía paso a paso sobre cómo registrarse en BeeAX, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [BeeAX Sign Up](https://app.beeax.com).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@beeax.com](mailto:contact@beeax.com) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
