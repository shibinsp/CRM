---
title: Glosario
description: Familiarízate con la terminología esencial utilizada en BeeAX.
---

## API

La API (Interfaz de Programación de Aplicaciones) permite conectar BeeAX con otros sistemas de software y construir integraciones personalizadas.
...
Las Oportunidades en el CRM de BeeAX son posibles tratos o ventas con cuentas o contactos.
...
Las Tareas en el CRM de BeeAX son actividades asignadas relacionadas con contactos, cuentas u oportunidades.
...
Los Webhooks son mensajes automatizados que se envían desde BeeAX a otras aplicaciones cuando ocurren eventos específicos, habilitando la sincronización de datos en tiempo real.
...
Un `Espacio de Trabajo` típicamente representa una empresa que usa BeeAX. Contiene todos los registros y datos que tú y los miembros de tu equipo añaden a BeeAX.
...
Los Miembros del Espacio de Trabajo son los usuarios de BeeAX de tu equipo que tienen acceso a tu espacio de trabajo. Pueden asignarse como propietarios o responsables de registros.
