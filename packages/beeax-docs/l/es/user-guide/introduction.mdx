...
description: Bienvenido a la Guía del usuario de BeeAX, tu recurso para configuraciones avanzadas y mejores prácticas.
---
...
<CardGroup cols={3}>
  ...
  <Card href="/l/es/user-guide/permissions-access/overview" img="/images/user-guide/halftone/permissions.png">
    ...
    Gestiona los roles y el acceso a BeeAX.
  </Card>

  <Card href="/l/es/user-guide/billing/overview" img="/images/user-guide/halftone/billing.png">
    <CardTitle>Facturación</CardTitle>
    Comprende cómo funcionan los precios y la facturación de BeeAX.
  </Card>
