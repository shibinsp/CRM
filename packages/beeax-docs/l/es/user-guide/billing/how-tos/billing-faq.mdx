...
description: Preguntas frecuentes sobre los precios y la facturación de BeeAX.
---

## Precios

<AccordionGroup>
<Accordion title="¿Puedo usar BeeAX gratis mientras lo alojo por mi cuenta?">
Sí, puedes usar BeeAX gratis mientras lo alojas por tu cuenta. Tendrás acceso a todo lo incluido en el plan Pro (nube), excepto el soporte de nuestro equipo central. El soporte está disponible a través de nuestra comunidad en Discord.

Si quieres alojar por tu cuenta y necesitas las funciones Premium (SSO y permisos a nivel de registro), puedes elegir la licencia de pago de Organization (Self-Hosted). Esto también incluye soporte del equipo de BeeAX y elimina el requisito de publicar el código personalizado como código abierto antes de distribuirlo.
</Accordion>
...
No ofrecemos asientos gratuitos. El precio es por usuario y cada usuario necesita una licencia para acceder a BeeAX.
</Accordion>
