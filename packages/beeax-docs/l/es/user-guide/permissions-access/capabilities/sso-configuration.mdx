...
El inicio de sesión único (SSO) permite que los miembros de su equipo inicien sesión en BeeAX utilizando el proveedor de identidad de su organización. Esto proporciona:
...
* Acceso de administrador al espacio de trabajo de BeeAX

<Note>
**Para usuarios de autoalojamiento que deseen configurar SSO**, comuníquese con contact@beeax.com
</Note>
...
* Elimínelos del espacio de trabajo de BeeAX
...
* **Asignación de grupos**: Asigne los grupos del IdP a roles de BeeAX (si está disponible)
* **Proceso de desvinculación**: Incluya BeeAX en su flujo de trabajo de desaprovisionamiento
