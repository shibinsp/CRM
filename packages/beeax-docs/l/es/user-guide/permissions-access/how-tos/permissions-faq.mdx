...
<AccordionGroup>
<Accordion title="¿Qué roles incluye BeeAX por defecto?">
BeeAX incluye los roles **Admin** y **Member** por defecto. Puedes crear roles personalizados adicionales según las necesidades de tu equipo (p. ej., Representante de ventas, Gerente, Usuario de solo lectura).
</Accordion>
...
Puedes controlar:
* **Send Email**: Capacidad para enviar correos desde BeeAX
...
Con el aprovisionamiento JIT, las cuentas de usuario se crean automáticamente en BeeAX cuando alguien inicia sesión mediante SSO por primera vez. Se les asigna automáticamente el rol predeterminado.
</Accordion>
