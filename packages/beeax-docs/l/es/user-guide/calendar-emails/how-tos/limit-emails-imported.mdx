...
description: Controla qué correos electrónicos se importan en BeeAX.
---

## Resumen

De forma predeterminada, BeeAX sincroniza todos los correos electrónicos externos de tu buzón conectado. Puedes limitar lo que se importa usando la **selección de carpetas** y los **ajustes de visibilidad**.
