---
title: Buzón
description: Comprender las funciones de integración de correo electrónico en BeeAX.
---
...
BeeAX vincula automáticamente los correos electrónicos de sus buzones conectados a los registros CRM relevantes, manteniendo todo el historial de comunicación en un solo lugar.
...
BeeAX importa correos electrónicos a aproximadamente **400 mensajes por minuto**. Actualmente, esta tasa está limitada por la limitación de tasa de la API de Gmail (y se aplica de manera similar a otros proveedores).
...
* **Correos Faltantes**: Compruebe si:
  ...
  * La creación automática de contactos está desactivada (los correos necesitan registros existentes de BeeAX)
