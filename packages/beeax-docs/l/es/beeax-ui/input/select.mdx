...
<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="Encabezado" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Opción A', Icon: IconBeeAXStar },
        { value: 'option2', label: 'Opción B', Icon: IconBeeAXStar },
      ]}
      value="option1"
    />
  );
