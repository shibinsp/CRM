...
BeeAX implementa OAuth 2.0 con código de autorización + PKCE para aplicaciones orientadas al usuario y credenciales de cliente para acceso de servidor a servidor. Los clientes se registran dinámicamente mediante [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) — sin configuración manual en un panel.
...
| Aplicación de BeeAX con extensiones de UI           | [Aplicaciones](/l/es/developers/extend/apps/getting-started) (OAuth se gestiona automáticamente) |

## Registrar un cliente

BeeAX admite el **registro dinámico de clientes** según [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591). No se necesita configuración manual — regístrelo de forma programática:
...
Use este flujo cuando su aplicación actúe en nombre de un usuario de BeeAX.
...
Tras la autorización, BeeAX redirige de vuelta a su `redirect_uri`:
...
BeeAX publica su configuración de OAuth en un endpoint de descubrimiento estándar:
