...
La **capa de configuración** de una app de BeeAX es lo que describe la app *a la plataforma*: su identidad, los permisos que posee y el código que se ejecuta durante la instalación o la actualización. Estas declaraciones no añaden nuevas estructuras de datos ni comportamiento en tiempo de ejecución; le indican a BeeAX *quién es la app* y *cómo configurarla*.
