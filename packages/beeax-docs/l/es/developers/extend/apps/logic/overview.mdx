---
title: Resumen
description: TypeScript del lado del servidor que se ejecuta dentro de BeeAX, activado por rutas HTTP, programaciones cron, eventos de base de datos, herramientas de IA o acciones de flujos de trabajo.
icon: bolt
---

La **capa de lógica** de una app de BeeAX es el código que *se ejecuta*: controladores de TypeScript del lado del servidor que reaccionan a solicitudes HTTP, programaciones cron y cambios en registros; habilidades y agentes de IA que viven dentro del espacio de trabajo; y conexiones OAuth que permiten que tus funciones actúen en nombre de un usuario en servicios de terceros.
...
| **Herramienta de IA**           | Una funcionalidad de IA de BeeAX decide llamar a tu función    | `toolTriggerSettings`           |
