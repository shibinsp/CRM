...
Las relaciones conectan dos objetos entre sí. En BeeAX, las relaciones siempre son **bidireccionales**: cada relación tiene dos lados, y cada lado se declara como un campo que hace referencia al otro.
...
Para crear una relación con un objeto integrado de BeeAX (Person, Company, etc.), usa `STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS`:
