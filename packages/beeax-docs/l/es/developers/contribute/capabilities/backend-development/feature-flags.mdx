...
Los indicadores de característica se usan para ocultar características experimentales. Para BeeAX, se configuran a nivel de espacio de trabajo y no a nivel de usuario.
