...
Los objetos son estructuras que te permiten almacenar datos (registros, atributos y valores) específicos de una organización. BeeAX proporciona tanto objetos estándar como personalizados.

Los objetos estándar son objetos incorporados con un conjunto de atributos disponibles para todos los usuarios. Ejemplos de objetos estándar en BeeAX incluyen Empresa y Persona. Los objetos estándar tienen campos estándar que también están disponibles para todos los usuarios de BeeAX, como Company.displayName.
