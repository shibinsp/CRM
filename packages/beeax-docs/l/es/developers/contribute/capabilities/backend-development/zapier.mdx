...
Sincroniza sin esfuerzo BeeAX con más de 3000 aplicaciones usando [Zapier](https://zapier.com/). ¡Automatiza tareas, mejora la productividad y potencia tus relaciones con los clientes!
...
Desde la carpeta `packages/beeax-zapier`, ejecuta:
