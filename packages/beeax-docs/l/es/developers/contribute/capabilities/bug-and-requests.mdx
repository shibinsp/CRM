...
Para reportar un error, por favor [crea un problema en GitHub](https://github.com/beeax/beeax/issues/new).

También puedes pedir ayuda en [Discord](https://discord.gg/cx5n4Jzs57).

## Solicitudes de funciones

Si no estás seguro de si es un error y sientes que está más cerca de una solicitud de función, entonces probablemente deberías [abrir una discusión en su lugar](https://github.com/beeax/beeax/discussions/new).

## Envía un pull request

Contribuir código a BeeAX comienza con un pull request (PR).

### Antes de empezar

1. Consulta [los issues existentes](https://github.com/beeax/beeax/issues) para ver trabajos relacionados
2. Para nuevas funcionalidades, abre primero un issue para discutir
3. Revisa nuestro [Código de conducta](https://github.com/beeax/beeax/blob/main/CODE_OF_CONDUCT.md)
