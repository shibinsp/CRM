...
info: Aprende cómo puedes colaborar con BeeAX en Figma
---
...
1. **Accede al enlace compartido:** Puedes acceder al archivo de Figma del proyecto [aquí](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/BeeAX).
...
En la barra lateral izquierda, puedes acceder a las diferentes páginas del Figma de BeeAX. Así es como están organizadas:
