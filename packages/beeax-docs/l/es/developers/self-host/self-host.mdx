...
description: Despliega y administra BeeAX en tu propia infraestructura.
---
...
Puedes autoalojar BeeAX en tu propia infraestructura, lo que te brinda control total sobre tus datos y el despliegue.
