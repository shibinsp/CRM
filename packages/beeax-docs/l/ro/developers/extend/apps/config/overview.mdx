...
**Stratul de configurare** al unei aplicații BeeAX este cel care descrie aplicația *pentru platformă* — identitatea ei, permisiunile pe care le deține și codul care rulează în timpul instalării sau actualizării. Aceste declarații nu adaugă noi structuri de date sau comportamente la rulare; ele îi spun lui BeeAX *cine este aplicația* și *cum să fie configurată*.
