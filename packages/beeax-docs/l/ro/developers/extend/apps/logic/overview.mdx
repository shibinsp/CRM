...
description: TypeScript pe server care rulează în BeeAX — declanșat de rute HTTP, programări cron, evenimente de bază de date, instrumente IA sau acțiuni de workflow.
icon: bolt
---

**Stratul de logică** al unei aplicații BeeAX este codul care *rulează* — handler-e TypeScript pe server care reacționează la cereri HTTP, programări cron și modificări ale înregistrărilor; abilități și agenți IA care trăiesc în workspace; și conexiuni OAuth care permit funcțiilor tale să acționeze în numele utilizatorului în servicii terțe.
...
| **Instrument IA**             | O funcționalitate IA din BeeAX decide să apeleze funcția ta      | `toolTriggerSettings`           |
