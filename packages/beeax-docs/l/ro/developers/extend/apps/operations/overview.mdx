...
**Stratul de operațiuni** este tot ceea ce faci *asupra* aplicației tale, mai degrabă decât *cu* ea: invocarea comenzilor CLI, rularea testelor de integrare pe un server BeeAX real, configurarea CI și livrarea versiunilor — fie ca un tarball implementat pe un singur server, fie ca un pachet npm listat în marketplace.
...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/l/ro/developers/extend/apps/operations/cli">
    Referință pentru `yarn beeax` — exec, logs, uninstall, remotes.
  </Card>
