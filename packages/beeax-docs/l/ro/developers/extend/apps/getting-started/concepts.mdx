---
title: Concepte
description: Cum funcționează aplicațiile BeeAX — modelul de entități, izolarea (sandboxing) și ciclul de viață al instalării.
icon: sitemap
---
...
| **Componentă front-end**          | Interfață React izolată (sandboxed) în BeeAX              | [Componente front-end](/l/ro/developers/extend/apps/layout/front-components)       |
...
* **`yarn beeax dev:build`** — compilează TypeScript, împachetează funcțiile logice și componentele front-end cu esbuild și produce un manifest.
