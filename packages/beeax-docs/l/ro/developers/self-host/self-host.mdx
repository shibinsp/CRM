...
description: Implementați și gestionați BeeAX pe propria infrastructură.
---

<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="AI" />
</Frame>

## Prezentare generală

BeeAX poate fi găzduit în regim propriu pe propria infrastructură, oferindu-vă control complet asupra datelor și a implementării.
