...
Pentru a raporta o eroare, te rog [creează o problemă pe GitHub](https://github.com/beeax/beeax/issues/new).

Poți de asemenea să ceri ajutor pe [Discord](https://discord.gg/cx5n4Jzs57).

## Cereri de Funcționalități

Dacă nu ești sigur că este o eroare și simți că este mai aproape de o cerere de funcționalitate, atunci ar trebui probabil să [deschizi în loc o discuție](https://github.com/beeax/beeax/discussions/new).

## Trimiteți un pull request

Contribuirea cu cod la BeeAX începe cu un pull request (PR).

### Înainte de a începe

1. Verificați [problemele existente](https://github.com/beeax/beeax/issues) pentru lucrări conexe
2. Pentru funcționalități noi, deschideți mai întâi o problemă pentru a discuta
3. Consultați [Codul de conduită](https://github.com/beeax/beeax/blob/main/CODE_OF_CONDUCT.md)
