...
Sincronizează fără efort BeeAX cu peste 3000 de aplicații folosind [Zapier](https://zapier.com/). Automatizează sarcinile, stimulează productivitatea și îmbunătățește relațiile cu clienții!
...
Din folderul `packages/beeax-zapier`, rulează:
