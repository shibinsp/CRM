...
Steagurile de caracteristici sunt utilizate pentru a ascunde caracteristici experimentale. Pentru BeeAX, acestea sunt setate la nivel de spațiu de lucru și nu la nivel de utilizator.
