...
description: Întrebări frecvente despre funcționalitățile IA din BeeAX.
---
...
<AccordionGroup>
  ...
  <Accordion title="Ce capabilități IA sunt planificate?">
    ...
    1. **Chatbot IA**: Un asistent conștient de context care poate accesa datele dvs. din BeeAX și vă poate ajuta cu întrebări
  ...
  <Accordion title="Pot folosi propriile modele IA?">
    Inițial, BeeAX va utiliza modele IA integrate. Suportul pentru modele IA personalizate sau externe poate fi adăugat în versiunile viitoare, pe baza feedbackului utilizatorilor.
  </Accordion>
