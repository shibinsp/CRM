...
description: Urmați un ghid pas cu pas despre cum să vă înregistrați pe BeeAX, să alegeți un plan de abonament și să vă configurați contul.
---
...
1. Navigați la [BeeAX Sign Up](https://app.beeax.com).
...
Pentru întrebări sau ajutor, contactați echipa de suport dedicată la [contact@beeax.com](mailto:contact@beeax.com) sau trimiteți un mesaj pe [Discord](https://discord.gg/cx5n4Jzs57).
