---
title: Ce este BeeAX
description: BeeAX este un CRM cu sursă deschisă care vă oferă elementele de bază pentru a crea exact ceea ce are nevoie afacerea dvs.
---
...
La început, BeeAX arată ca majoritatea CRM-urilor pe care le cunoașteți deja: puteți urmări oferte, organiza contacte, gestiona sarcini și note.
...
Open-source este fundamentul abordării noastre, asigurându-ne că BeeAX evoluează cu comunitatea sa, pentru comunitatea sa.
...
[Înregistrați-vă aici](https://app.beeax.com) sau [deveniți contributor pe GitHub](https://github.com/beeax/beeax).
