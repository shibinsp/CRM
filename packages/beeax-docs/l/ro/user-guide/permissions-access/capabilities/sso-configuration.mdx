...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în BeeAX folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru BeeAX

<Note>
**Pentru utilizatorii care se auto-găzduiesc și doresc să configureze SSO**, contactați contact@beeax.com
</Note>
...
* Eliminați-i din spațiul de lucru BeeAX
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile BeeAX (dacă este disponibilă)
* **Proces de offboarding**: Includeți BeeAX în fluxul dvs. de deprovisionare
