...
<AccordionGroup>
<Accordion title="Ce roluri sunt incluse implicit în BeeAX?">
BeeAX include în mod implicit rolurile **Admin** și **Member**. Puteți crea roluri personalizate suplimentare în funcție de nevoile echipei dvs. (de exemplu, Reprezentant de vânzări, Manager, Utilizator doar pentru citire).
</Accordion>
...
Puteți controla:
* **Send Email**: Posibilitatea de a trimite e-mailuri din BeeAX
...
Cu provisionarea JIT, conturile de utilizator sunt create automat în BeeAX atunci când cineva se autentifică prin SSO pentru prima dată. Li se atribuie automat rolul implicit.
</Accordion>
