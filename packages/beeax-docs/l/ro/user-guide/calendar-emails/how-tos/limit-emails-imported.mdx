...
description: Controlați ce e-mailuri sunt importate în BeeAX.
---

## Prezentare generală

În mod implicit, BeeAX sincronizează toate e-mailurile externe din căsuța poștală conectată. Puteți limita ce se importă folosind **selecția de dosare** și **setările de vizibilitate**.
