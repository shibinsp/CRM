...
description: Înțelegerea funcțiilor de integrare a emailului în BeeAX.
---
...
BeeAX leagă automat e-mailurile din căsuțele poștale conectate la înregistrările CRM relevante, păstrând toate istoricul comunicațiilor într-un singur loc.
...
BeeAX importă e-mailuri cu aproximativ **400 de mesaje pe minut**. Această rată este în prezent limitată de restricțiile de rată ale API-ului Gmail (și se aplică în mod similar altor furnizori).
...
* **E-mailuri lipsă**: Verificați dacă:
  ...
  * Crearea automată a contactelor este dezactivată (e-mailurile necesită existența înregistrărilor BeeAX)
