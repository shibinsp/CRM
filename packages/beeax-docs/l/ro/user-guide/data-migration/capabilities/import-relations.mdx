...
BeeAX acceptă importul relațiilor dintre obiecte în timpul importului CSV. Acest lucru vă permite să conectați înregistrări (de ex., să atașați Persoane la Companii) ca parte a migrării datelor.
...
## Cum funcționează relațiile în BeeAX

### Unu la mulți / Mulți la unu

BeeAX acceptă relații standard în care o înregistrare se leagă de multe altele:
...
Înainte de a importa partea „mulți”, înregistrările de pe partea „unu” trebuie să existe deja în BeeAX.
...
4. BeeAX va lega automat fiecare înregistrare de părintele corespunzător
...
<Note>**Conectarea la Membrii Workspace-ului**: Când relația indică către Membrii Workspace-ului (echipa dvs. care se autentifică în BeeAX), referiți-vă la ei prin **adresa de email**, nu prin nume.</Note>
