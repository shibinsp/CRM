...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în BeeAX.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă BeeAX.
...
BeeAX impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în BeeAX
...
* Trebuie să fie unic (fără duplicate în fișier sau în BeeAX)
...
* Trebuie să fie unic în fișierul dvs. și în BeeAX
...
* **Linkuri / Etichetă link**: `BeeAX`
* **Linkuri / URL link**: `https://beeax.com`
...
* **Opțional**: BeeAX generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în BeeAX
...
## Pasul 6: Asigurați-vă că câmpurile există în BeeAX
