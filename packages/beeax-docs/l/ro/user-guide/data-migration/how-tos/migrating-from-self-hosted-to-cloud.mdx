...
description: Ghid pas cu pas pentru migrarea instanței BeeAX auto-găzduite la BeeAX Cloud.
---

## Prezentare generală

Acest ghid vă ghidează prin migrarea datelor dvs. dintr-o instanță BeeAX auto-găzduită către BeeAX Cloud. Procesul presupune configurarea spațiului dvs. de lucru în cloud, exportarea datelor și reimportarea acestora.
...
1. Accesați [app.beeax.com](https://app.beeax.com) și creați un nou spațiu de lucru
...
Pentru migrarea complexă sau seturi mari de date, contactați-ne la [contact@beeax.com](mailto:contact@beeax.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
