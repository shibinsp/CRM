...
description: Ghid pas cu pas pentru migrarea datelor din orice CRM către BeeAX.
---

## Prezentare generală

Acest ghid vă ghidează prin procesul de migrare a datelor din orice CRM către BeeAX. Procesul implică auditarea datelor, pregătirea spațiului de lucru BeeAX, exportul din sistemul curent și importul în BeeAX.
...
Creați un document de mapare între CRM-ul curent și BeeAX:
...
## Pasul 3: Configurați spațiul dvs. de lucru BeeAX

Înainte de a importa date, pregătiți spațiul dvs. de lucru BeeAX:
...
Dacă datele dvs. includ referințe la utilizatori (Proprietar cont, Atribuit etc.), acei utilizatori trebuie să existe în BeeAX înainte de import. În caz contrar, acele relații nu pot fi mapate.
</Warning>
...
Deschideți fiecare CSV exportat într-o aplicație de calcul tabelar și pregătiți-l pentru BeeAX.
...
3. Verificați că nu există deja duplicate în BeeAX
...
Folosiți `https://domain.com` (nu `domain.com` sau `www.domain.com`). Acest lucru corespunde formatului BeeAX și previne duplicatele când conectați sincronizarea e-mailului/calendarului.
</Warning>
...
2. Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a se alătura spațiului dvs. de lucru BeeAX
...
* BeeAX va începe să sincronizeze e-mailurile cu înregistrările de contact
...
<AccordionGroup>
  <Accordion title="Pot migra fluxurile de lucru automat?">
    Momentan, nu. Fluxurile de lucru trebuie recreate manual în BeeAX.
  </Accordion>
...
Contactați [contact@beeax.com](mailto:contact@beeax.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
