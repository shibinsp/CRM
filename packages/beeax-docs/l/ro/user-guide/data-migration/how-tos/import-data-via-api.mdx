...
description: Când și cum să utilizați API-urile BeeAX pentru importuri de date la scară mare.
---

## Prezentare generală

BeeAX oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
BeeAX impune limitări de rată pentru a asigura stabilitatea sistemului:
...
BeeAX acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor BeeAX (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în BeeAX
...
Contactați-ne la [contact@beeax.com](mailto:contact@beeax.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
