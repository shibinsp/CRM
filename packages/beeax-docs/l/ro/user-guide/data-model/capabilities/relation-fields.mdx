...
Relațiile de tip multe-la-multe folosesc un model de tip **obiect de legătură**: un obiect intermediar care conectează ambele părți. Cu funcția de relație cu obiect de legătură, BeeAX afișează direct înregistrările finale asociate, ascunzând obiectul intermediar din UI.
...
BeeAX include relații predefinite între obiectele standard:
