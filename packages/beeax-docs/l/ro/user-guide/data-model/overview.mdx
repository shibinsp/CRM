...
BeeAX include obiecte standard:
...
Fiecare afacere funcționează diferit. Personalizarea modelului tău de date înseamnă că poți modela BeeAX în jurul proceselor **tale**, în loc să le forțezi într-un sistem rigid.

BeeAX oferă flexibilitate totală:
...
Identifică principalele concepte cu care lucrezi. BeeAX oferă deja:
