...
BeeAX folosește un model de **obiect de legătură** pentru relațiile mulți-la-mulți. Un obiect de legătură se află între două obiecte și păstrează conexiunile:
...
Când activați comutatorul pentru relația de legătură, BeeAX afișează înregistrările legate direct, în loc să afișeze înregistrările intermediare ale obiectului de legătură.
