...
description: Întrebări frecvente despre setările BeeAX.
---
...
Pentru a vă schimba adresa de e-mail, vă rugăm să ne contactați la [contact@beeax.com](mailto:contact@beeax.com).
</Accordion>
...
* **Subdomeniu**: Folosiți un subdomeniu BeeAX, de exemplu `yourcompany.beeax.com`
