...
description: Aflați despre planurile tarifare ale BeeAX și cum să comutați între ele.
---

## Prezentare generală

BeeAX oferă prețuri flexibile care se potrivesc echipelor de orice dimensiune, fie că preferați găzduirea în cloud sau autogăzduirea.
...
Găzduiți BeeAX pe propria infrastructură, fără costuri:
...
* **Funcționalități Premium**: integrare SSO, permisiuni la nivel de rând și date privind utilizarea AI
* Asistență din partea echipei BeeAX
