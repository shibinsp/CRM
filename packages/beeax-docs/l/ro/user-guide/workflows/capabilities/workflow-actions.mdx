...
description: Aflați despre acțiunile disponibile în fluxurile de lucru BeeAX.
---
...
<Note>
Puteți trimite emailuri doar din căsuțele poștale sincronizate cu propriul dvs. cont BeeAX. Trimiterea din căsuțele poștale ale altor membri ai echipei (de ex., emailul proprietarului contului) este pe roadmap.
</Note>
