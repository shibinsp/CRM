---
title: Importați datele despre produse în BeeAX
description: Sincronizați datele catalogului de produse dintr-un depozit de date în CRM-ul dvs., conform unui program.
---

Folosiți acest model pentru a menține BeeAX sincronizat cu datele despre produse din depozitul dvs. de date (de ex., Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Creați sau actualizați în BeeAX
