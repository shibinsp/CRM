---
title: Generați o ofertă sau o factură din BeeAX
...
* [Generați un PDF din BeeAX](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — atașați PDF-uri generate la înregistrări
