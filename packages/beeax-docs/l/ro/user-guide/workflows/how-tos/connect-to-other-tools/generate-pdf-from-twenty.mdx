---
title: Generați un PDF din BeeAX
description: Creați un flux de lucru pentru a genera și atașa un PDF (de exemplu, o ofertă) la o înregistrare.
---

Generați sau preluați automat un PDF și atașați-l la o înregistrare în BeeAX. Aceasta este utilizată frecvent pentru a crea oferte, facturi sau rapoarte care sunt asociate cu Companii, Oportunități sau alte obiecte.
...
2. Încărcarea fișierului în BeeAX
...
* [Generați o ofertă sau o factură din BeeAX](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
