...
**De ce se întâmplă asta**: BeeAX salvează totul în timp real — nu există moduri separate "edit" vs "read". Când creați o înregistrare, aceasta este salvată imediat, declanșând evenimentul "Record is created" înainte să puteți completa câmpuri suplimentare.
...
* Testați mai întâi apelul API în afara BeeAX
