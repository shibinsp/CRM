---
title: Postfach
description: E-Mail-Integrationsfunktionen in BeeAX verstehen.
---
...
BeeAX verknüpft E-Mails automatisch aus Ihren verknüpften Postfächern mit den relevanten CRM-Datensätzen, um den gesamten Kommunikationsverlauf an einem Ort zu halten.
...
BeeAX importiert E-Mails mit ungefähr **400 Nachrichten pro Minute**. Diese Rate ist derzeit durch das Ratenlimit der Gmail-API begrenzt (und gilt ähnlich für andere Anbieter).
...
* **Fehlende E-Mails**: Prüfen Sie, ob:
  ...
  * Die automatische Erstellung von Kontakten deaktiviert ist (E-Mails benötigen vorhandene BeeAX-Datensätze)
