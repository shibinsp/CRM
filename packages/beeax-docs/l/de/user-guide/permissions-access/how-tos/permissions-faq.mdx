...
<AccordionGroup>
<Accordion title="Welche Rollen sind in BeeAX standardmäßig enthalten?">
BeeAX enthält standardmäßig die Rollen **Admin** und **Member**. Sie können je nach Bedarf Ihres Teams zusätzliche benutzerdefinierte Rollen erstellen (z. B. Vertriebsmitarbeiter, Manager, Nur-Lese-Benutzer).
</Accordion>
...
Sie können steuern:
* **E-Mail senden**: Möglichkeit, E-Mails aus BeeAX zu senden
...
Mit JIT-Bereitstellung werden Benutzerkonten in BeeAX automatisch erstellt, wenn sich jemand zum ersten Mal über SSO anmeldet. Ihnen wird automatisch die Standardrolle zugewiesen.
</Accordion>
