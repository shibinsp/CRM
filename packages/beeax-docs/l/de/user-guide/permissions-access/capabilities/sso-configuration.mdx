...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei BeeAX anzumelden. Dies bietet:
...
* Administratorzugriff auf den BeeAX-Arbeitsbereich

<Note>
**Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@beeax.com
</Note>
...
* Entfernen Sie sie aus dem BeeAX-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen BeeAX-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie BeeAX in Ihren Deprovisioning-Workflow ein
