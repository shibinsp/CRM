---
title: Abrechnung
description: Verstehen Sie die Preisgestaltung von BeeAX und verwalten Sie Ihr Abonnement.
---

BeeAX bietet flexible Preispläne, die den Bedürfnissen Ihres Teams entsprechen. Verwalten Sie Ihr Abonnement, verfolgen Sie Workflow-Guthaben und greifen Sie auf Rechnungen zu – alles über **Einstellungen → Abrechnung**.

## Was enthält dieser Abschnitt

<CardGroup cols={2}>
  <Card title="Preispläne" icon="tags" href="/l/de/user-guide/billing/capabilities/pricing-plans">
    Erfahren Sie mehr über die Preispläne von BeeAX und was enthalten ist.
  </Card>
...
| **Organisation (Selbstgehostet)** | Alles aus Pro + die Premium-Funktionen (SSO, zeilenbezogene Berechtigungen), Support durch das BeeAX-Team, keine Pflicht, Ihren benutzerdefinierten Code vor der Verteilung als Open Source zu veröffentlichen |
...
**Kann ich BeeAX kostenlos nutzen?**
Ja! Hosten Sie BeeAX selbst und erhalten Sie alle Pro-Funktionen kostenlos.
