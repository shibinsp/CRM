...
Die linke Seitenleiste ist Ihre wichtigste Möglichkeit, in BeeAX zu navigieren. Sie ist vollständig anpassbar — Sie können sie neu organisieren, damit sie zu Ihrem Workflow passt, ohne eine Einstellungsseite zu öffnen.
