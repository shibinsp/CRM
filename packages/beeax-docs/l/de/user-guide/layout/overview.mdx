---
title: Layout
description: Passen Sie die Navigation, das Durchsuchen und die Anzeige von Datensätzen in BeeAX an.
---

Das Layout von BeeAX ist auf drei Ebenen anpassbar: wie Sie in der App navigieren, wie Sie Listen von Datensätzen durchsuchen und was Sie sehen, wenn Sie einen einzelnen Datensatz öffnen.
...
Ansichten steuern, wie Listen von Datensätzen angezeigt werden. BeeAX unterstützt drei Ansichtstypen:
