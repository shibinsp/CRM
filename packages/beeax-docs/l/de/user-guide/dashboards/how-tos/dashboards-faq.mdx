...
description: Häufig gestellte Fragen zu Dashboards in BeeAX.
---

<AccordionGroup>
  <Accordion title="Kann ich private Dashboards erstellen?">
    Nein, Dashboards sind derzeit für alle sichtbar, die Zugriff auf deinen BeeAX-Arbeitsbereich haben. Private Dashboards sind noch nicht verfügbar.
  </Accordion>
  ...
  <Accordion title="Kann ich Dashboards mit externen Benutzerinnen und Benutzern teilen?">
    Nein, das Teilen von Dashboards mit Benutzerinnen und Benutzern außerhalb deines BeeAX-Arbeitsbereichs (Nicht-BeeAX-Benutzer) wird derzeit nicht unterstützt.
  </Accordion>
