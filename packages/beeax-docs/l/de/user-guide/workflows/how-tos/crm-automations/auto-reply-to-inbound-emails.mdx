...
In BeeAX wird dieser Fingerabdruck als `headerMessageId` am Message-Objekt gespeichert. Ihr Workflow greift ihn auf und übergibt ihn an das Feld In-Reply-To der Aktion Send Email.
...
Jedes Mal, wenn eine E-Mail in BeeAX eingeht, wird dies ausgelöst.
...
* **Nur an VIPs antworten** — fügen Sie einen Zweig hinzu, der die Domain des Absenders prüft oder ob er in BeeAX als Kontakt existiert
