...
BeeAX unterstützt derzeit noch keine nativen Formelfelder (kommt 2026), aber Sie können dasselbe Ergebnis mithilfe von Workflows erreichen. Mit diesem Workaround können Sie Feldwerte automatisch berechnen und ausfüllen – von einfachen Verkettungen bis hin zu komplexer Geschäftslogik.
