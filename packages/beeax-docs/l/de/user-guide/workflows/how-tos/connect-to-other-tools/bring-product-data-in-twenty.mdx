---
title: Produktdaten in BeeAX importieren
description: Synchronisieren Sie Produktkatalogdaten nach Zeitplan aus einem Data Warehouse in Ihr CRM.
---

Verwenden Sie dieses Muster, um BeeAX mit Produktdaten aus Ihrem Data Warehouse (z. B. Snowflake, BigQuery, PostgreSQL) synchron zu halten.
...
5. **Upsert Record**: In BeeAX erstellen oder aktualisieren
