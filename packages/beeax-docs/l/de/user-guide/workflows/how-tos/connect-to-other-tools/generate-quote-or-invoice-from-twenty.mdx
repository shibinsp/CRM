---
title: Ein Angebot oder eine Rechnung aus BeeAX erstellen.
...
* [Ein PDF aus BeeAX generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — generierte PDFs an Datensätze anhängen
