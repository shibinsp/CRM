...
**Warum das passiert**: BeeAX speichert alles in Echtzeit — es gibt keinen separaten "edit"- vs. "read"-Modus. Wenn Sie einen Datensatz erstellen, wird er sofort gespeichert und löst das Ereignis "Record is created" aus, bevor Sie weitere Felder ausfüllen können.
...
* Testen Sie den API-Aufruf zunächst außerhalb von BeeAX
