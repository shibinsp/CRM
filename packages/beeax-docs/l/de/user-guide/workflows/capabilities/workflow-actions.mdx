...
description: Erfahren Sie mehr über die in BeeAX-Workflows verfügbaren Aktionen.
---
...
<Note>
You can only send emails from mailboxes synced to your own BeeAX account. Sending from other team members' mailboxes (e.g., the account owner's email) is on the roadmap.
</Note>
