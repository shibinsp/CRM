...
* Für POST-Anfragen definieren Sie die erwartete Body-Struktur, damit BeeAX weiß, welche Daten zu erwarten sind. Fügen Sie hier die Felder hinzu, die Sie erhalten und die weiter unten in Ihrem Workflow benötigt werden.
