...
2. **Daten in und aus BeeAX bringen**: Verbinden Sie BeeAX über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
...
* **Formular**: Eingaben von Benutzern innerhalb der BeeAX-Oberfläche zum Zeitpunkt der Ausführung abfragen
