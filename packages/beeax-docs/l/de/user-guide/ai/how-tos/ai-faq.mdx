---
title: KI-FAQ
description: Häufig gestellte Fragen zu KI-Funktionen in BeeAX.
---
...
<AccordionGroup>
  ...
  <Accordion title="Welche KI-Funktionen sind geplant?">
    ...
    1. **KI-Chatbot**: Ein kontextbewusster Assistent, der auf Ihre BeeAX-Daten zugreifen kann und Sie bei Anfragen unterstützt
  ...
  <Accordion title="Kann ich meine eigenen KI-Modelle verwenden?">
    Zunächst wird BeeAX integrierte KI-Modelle verwenden. Unterstützung für benutzerdefinierte oder externe KI-Modelle kann in zukünftigen Versionen basierend auf Nutzerfeedback hinzugefügt werden.
  </Accordion>
