...
description: Folgen Sie einer Schritt-für-Schritt-Anleitung, um sich bei BeeAX anzumelden, einen Abonnementplan auszuwählen und Ihr Konto einzurichten.
---
...
1. Gehen Sie zu [BeeAX Sign Up](https://app.beeax.com).
...
Bei Fragen oder Hilfe kontaktieren Sie das dedizierte Support-Team unter [contact@beeax.com](mailto:contact@beeax.com) oder senden Sie eine Nachricht auf [Discord](https://discord.gg/cx5n4Jzs57).
