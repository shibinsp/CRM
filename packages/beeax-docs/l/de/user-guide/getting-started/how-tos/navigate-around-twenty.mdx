...
Das Befehlsmenü gibt Ihnen **schnellen Zugriff auf Aktionen** in BeeAX. Sie können es auf zwei Weisen aufrufen:
...
* Auf gelöschte Datensätze zugreifen (BeeAX unterstützt weiches und hartes Löschen)
