---
title: Was ist BeeAX
description: BeeAX ist ein Open-Source-CRM, das Ihnen die Bausteine liefert, um genau das zu erstellen, was Ihr Unternehmen benötigt.
---
...
Zunächst sieht BeeAX aus wie die meisten CRMs, die Sie bereits kennen: Sie können Geschäfte verfolgen, Kontakte organisieren, Aufgaben und Notizen verwalten.
...
Open-Source ist das Fundament unseres Ansatzes, das sicherstellt, dass BeeAX sich mit seiner Gemeinschaft und für seine Gemeinschaft weiterentwickelt.
...
[Hier registrieren](https://app.beeax.com) oder [werden Sie ein Beitragender auf GitHub](https://github.com/beeax/beeax).
