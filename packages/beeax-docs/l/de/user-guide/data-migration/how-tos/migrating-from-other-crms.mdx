...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer Daten von jedem CRM zu BeeAX.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von jedem CRM zu BeeAX. Der Prozess umfasst die Überprüfung Ihrer Daten, die Vorbereitung Ihres BeeAX-Arbeitsbereichs, den Export aus Ihrem aktuellen System und den Import in BeeAX.
...
Erstellen Sie ein Zuordnungsdokument zwischen Ihrem aktuellen CRM und BeeAX:
...
## Schritt 3: Richten Sie Ihren BeeAX-Arbeitsbereich ein

Bereiten Sie Ihren BeeAX-Arbeitsbereich vor, bevor Sie Daten importieren:
...
Wenn Ihre Daten Benutzerreferenzen enthalten (Account Owner, Assignee usw.), müssen diese Benutzer vor dem Import in BeeAX existieren. Andernfalls können diese Beziehungen nicht zugeordnet werden.
</Warning>
...
Öffnen Sie jede exportierte CSV in einer Tabellenkalkulationsanwendung und bereiten Sie sie für BeeAX vor.
...
3. Überprüfen Sie, dass in BeeAX keine Duplikate vorhanden sind
...
Verwenden Sie `https://domain.com` (nicht `domain.com` oder `www.domain.com`). Dies entspricht dem Format von BeeAX und verhindert Duplikate, wenn Sie die E-Mail-/Kalendersynchronisierung verbinden.
</Warning>
...
2. Verwenden Sie dieselben E-Mail-Adressen, mit denen die Benutzer Ihrem BeeAX-Arbeitsbereich beigetreten sind
...
## Schritt 6: In BeeAX importieren
...
1. Navigieren Sie zum Objekt in BeeAX
...
* BeeAX beginnt, E-Mails mit Kontaktdatensätzen zu synchronisieren
...
<AccordionGroup>
  <Accordion title="Kann ich Workflows automatisch migrieren?">
    Derzeit nicht. Workflows müssen in BeeAX manuell neu erstellt werden.
  </Accordion>
...
Kontaktieren Sie [contact@beeax.com](mailto:contact@beeax.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
