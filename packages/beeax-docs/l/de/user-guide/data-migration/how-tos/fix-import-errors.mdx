...
Nachdem Sie Ihre Datei hochgeladen und die Spalten zugeordnet haben, validiert BeeAX Ihre Daten:

1. **Validierung läuft** — BeeAX prüft jede Zeile auf Fehler
...
| ------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| Doppelte Werte, gelb hervorgehoben                                             | Wert existiert bereits in BeeAX oder kommt in Ihrer Datei doppelt vor |
...
**Option 3: BeeAX den vorhandenen Datensatz aktualisieren lassen**
...
3. BeeAX aktualisiert den vorhandenen Datensatz, statt ein Duplikat zu erstellen
...
Solange ein eindeutiger Bezeichner übereinstimmt, aktualisiert BeeAX den Datensatz.
</Note>
...
3. Prüfen Sie, ob Datensätze bereits in BeeAX existieren
...
Das bedeutet, dass es in BeeAX kein Unternehmen mit diesem spezifischen Bezeichner gibt.
...
Sie versuchen, auf einen Datensatz zu verweisen, der in BeeAX nicht existiert.
...
Eine Spalte in Ihrer Datei kann nicht zugeordnet werden, weil das Feld in BeeAX nicht existiert.
...
1. **Benutzer hat seine Einladung nicht angenommen** — der Benutzer existiert noch nicht in BeeAX
2. **Benutzer-ID aus altem System verwendet** — BeeAX kann IDs aus einem anderen System nicht zuordnen
3. **Falsches E-Mail-Format** — die E-Mail entspricht nicht dem BeeAX-Konto des Benutzers

### So beheben Sie den Fehler

1. Stellen Sie sicher, dass alle Benutzer **ihre Einladung** zu Ihrem BeeAX-Arbeitsbereich **angenommen haben**
2. Verwenden Sie die **E-Mail-Adresse** des Benutzers (nicht seinen Namen oder die alte System-ID)
3. Verwenden Sie dieselbe E-Mail, mit der sie BeeAX beigetreten sind
...
<Check>Domain-Format entspricht exakt dem Format von BeeAX</Check>
...
1. **Beispieldatei herunterladen** — sehen Sie das genaue Format, das BeeAX erwartet
