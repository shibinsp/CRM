...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in BeeAX.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das BeeAX erwartet.
...
BeeAX erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in BeeAX bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in BeeAX)
...
* Muss innerhalb deiner Datei und in BeeAX eindeutig sein
...
* **Links / Link-Label**: `BeeAX`
* **Links / Link-URL**: `https://beeax.com`

Für sekundäre Links verwenden Sie die Spalte **Links / Sekundäre Links**:

```
[{"url":"https://beeax.com","label":"BeeAX"}]
```
...
* **Optional**: BeeAX erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in BeeAX vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in BeeAX vorhanden sind
