...
description: Wann und wie Sie die APIs von BeeAX für groß angelegte Datenimporte verwenden.
---

## Übersicht

BeeAX stellt sowohl **GraphQL**- als auch **REST-APIs** für den programmatischen Datenimport bereit. Verwenden Sie die API, wenn der CSV-Import für Ihr Datenvolumen nicht praktikabel ist oder wenn Sie automatisierte, wiederkehrende Importe benötigen.
...
BeeAX setzt Rate-Limits durch, um die Systemstabilität zu gewährleisten:
...
BeeAX unterstützt zwei API-Typen:
...
* Überprüfen Sie, ob die Formate den Anforderungen von BeeAX entsprechen (siehe [Feldzuordnung](/l/de/user-guide/data-migration/capabilities/field-mapping))
...
* Überprüfen Sie, ob die Daten in BeeAX korrekt angezeigt werden
...
Kontaktieren Sie uns unter [contact@beeax.com](mailto:contact@beeax.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
