...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten BeeAX-Instanz zu BeeAX Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten BeeAX-Instanz zu BeeAX Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.beeax.com](https://app.beeax.com) und erstellen Sie einen neuen Arbeitsbereich
...
Bei komplexen Migrationen oder großen Datenmengen kontaktieren Sie uns unter [contact@beeax.com](mailto:contact@beeax.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
