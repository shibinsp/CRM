...
Wenn Sie eine Datei hochladen, analysiert BeeAX Ihre Spalten und versucht, sie bestehenden Feldern zuzuordnen.

### Automatische Zuordnung

BeeAX versucht, Spalten anhand der folgenden Kriterien abzugleichen:

* Spaltenüberschriften (genaue oder ähnliche Übereinstimmungen)
* Erkennung des Datentyps (Datum, Zahlen, E-Mails)
* Häufige Feldmuster

<Note>**Schneller Tipp:** Exportieren Sie ein paar Zeilen aus dem Objekt, das Sie importieren möchten. Die exportierte Datei enthält genau die Spaltennamen, die BeeAX erwartet, sodass die automatische Zuordnung beim Import reibungslos funktioniert.</Note>

### Optionen für die manuelle Zuordnung

Für jede Spalte können Sie:

* **Einem Feld zuordnen**: Wählen Sie das passende BeeAX-Feld aus einem Dropdown aus
...
Die Angabe einer `id` während des Imports ist optional. BeeAX erzeugt automatisch eine, wenn keine angegeben wird.
