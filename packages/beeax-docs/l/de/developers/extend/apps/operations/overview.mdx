...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/l/de/developers/extend/apps/operations/cli">
    `yarn beeax`-Referenz – exec, logs, uninstall, remotes.
  </Card>
