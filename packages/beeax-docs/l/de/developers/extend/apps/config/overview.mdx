...
Die **Konfigurationsebene** einer BeeAX-App beschreibt die App *für die Plattform* – ihre Identität, die Berechtigungen, die sie hält, und den Code, der während der Installation oder Aktualisierung ausgeführt wird. Diese Deklarationen fügen keine neuen Datentypen oder Laufzeitverhalten hinzu; sie teilen BeeAX mit, *wer die App ist* und *wie sie eingerichtet werden soll*.
