...
* Der `objectUniversalIdentifier` identifiziert das Zielobjekt. Für Standard-BeeAX-Objekte importieren Sie die Konstante aus `beeax-sdk`:
...
* Um eine Registerkarte zu einem Standard-Seitenlayout hinzuzufügen (z. B. der Aufgaben- oder Unternehmensdetailseite), verwenden Sie [`definePageLayoutTab`](/l/de/developers/extend/apps/layout/page-layouts#definepagelayouttab) mit `STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS` aus `beeax-sdk/define`.
