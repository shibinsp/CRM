...
BeeAX implementiert OAuth 2.0 mit Autorisierungscode + PKCE für benutzerorientierte Apps und Client-Anmeldedaten für Server-zu-Server-Zugriff. Clients werden dynamisch über [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) registriert — keine manuelle Einrichtung in einem Dashboard.
...
| BeeAX-App mit UI-Erweiterungen                   | [Apps](/l/de/developers/extend/apps/getting-started) (OAuth wird automatisch gehandhabt) |

## Einen Client registrieren

BeeAX unterstützt die **dynamische Client-Registrierung** gemäß [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591). Keine manuelle Einrichtung erforderlich — registrieren Sie den Client programmgesteuert:
...
Verwenden Sie diesen Flow, wenn Ihre App im Namen eines BeeAX-Benutzers handelt.
...
Nach der Autorisierung leitet BeeAX zurück zu Ihrer `redirect_uri` weiter:
...
BeeAX veröffentlicht seine OAuth-Konfiguration an einem standardisierten Discovery-Endpunkt:
