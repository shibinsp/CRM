...
info: Erfahren Sie, wie Sie im Figma von BeeAX zusammenarbeiten können.
---
...
1. **Auf den freigegebenen Link zugreifen:** Sie können auf die Figma-Datei des Projekts [hier](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/BeeAX) zugreifen.
...
In der linken Seitenleiste können Sie auf die verschiedenen Seiten der Figma-Datei von BeeAX zugreifen. So sind sie organisiert:
