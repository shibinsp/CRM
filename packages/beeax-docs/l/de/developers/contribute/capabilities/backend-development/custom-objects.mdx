...
Objekte sind Strukturen, die es Ihnen ermöglichen, Daten (Aufzeichnungen, Attribute und Werte) zu speichern, die spezifisch für eine Organisation sind. BeeAX bietet sowohl Standard- als auch benutzerdefinierte Objekte.

Standardobjekte sind systemeigene Objekte mit einer Reihe von Attributen, die allen Benutzern zur Verfügung stehen. Beispiele für Standardobjekte in BeeAX sind Unternehmen und Person. Standardobjekte verfügen über Standardfelder, die ebenfalls allen BeeAX-Nutzern zur Verfügung stehen, wie z.B. Unternehmen.displayName.
