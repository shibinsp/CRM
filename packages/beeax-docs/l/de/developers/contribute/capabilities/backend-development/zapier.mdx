...
Synchronisieren Sie mühelos BeeAX mit über 3000 Apps mit [Zapier](https://zapier.com/). Automatisieren Sie Aufgaben, steigern Sie die Produktivität und stärken Sie Ihre Kundenbeziehungen!
...
Führen Sie im Ordner `packages/beeax-zapier` aus:
