...
<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="Kopfzeile" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Option A', Icon: IconBeeAXStar },
        { value: 'option2', label: 'Option B', Icon: IconBeeAXStar },
      ]}
      value="option1"
    />
  );
