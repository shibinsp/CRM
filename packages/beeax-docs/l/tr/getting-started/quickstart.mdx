...
description: BeeAX’yi bulutta veya kendi sunucunuzda 5 dakikadan kısa sürede çalışır hâle getirin.
icon: play
---
...
<Steps>
  <Step title="Hesabınızı oluşturun">
    [app.beeax.com](https://app.beeax.com) adresine gidin ve Google, Microsoft veya e-posta ile kayıt olun.
  </Step>
...
İçeri girdikten sonra, BeeAX'yi size özel kılmak için üç adım:

### 1. Posta kutunuzu bağlayın

**Ayarlar → Hesaplar**'a gidin ve Google veya Microsoft hesabınızı bağlayın. BeeAX, e-postalarınızı ve takvim etkinliklerinizi içe aktaracak ve etkileşimlerden otomatik olarak kişiler oluşturacaktır. Başka bir sağlayıcı mı kullanıyorsunuz? Aynı sayfadan SMTP üzerinden posta kutuları veya CalDAV üzerinden takvimler ekleyebilirsiniz.
