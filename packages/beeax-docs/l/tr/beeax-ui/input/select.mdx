...
<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="Başlık" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Seçenek A', Icon: IconBeeAXStar },
        { value: 'option2', label: 'Seçenek B', Icon: IconBeeAXStar },
      ]}
      value="option1"
    />
  );
