...
<CardGroup cols={3}>
  <Card href="/l/tr/developers/extend/apps/getting-started" img="/images/user-guide/halftone/dev-apps.png">
    ...
    Özel nesneler, sunucu tarafı mantık, UI bileşenleri ve yapay zeka ajanlarıyla BeeAX'yi genişletin — hepsi TypeScript paketleri olarak.
  </Card>
  ...
  <Card href="/l/tr/developers/self-host/capabilities/docker-compose" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    BeeAX'yi kendi altyapınızda çalıştırın.
  </Card>
