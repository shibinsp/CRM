...
| UI uzantılarına sahip BeeAX Uygulaması             | [Uygulamalar](/l/tr/developers/extend/apps/getting-started) (OAuth otomatik olarak yönetilir) |

## Bir İstemci Kaydedin

BeeAX, [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) uyarınca **dinamik istemci kaydını** destekler. Manuel kurulum gerekmez — programatik olarak kaydedin:
...
Uygulamanız bir BeeAX kullanıcısı adına hareket ettiğinde bu akışı kullanın.
...
Yetkilendirmeden sonra, BeeAX `redirect_uri` adresinize geri yönlendirir:
...
BeeAX, OAuth yapılandırmasını standart bir keşif uç noktasında yayımlar:
