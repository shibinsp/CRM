...
description: BeeAX'nin açık kaynak geliştirmesine katkıda bulunun.
---
...
BeeAX açık kaynaktır ve topluluktan gelen katkıları memnuniyetle karşılar. İster hataları düzeltiyor, ister özellikler ekliyor ya da belgeleri iyileştiriyor olun, katkılarınız BeeAX'yi herkes için daha iyi hâle getirmeye yardımcı olur.
