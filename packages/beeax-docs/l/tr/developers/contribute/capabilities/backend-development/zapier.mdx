...
Zapier'i kullanarak BeeAX'yi 3000+ uygulama ile zahmetsizce senkronize edin. Görevleri otomatikleştirin, verimliliği artırın ve müşteri ilişkilerinizi güçlendirin!
...
`packages/beeax-zapier` klasöründen şunu çalıştırın:
