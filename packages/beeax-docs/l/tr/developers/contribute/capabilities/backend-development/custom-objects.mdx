...
Nesneler, bir kuruluşa özgü verileri (kayıtlar, nitelikler ve değerler) saklamanıza olanak tanır. BeeAX provides both standard and custom objects.

Standart nesneler, tüm kullanıcılar için kullanılabilir bir dizi niteliğe sahip yerleşik nesnelerdir. BeeAX'deki standart nesne örnekleri arasında Şirket ve Kişi yer alır. Standart nesneler, tüm BeeAX kullanıcıları için de mevcut olan standart alanlara sahiptir, örneğin Şirket.görünenAd.
