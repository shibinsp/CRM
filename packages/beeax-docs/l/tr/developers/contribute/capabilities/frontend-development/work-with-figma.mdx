...
info: BeeAX'nin Figma'sında nasıl işbirliği yapabileceğinizi öğrenin
---
...
1. **Paylaşılan bağlantıya erişin:** Projenin Figma dosyasına [buradan](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/BeeAX) erişebilirsiniz.
...
Sol kenar çubuğundan BeeAX'nin Figma'sındaki farklı sayfalara erişebilirsiniz. Bu şekilde organize edilmişlerdir:
