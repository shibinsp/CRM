...
description: BeeAX'deki yapay zeka özellikleri hakkında sıkça sorulan sorular.
---
...
<AccordionGroup>
  ...
  <Accordion title="Hangi yapay zeka yetenekleri planlanıyor?">
    ...
    1. **Yapay Zeka Sohbet Botu**: BeeAX verilerinize erişebilen ve sorgularınızda size yardımcı olabilen bağlamın farkında olan bir asistan
  ...
  <Accordion title="Kendi yapay zeka modellerimi kullanabilir miyim?">
    Başlangıçta, BeeAX yerleşik yapay zeka modellerini kullanacaktır. Kullanıcı geri bildirimlerine bağlı olarak özel veya harici yapay zeka modellerine destek gelecekteki sürümlerde eklenebilir.
  </Accordion>
