...
description: Hangi e-postaların BeeAX'ye içe aktarılacağını kontrol edin.
---

## Genel Bakış

Varsayılan olarak, BeeAX bağlı posta kutunuzdan tüm harici e-postaları senkronize eder. **Klasör seçimi** ve **görünürlük ayarlarını** kullanarak içe aktarılanları sınırlayabilirsiniz.
