---
title: Posta Kutusu
description: BeeAX'deki e-posta entegrasyonu özelliklerini anlama.
---
...
BeeAX, bağlı posta kutularınızdaki e-postaları ilgili CRM kayıtlarına otomatik olarak bağlar, tüm iletişim geçmişini tek bir yerde tutar.
...
BeeAX e-postaları yaklaşık olarak dakikada **400 ileti** hızında içe aktarır. Bu hız şu anda Gmail API hız sınırlaması tarafından kısıtlanmaktadır (ve benzer şekilde diğer sağlayıcılar için de geçerlidir).
...
* **Eksik Mailler**: Şu durumları kontrol edin:
  ...
  * Otomatik kişi oluşturma devre dışı (e-postaların zaten var olan BeeAX kayıtlarına ihtiyacı var)
