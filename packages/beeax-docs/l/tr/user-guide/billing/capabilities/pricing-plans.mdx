...
description: BeeAX'nin fiyatlandırma planlarını ve bunlar arasında nasıl geçiş yapacağınızı öğrenin.
---

## Genel Bakış

İster bulut barındırma ister kendi kendine barındırmayı tercih edin, BeeAX her ölçekte ekibe uyacak esnek fiyatlandırma sunar.
...
BeeAX'yi kendi altyapınızda hiçbir ücret ödemeden barındırın:
