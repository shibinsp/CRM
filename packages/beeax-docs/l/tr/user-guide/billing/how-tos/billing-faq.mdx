...
description: BeeAX'nin fiyatlandırması ve faturalandırması hakkında sıkça sorulan sorular.
---

## Fiyatlandırma

<AccordionGroup>
<Accordion title="BeeAX'yi kendi sunucumda ücretsiz kullanabilir miyim?">
Evet, BeeAX'yi kendi sunucunuzda ücretsiz kullanabilirsiniz. Çekirdek ekibimizin desteği hariç, Pro (Bulut) planına dahil olan her şeye erişebileceksiniz. Destek, Discord topluluğumuz üzerinden erişilebilir.

Kendiniz barındırmak istiyor ve Premium özelliklere (SSO ve satır düzeyi izinler) ihtiyaç duyuyorsanız, ücretli Kuruluş (Kendi Barındırmalı) lisansını seçebilirsiniz. Bu ayrıca BeeAX ekibinden desteği içerir ve dağıtmadan önce özel kodu açık kaynak olarak yayımlama gerekliliğini ortadan kaldırır.
</Accordion>
...
Ücretsiz koltuk sunmuyoruz. Fiyatlandırma kullanıcı başınadır ve her kullanıcının BeeAX'e erişebilmesi için bir lisansa ihtiyacı vardır.
</Accordion>
