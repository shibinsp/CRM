...
description: Her iş farklı çalışır. İhtiyaçlarınıza göre BeeAX'yi şekillendirmek için bu 3 adımla başlayın.
---

<Note>**Hızlı Kazanım**: Posta kutunuzu bağlayarak başlayın. Bu size anında değer katar ve ekibinizin gerçek verilerle BeeAX'yi çalışırken görmesine yardımcı olur. Ayarlar → Hesaplar altında bu işlemi gerçekleştirebilirsiniz.</Note>

## 1. Veri modelinizi özelleştirin

BeeAX, günlük ihtiyaçlarınızı en iyi şekilde destekleyecek veri modelini şekillendirmeniz için ihtiyaç duyduğunuz esnekliği sunar.
...
Mevcut verilerinizi BeeAX'ye getirmek, ekibinize baştan itibaren bağlam sunar.

### Posta kutunuzu bağlayın

Çalışma alanınızı oluştururken bunu yapmadıysanız, Ayarlar → Hesaplar altında **Google veya Microsoft hesabınızı** bağlayın. Bu, BeeAX'ye şunları yapma olanağı tanır:
