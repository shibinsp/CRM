...
BeeAX, çoktan-çoka ilişkiler için bir **bağlantı nesnesi** desenini kullanır. Bir bağlantı nesnesi iki nesnenin arasında yer alır ve bağlantıları tutar:
...
Bağlantı ilişkisi anahtarını etkinleştirdiğinizde, BeeAX aradaki bağlantı kayıtlarını göstermeden bağlı kayıtları doğrudan görüntüler.
