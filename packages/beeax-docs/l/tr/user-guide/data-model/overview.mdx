...
BeeAX, standart nesnelerle birlikte gelir:
...
Her iş farklı çalışır. Veri modelinizi özelleştirmek, süreçlerinizi katı bir sisteme uydurmaya çalışmak yerine BeeAX'yi **sizin** süreçleriniz etrafında şekillendirebilmeniz demektir.

BeeAX tam esneklik sunar:
...
Üzerinde çalıştığınız temel kavramları belirleyin. BeeAX zaten şunları sunar:
