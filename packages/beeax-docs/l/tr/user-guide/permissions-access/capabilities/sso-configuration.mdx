...
Tek Oturum Açma (SSO), ekip üyelerinizin kuruluşunuzun kimlik sağlayıcısını kullanarak BeeAX'ye giriş yapmasına olanak tanır. Bu şunları sağlar:
...
BeeAX, SSO'yu şu sağlayıcılarla destekler:
...
* BeeAX çalışma alanına yönetici erişimi

<Note>
**SSO'yu kurmak isteyen öz barındırma kullanıcıları için**, contact@beeax.com ile iletişime geçin
</Note>
...
* BeeAX çalışma alanından kaldırın
...
* **Grup eşleme**: IdP gruplarını BeeAX rollerine eşleyin (varsa)
* **Ayrılış süreci**: Erişim kaldırma iş akışınıza BeeAX'yi dahil edin
