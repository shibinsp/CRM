...
description: BeeAX iş akışlarında kullanılabilen eylemler hakkında bilgi edinin.
---
...
<Note>
Yalnızca kendi BeeAX hesabınıza senkronize edilmiş posta kutularından e-posta gönderebilirsiniz. Diğer ekip üyelerinin posta kutularından gönderim (ör. hesap sahibinin e-postası) yol haritasındadır.
</Note>
