...
**Bunun nedeni**: BeeAX her şeyi gerçek zamanlı olarak kaydeder — ayrı bir "düzenleme" ve "okuma" modu yoktur. Bir kayıt oluşturduğunuzda, ek alanları doldurmadan önce "Record is created" olayını tetikleyerek hemen kaydedilir.
...
* Önce API çağrısını BeeAX dışında test edin
