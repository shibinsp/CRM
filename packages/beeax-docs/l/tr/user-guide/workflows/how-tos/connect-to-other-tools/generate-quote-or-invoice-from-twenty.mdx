---
title: BeeAX'den Teklif veya Fatura Oluşturun
...
* [BeeAX'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — oluşturulan PDF'leri kayıtlara ekleyin
