---
title: Ürün Verilerini BeeAX'ye Aktarın
description: Ürün katalog verilerini bir veri ambarından CRM'inize bir programa göre eşitleyin.
---

Veri ambarınızdaki ürün verileriyle BeeAX'yi senkron tutmak için bu kalıbı kullanın (örn. Snowflake, BigQuery, PostgreSQL).
...
5. **Kaydı Ekle/Güncelle**: BeeAX'de oluşturun veya güncelleyin
