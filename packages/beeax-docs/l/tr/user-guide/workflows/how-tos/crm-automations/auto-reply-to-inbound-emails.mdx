...
BeeAX’de, bu parmak izi Message nesnesinde `headerMessageId` olarak saklanır. İş akışınız bunu alır ve E-posta Gönder eyleminin In-Reply-To alanına aktarır.
...
Her e-posta BeeAX'ye ulaştığında bu tetiklenir.
...
* **Yalnızca VIP'lere yanıt verin** — gönderenin alan adını veya BeeAX’de bir Contact olarak bulunup bulunmadığını kontrol eden bir dal ekleyin
