---
title: Widget'lar
description: BeeAX'deki widget türlerini ve görselleştirme seçeneklerini keşfedin.
---
...
BeeAX, Müşteri İlişkileri Yönetimi (CRM) verilerinizi görselleştirmek için çeşitli widget türleri sunar.
