...
description: Büyük ölçekli veri içe aktarmaları için BeeAX'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

BeeAX, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
BeeAX, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
BeeAX iki API türünü destekler:
...
* Biçimlerin BeeAX'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin BeeAX'de doğru göründüğünü doğrulayın
