...
description: BeeAX kendi barındırmalı örneğinizi BeeAX Cloud’a taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi BeeAX kendi barındırmalı örneğinizden BeeAX Cloud’a taşıma sürecinde size adım adım yol gösterir. Süreç; bulut çalışma alanınızı kurmayı, verilerinizi dışa aktarmayı ve yeniden içe aktarmayı içerir.
...
1. [app.beeax.com](https://app.beeax.com) adresine gidin ve yeni bir çalışma alanı oluşturun
...
Karmaşık geçişler veya büyük veri kümeleri için [contact@beeax.com](mailto:contact@beeax.com) adresinden bize ulaşın veya [Uygulama Hizmetlerimizi](/l/tr/user-guide/getting-started/capabilities/implementation-services) inceleyin.
