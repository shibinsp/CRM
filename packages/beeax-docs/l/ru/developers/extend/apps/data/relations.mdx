...
Отношения связывают два объекта между собой. В BeeAX отношения всегда **двунаправленные** — у каждого отношения есть две стороны, и каждая сторона объявляется как поле, ссылающееся на другую.
