---
title: Создание PDF в BeeAX
description: Создайте рабочий процесс для создания и прикрепления PDF (например, коммерческого предложения) к записи.
---

Автоматически создавайте или получайте PDF и прикрепляйте его к записи в BeeAX. Это часто используют для создания коммерческих предложений, счетов или отчетов, связанных с компаниями, сделками или другими объектами.
...
* [Создание коммерческого предложения или счета в BeeAX](/l/ru/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
