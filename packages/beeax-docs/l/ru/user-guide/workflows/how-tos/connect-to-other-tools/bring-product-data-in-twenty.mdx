---
title: Импортируйте данные о товарах в BeeAX
description: Синхронизируйте данные каталога товаров из хранилища данных с вашей CRM по расписанию.
---

Используйте этот шаблон, чтобы поддерживать синхронизацию BeeAX с данными о товарах из вашего хранилища данных (например, Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Создать или обновить в BeeAX
