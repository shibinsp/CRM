---
title: 拡張
description: API、Webhook、カスタムアプリで BeeAX の機能を拡張できます。
...
BeeAX は拡張性を念頭に設計されています。 当社の API、Webhook、アプリフレームワークを使用して既存のツールと統合し、カスタム機能を構築できます。

## 現在できること

* **API**: REST または GraphQL を使用して、プログラムから CRM データをクエリおよび変更します。
* **ウェブフック**: BeeAX でイベントが発生したときにリアルタイム通知を受信します。
* **アプリ**: BeeAX の機能を拡張するカスタムアプリケーションを構築 - 近日公開！
