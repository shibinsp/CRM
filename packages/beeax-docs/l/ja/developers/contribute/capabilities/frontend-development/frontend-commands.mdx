...
```bash
npx nx run beeax-front:lint # pass --fix to fix lint errors
```
...
```bash
npx nx run beeax-front:test # run jest tests
npx nx run beeax-front:storybook:serve:dev # run storybook
npx nx run beeax-front:storybook:test # run tests # (needs yarn storybook:serve:dev to be running)
npx nx run beeax-front:storybook:coverage # (needs yarn storybook:serve:dev to be running)
```
