---
title: BeeAX を知る
description: BeeAX ユーザーガイドへようこそ。高度な設定やベストプラクティスのためのリソースです。
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={3}>
  <Card href="/l/ja/user-guide/getting-started/capabilities/what-is-beeax" img="/images/user-guide/api/api.png">
    <CardTitle>BeeAX を知る</CardTitle>
    BeeAX とは何か、ビジネスにどのように役立つかを学びましょう。
  </Card>
