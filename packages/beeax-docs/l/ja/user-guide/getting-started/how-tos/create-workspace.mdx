---
title: ワークスペースを作成する
description: BeeAX に登録し、サブスクリプションプランを選択して、アカウントを設定するためのステップバイステップガイドに従ってください。
---
...
1. [BeeAXへのサインアップ](https://app.beeax.com)に移動します。
...
ご質問やサポートが必要な場合は、[contact@beeax.com](mailto:contact@beeax.com) または [Discord](https://discord.gg/cx5n4Jzs57) で専属のサポートチームに連絡してください。
