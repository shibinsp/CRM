---
title: AI FAQ
description: Frequently asked questions about AI features in BeeAX.
---
...
<AccordionGroup>
  ...
  <Accordion title="What AI capabilities are planned?">
    ...
    1. **AI Chatbot**: A context-aware assistant that can access your BeeAX data and help you with queries
  ...
  <Accordion title="Can I use my own AI models?">
    Initially, BeeAX will use built-in AI models. Support for custom or external AI models may be added in future releases based on user feedback.
  </Accordion>
</AccordionGroup>
