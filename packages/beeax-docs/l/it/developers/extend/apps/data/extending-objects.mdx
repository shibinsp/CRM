...
* `objectUniversalIdentifier` identifica l'oggetto di destinazione. Per gli oggetti standard di BeeAX, importa la costante da `beeax-sdk`:
...
* Per aggiungere una scheda a un layout di pagina standard (ad es. la pagina di dettaglio di Task o Company), utilizza [`definePageLayoutTab`](/l/it/developers/extend/apps/layout/page-layouts#definepagelayouttab) con `STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS` da `beeax-sdk/define`.
