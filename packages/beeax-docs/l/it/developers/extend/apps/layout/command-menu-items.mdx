...
Un **elemento del menu comandi** è il collegamento tra l'utente e un [front component](/l/it/developers/extend/apps/layout/front-components). Registra il componente nel menu comandi (Cmd+K) di BeeAX e, opzionalmente, come pulsante di azione rapida fissato nell'angolo in alto a destra della pagina.
