---
title: Concetti
description: Come funzionano le app BeeAX — modello di entità, sandboxing e ciclo di vita dell’installazione.
icon: sitemap
---
...
| **Componente front-end**         | UI React in sandbox all’interno di BeeAX              | [Componenti front-end](/l/it/developers/extend/apps/layout/front-components)              |
...
* **`yarn beeax dev:build`** — compila TypeScript, crea i bundle delle funzioni logiche e dei componenti front-end con esbuild e produce un manifest.
