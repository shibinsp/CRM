...
Per segnalare un bug, per favore [crea una issue su GitHub](https://github.com/beeax/beeax/issues/new).

Puoi anche chiedere aiuto su [Discord](https://discord.gg/cx5n4Jzs57).

## Richieste di Funzionalità

Se non sei sicuro che sia un bug e ti sembra più vicino a una richiesta di funzionalità, probabilmente dovresti [aprire invece una discussione](https://github.com/beeax/beeax/discussions/new).

## Invia una Pull Request

Contribuire al codice di BeeAX inizia con una pull request (PR).

### Prima di Iniziare

1. Controlla le [issue esistenti](https://github.com/beeax/beeax/issues) per lavori correlati
2. Per le nuove funzionalità, apri prima una issue per discuterne
3. Consulta il nostro [Codice di condotta](https://github.com/beeax/beeax/blob/main/CODE_OF_CONDUCT.md)
