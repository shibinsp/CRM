...
Sincronizza facilmente BeeAX con oltre 3000 app utilizzando [Zapier](https://zapier.com/). Automatizza le attività, aumenta la produttività e potenzia le relazioni con i clienti!
...
Dalla cartella `packages/beeax-zapier`, esegui:
