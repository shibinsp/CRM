...
Gli oggetti sono strutture che permettono di memorizzare dati (record, attributi e valori) specifici di un'organizzazione. BeeAX offre sia oggetti standard che personalizzati.

Gli oggetti standard sono oggetti integrati con un set di attributi disponibili per tutti gli utenti. Esempi di oggetti standard in BeeAX includono Company e Person. Gli oggetti standard hanno campi standard che sono inoltre disponibili per tutti gli utenti di BeeAX, come Company.displayName.
