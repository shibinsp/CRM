...
```bash
npx nx run beeax-front:lint # aggiungere --fix per correggere gli errori di lint
```
...
```bash
npx nx run beeax-front:test # eseguire i test jest
npx nx run beeax-front:storybook:serve:dev # eseguire storybook
npx nx run beeax-front:storybook:test # eseguire i test # (è necessario che yarn storybook:serve:dev sia in esecuzione)
npx nx run beeax-front:storybook:coverage # (è necessario che yarn storybook:serve:dev sia in esecuzione)
```
