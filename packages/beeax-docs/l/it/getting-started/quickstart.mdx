---
title: Guida rapida
description: Metti BeeAX in funzione in meno di 5 minuti — sul cloud o in modalità self-hosted.
icon: play
---
...
<Steps>
  <Step title="Crea il tuo account">
    Vai su [app.beeax.com](https://app.beeax.com) e registrati con Google, Microsoft o email.
  </Step>
...
Una volta dentro, tre passaggi per rendere BeeAX tuo:

### 1. Collega la tua casella di posta

Vai a **Impostazioni → Account** e collega il tuo account Google o Microsoft. BeeAX importerà le tue email e gli eventi del calendario e creerà automaticamente contatti dalle interazioni. Stai usando un altro provider? Puoi aggiungere caselle di posta tramite SMTP o calendari tramite CalDAV dalla stessa pagina.
