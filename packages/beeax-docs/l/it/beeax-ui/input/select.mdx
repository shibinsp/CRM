...
<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="Intestazione" />
</Frame>
...
```jsx
import { IconBeeAXStar } from 'beeax-ui/display';
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Opzione A', Icon: IconBeeAXStar },
        { value: 'option2', label: 'Opzione B', Icon: IconBeeAXStar },
      ]}
      value="option1"
    />
  );
