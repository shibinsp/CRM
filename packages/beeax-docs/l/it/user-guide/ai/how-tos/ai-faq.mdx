---
title: FAQ sull'IA
description: Domande frequenti sulle funzionalità di IA in BeeAX.
---
...
<AccordionGroup>
  ...
  <Accordion title="Quali capacità di IA sono previste?">
    ...
    1. **Chatbot IA**: un assistente contestuale che può accedere ai tuoi dati di BeeAX e aiutarti con le tue domande
  ...
  <Accordion title="Posso usare i miei modelli di IA?">
    Inizialmente, BeeAX utilizzerà modelli di IA integrati. Il supporto per modelli di IA personalizzati o esterni potrebbe essere aggiunto in versioni future in base al feedback degli utenti.
  </Accordion>
