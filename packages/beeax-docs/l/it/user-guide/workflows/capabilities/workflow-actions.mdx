...
description: Scopri le azioni disponibili nei workflow di BeeAX.
---
...
<Note>
Puoi inviare email solo dalle caselle di posta sincronizzate con il tuo account BeeAX. L'invio dalle caselle di posta di altri membri del team (ad es., l'email del proprietario dell'account) è nella roadmap.
</Note>
