...
<Note>
Gli allegati sono statici—lo stesso file viene inviato a tutti i destinatari. Per documenti dinamici (come i preventivi personalizzati), genera e allega i file utilizzando una [Funzione serverless](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax).
</Note>
