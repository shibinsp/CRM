...
* Per le richieste POST, definisci la struttura del body prevista in modo che BeeAX sappia quali dati aspettarsi. Aggiungi qui i campi che riceverai e che saranno necessari più avanti nel tuo flusso di lavoro.
