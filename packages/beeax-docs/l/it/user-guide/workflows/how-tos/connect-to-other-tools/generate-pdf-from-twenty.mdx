---
title: Genera un PDF da BeeAX
description: Crea un flusso di lavoro per generare e allegare un PDF (ad esempio un preventivo) a un record.
---

Genera o recupera automaticamente un PDF e allegalo a un record in BeeAX. Questo viene comunemente utilizzato per creare preventivi, fatture o report collegati ad Aziende, Opportunità o altri oggetti.
...
* [Genera un preventivo o una fattura da BeeAX](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
