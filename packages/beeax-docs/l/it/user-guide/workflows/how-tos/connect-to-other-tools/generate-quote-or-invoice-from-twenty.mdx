---
title: Genera un preventivo o una fattura da BeeAX
...
* [Generare un PDF da BeeAX](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — allegare i PDF generati ai record
