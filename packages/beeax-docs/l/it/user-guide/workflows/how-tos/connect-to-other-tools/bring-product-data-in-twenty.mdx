---
title: Porta i dati di prodotto in BeeAX
description: Sincronizza i dati del catalogo prodotti da un data warehouse nel tuo CRM in base a una pianificazione.
---

Usa questo modello per mantenere BeeAX sincronizzato con i dati di prodotto dal tuo data warehouse (ad esempio, Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Crea o aggiorna in BeeAX
