...
**Perché accade**: BeeAX salva tutto in tempo reale — non esiste una modalità separata "modifica" vs "lettura". Quando crei un record, questo viene salvato immediatamente, attivando l'evento "Record is created" prima che tu possa compilare i campi aggiuntivi.
...
* Esegui prima il test della chiamata API al di fuori di BeeAX
