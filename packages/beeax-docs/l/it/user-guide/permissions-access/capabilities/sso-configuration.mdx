...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a BeeAX utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore allo spazio di lavoro BeeAX

<Note>
**Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@beeax.com
</Note>
...
* Rimuovili dallo spazio di lavoro BeeAX
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di BeeAX (se disponibile)
* **Processo di offboarding**: Includi BeeAX nel tuo flusso di lavoro di deprovisioning
