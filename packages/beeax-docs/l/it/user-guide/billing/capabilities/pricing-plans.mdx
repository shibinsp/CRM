...
description: Scopri i piani tariffari di BeeAX e come passare da uno all'altro.
---

## Panoramica

BeeAX offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui BeeAX sulla tua infrastruttura senza costi:
