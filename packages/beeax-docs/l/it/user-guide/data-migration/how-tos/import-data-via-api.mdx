...
description: Quando e come usare le API di BeeAX per importazioni di dati su larga scala.
---

## Panoramica

BeeAX offre sia **GraphQL** che **API REST** per l'importazione programmatica dei dati. Usa l'API quando l'importazione CSV non è pratica per il tuo volume di dati o quando hai bisogno di importazioni automatizzate e ricorrenti.
...
BeeAX applica limiti di frequenza per garantire la stabilità del sistema:
...
BeeAX supporta due tipi di API:
...
* Verifica che i formati soddisfino i requisiti di BeeAX (vedi [Mappatura dei campi](/l/it/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica che i dati compaiano correttamente in BeeAX
...
Contattaci a [contact@beeax.com](mailto:contact@beeax.com) oppure scopri i nostri [Servizi di implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
