...
description: Guida passo-passo per migrare la tua istanza BeeAX self-hosted verso BeeAX Cloud.
---

## Panoramica

Questa guida ti accompagna nella migrazione dei tuoi dati da un'istanza BeeAX self-hosted a BeeAX Cloud. Il processo prevede la configurazione dello spazio di lavoro cloud, l'esportazione dei dati e la loro reimportazione.
...
1. Vai su [app.beeax.com](https://app.beeax.com) e crea un nuovo spazio di lavoro
...
Per migrazioni complesse o set di dati di grandi dimensioni, contattaci all'indirizzo [contact@beeax.com](mailto:contact@beeax.com) oppure scopri i nostri [Servizi di Implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
