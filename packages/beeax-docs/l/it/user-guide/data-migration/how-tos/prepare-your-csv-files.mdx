...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in BeeAX.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che BeeAX si aspetta.
...
BeeAX impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in BeeAX
...
* Deve essere univoco (nessun duplicato nel file o in BeeAX)
...
* Deve essere univoco all'interno del tuo file e in BeeAX
...
* **Link / Etichetta del link**: `BeeAX`
* **Link / URL del link**: `https://beeax.com`
...
* **Opzionale**: BeeAX genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in BeeAX
...
## Passaggio 6: Verifica che i campi esistano in BeeAX
