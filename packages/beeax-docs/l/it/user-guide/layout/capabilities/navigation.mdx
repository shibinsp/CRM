...
La barra laterale sinistra è il modo principale per navigare in BeeAX. È completamente personalizzabile — puoi riorganizzarla per adattarla al tuo flusso di lavoro senza toccare alcuna pagina delle impostazioni.
