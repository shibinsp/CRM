---
title: Disposizione
description: Personalizza il modo in cui navighi, esplori e visualizzi i record in BeeAX.
---

Il layout di BeeAX è personalizzabile su tre livelli: come navighi nell'app, come consulti gli elenchi di record e cosa vedi quando apri un singolo record.
...
Le viste determinano come vengono visualizzati gli elenchi di record. BeeAX supporta tre tipi di vista:
