...
description: Ogni azienda lavora in modo diverso. Inizia con questi 3 passaggi per adattare BeeAX alle tue esigenze.
---

<Note>**Risultato rapido**: Inizia collegando la tua casella di posta. Ciò ti offre un valore immediato e aiuta il tuo team a vedere BeeAX in azione con dati reali. Puoi farlo in Impostazioni → Account.</Note>

## 1. Personalizza il tuo modello di dati

BeeAX offre la flessibilità necessaria per modellare il modello di dati che meglio supporterà la tua routine quotidiana.
...
Importare i tuoi dati esistenti in BeeAX dà al tuo team un contesto fin dall'inizio.

### Collega la tua casella di posta

Se non lo hai fatto creando il tuo spazio di lavoro, collega il tuo **account Google o Microsoft** sotto Impostazioni → Account. Questo permette a BeeAX di:
