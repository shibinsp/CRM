...
description: Segui una guida passo passo su come registrarti su BeeAX, scegliere un piano di abbonamento e configurare il tuo account.
---
...
1. Vai a [Registrati su BeeAX](https://app.beeax.com).
...
Per domande o aiuto, contatta il team di supporto dedicato a [contact@beeax.com](mailto:contact@beeax.com) o invia un messaggio su [Discord](https://discord.gg/cx5n4Jzs57).
