---
title: Che cos'è BeeAX
description: BeeAX è un CRM open source che ti fornisce i componenti di base per creare esattamente ciò di cui la tua azienda ha bisogno.
---
...
All'inizio, BeeAX appare come la maggior parte dei CRM che già conosci: puoi monitorare le trattative, organizzare i contatti, gestire compiti e note.
...
L'open-source è la base del nostro approccio, garantendo che BeeAX evolva con la sua comunità, per la sua comunità.
...
[Registrati qui](https://app.beeax.com) o [diventa un collaboratore su GitHub](https://github.com/beeax/beeax).
