...
Le relazioni molti-a-molti utilizzano lo schema dell'**oggetto di giunzione**: un oggetto intermedio che collega entrambe le parti. Con la funzionalità delle relazioni di giunzione, BeeAX visualizza direttamente i record collegati finali, nascondendo l'oggetto intermedio dall'interfaccia utente.
...
BeeAX offre relazioni predefinite tra oggetti standard:
