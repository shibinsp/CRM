...
BeeAX include oggetti standard:
...
Ogni azienda lavora in modo diverso. Personalizzare il tuo modello di dati significa poter modellare BeeAX attorno ai **tuoi** processi invece di forzarli dentro un sistema rigido.

BeeAX offre massima flessibilità:
...
Identifica i concetti principali con cui lavori. BeeAX offre già:
