...
description: Domande frequenti sulle impostazioni di BeeAX.
---
...
Per modificare il tuo indirizzo email, contatta [contact@beeax.com](mailto:contact@beeax.com).
</Accordion>
...
* **Sottodominio**: usa un sottodominio di BeeAX come `yourcompany.beeax.com`
