...
description: Controlla quali email vengono importate in BeeAX.
---

## Panoramica

Per impostazione predefinita, BeeAX sincronizza tutte le email esterne dalla tua casella di posta collegata. Puoi limitare ciò che viene importato utilizzando la **selezione delle cartelle** e le **impostazioni di visibilità**.
