---
title: 在 BeeAX 中生成 PDF
description: 创建一个工作流，用于生成 PDF（例如报价单）并将其附加到记录。
---

自动生成或获取 PDF，并将其附加到 BeeAX 中的记录。 这通常用于创建与公司、商机或其他对象关联的报价单、发票或报告。
...
* [从 BeeAX 生成报价单或发票](/l/zh/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
