---
title: 从其他CRM迁移
description: 分步指南：将您的数据从任何客户关系管理系统迁移到 BeeAX。
---

## 概览

本指南将引导您将数据从任何客户关系管理系统迁移到 BeeAX。 该过程包括审核您的数据、准备您的 BeeAX 工作区、从当前系统导出，并导入到 BeeAX。
...
在您当前的客户关系管理系统与 BeeAX 之间创建一份映射文档：
...
Contact [contact@beeax.com](mailto:contact@beeax.com) or explore our [Implementation Services](/l/zh/user-guide/getting-started/capabilities/implementation-services).
