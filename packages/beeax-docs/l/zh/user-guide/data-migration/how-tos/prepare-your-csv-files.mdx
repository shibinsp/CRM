---
title: 准备您的 CSV 文件
description: 完整的分步指南，指导您将数据格式化以导入 BeeAX。
---
...
**这是最重要的一步。** 示例文件展示了 BeeAX 期望的准确列名和格式。
