...
BeeAX 的设计对开发者友好，提供适合您定制数据模型的强大API。 我们提供四种不同的API类型来满足不同的集成需求。

## 开发者优先的方法

BeeAX 会针对您的数据模型生成专用 API：
...
<Note>
创建 API 密钥后，可在 **设置 → API & Webhooks** 中查看您的个性化 API 文档。 由于 BeeAX 会生成与您的自定义数据模型相匹配的 API，因此文档对您的工作区是唯一的。
</Note>
