---
title: Layout
description: Personalize a forma como navega, explora e visualiza registos na BeeAX.
---

O layout da BeeAX é personalizável em três níveis: a forma como navega na aplicação, como consulta listas de registos, e o que vê ao abrir um registo individual.
...
As vistas controlam como as listas de registos são apresentadas. A BeeAX suporta três tipos de vista:
