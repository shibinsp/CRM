...
A barra lateral esquerda é sua principal forma de navegar pelo BeeAX. Ela é totalmente personalizável — você pode reorganizá-la para corresponder ao seu fluxo de trabalho sem acessar nenhuma página de configurações.
