...
description: Aprenda a criar automações no BeeAX.
---

## Por que Workflows Importam

BeeAX foi criado para trazer flexibilidade máxima aos seus usuários. Em vez de forçá-lo a adaptar seus processos de negócios a recursos rígidos e pré-construídos, os workflows permitem que você crie automações que criem o CRM que melhor apoie seus casos de uso de negócios exclusivos.

Workflows são o recurso interno de BeeAX para criar essas automações. Eles oferecem os blocos de construção para criar exatamente o que seu negócio precisa, quando precisa.
...
2. **Traga dados para dentro e para fora do BeeAX**: Conecte-se ao BeeAX por meio de chamadas de API e webhooks para seu banco de dados e outras ferramentas.
...
* **Formulário**: Obter entradas de usuários na interface do BeeAX no momento da execução
