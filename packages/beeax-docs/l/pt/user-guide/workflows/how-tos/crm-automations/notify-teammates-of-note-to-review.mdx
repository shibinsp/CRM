...
Você quer marcar um colega em uma nota para que receba uma notificação para revisá-la. Hoje, a BeeAX não oferece suporte a @mentions em notas ou tarefas.
...
<Note>
Substitua `yourSubDomain` pelo subdomínio real do seu espaço de trabalho BeeAX.
</Note>
