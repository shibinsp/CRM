...
**Por que isso acontece**: BeeAX salva tudo em tempo real — não há um modo separado de "edit" vs "read". Quando você cria um registro, ele é salvo imediatamente, acionando o evento "Record is created" antes de você preencher os campos adicionais.
...
* Teste a chamada de API primeiro fora do BeeAX
