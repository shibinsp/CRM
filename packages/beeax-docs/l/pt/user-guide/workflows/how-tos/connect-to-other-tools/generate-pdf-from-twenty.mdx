---
title: Gerar um PDF a partir do BeeAX
description: Crie um fluxo de trabalho para gerar e anexar um PDF (como um orçamento) a um registo.
---

Gere automaticamente ou obtenha um PDF e anexe-o a um registo no BeeAX. Isto é normalmente utilizado para criar orçamentos, faturas ou relatórios que estão associados a Empresas, Oportunidades ou outros objetos.
...
2. Carregar o ficheiro para o BeeAX
...
* [Gerar um Orçamento ou Fatura a partir do BeeAX](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
