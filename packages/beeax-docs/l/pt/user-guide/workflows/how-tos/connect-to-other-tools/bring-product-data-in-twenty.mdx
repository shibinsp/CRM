---
title: Traga dados de produtos para o BeeAX
description: Sincronize, de forma agendada, os dados do catálogo de produtos do seu armazém de dados para o seu CRM.
---

Use este padrão para manter o BeeAX sincronizado com os dados de produtos do seu armazém de dados (por exemplo, Snowflake, BigQuery, PostgreSQL).
...
5. **Inserir/atualizar registro**: Criar ou atualizar no BeeAX
