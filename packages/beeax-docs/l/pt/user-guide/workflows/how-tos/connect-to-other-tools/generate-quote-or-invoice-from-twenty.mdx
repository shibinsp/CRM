---
title: Gerar um orçamento ou fatura no BeeAX
...
* [Gerar um PDF a partir do BeeAX](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — anexar PDFs gerados aos registros
