...
description: Saiba mais sobre as ações disponíveis nos fluxos de trabalho do BeeAX.
---
...
<Note>
Você só pode enviar e-mails de caixas de correio sincronizadas com a sua própria conta BeeAX. O envio a partir das caixas de correio de outros membros da equipe (por exemplo, o e-mail do proprietário da conta) está no roadmap.
</Note>
