...
* Para requisições POST, defina a estrutura de corpo esperada para que o BeeAX saiba quais dados esperar. Adicione aqui os campos que você receberá e que serão necessários abaixo no seu fluxo de trabalho.
