...
A sincronização de emails leva tempo, especialmente para caixas de correio grandes. BeeAX importa emails a uma taxa de aproximadamente **400 mensagens por minuto** (limitado pela restrição de taxa da API do Gmail).
...
### 2. O contacto não existe no BeeAX
