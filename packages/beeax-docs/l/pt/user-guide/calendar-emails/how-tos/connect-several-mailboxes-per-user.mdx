...
O BeeAX oferece suporte a **contas de e-mail ilimitadas por usuário**. Isso é útil se você gerencia várias caixas de entrada, como:
...
Os e-mails de todas as suas caixas de correio conectadas são sincronizados com o BeeAX e aparecem em:
