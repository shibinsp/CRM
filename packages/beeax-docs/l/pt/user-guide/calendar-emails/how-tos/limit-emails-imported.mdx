...
description: Controle quais emails são importados para o BeeAX.
---

## Visão Geral

Por padrão, o BeeAX sincroniza todos os emails externos da sua caixa de correio conectada. Você pode limitar o que é importado usando **seleção de pastas** e **configurações de visibilidade**.
