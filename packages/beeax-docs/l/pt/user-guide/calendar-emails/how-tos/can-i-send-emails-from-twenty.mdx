---
title: Posso enviar e-mails a partir do BeeAX?
description: Informações sobre o envio de e-mails diretamente a partir do BeeAX.
---

## Estado atual

A integração de e-mail do BeeAX foi concebida para **sincronizar e apresentar** o seu histórico de e-mails. Não é possível redigir ou enviar e-mails diretamente a partir da interface do BeeAX.
...
Embora não seja possível enviar e-mails manualmente a partir do BeeAX, **pode enviar e-mails automaticamente utilizando Fluxos de Trabalho**. Isto é útil para:
...
Para sequências de e-mails e boletins informativos, recomendamos utilizar Fluxos de Trabalho para ligar o BeeAX a uma ferramenta dedicada de marketing por e-mail.
...
A redação nativa de e-mails dentro do BeeAX está no nosso roteiro. Junte-se às nossas [discussões no GitHub](https://github.com/beeax/beeax/discussions) para partilhar o seu caso de uso e ajudar a priorizar esta funcionalidade.
