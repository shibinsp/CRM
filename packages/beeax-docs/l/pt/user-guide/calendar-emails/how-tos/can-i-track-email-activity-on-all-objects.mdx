...
Está a ser considerada a extensão da visibilidade do email a objetos personalizados. Partilhe o seu caso de uso nas nossas [discussões no GitHub](https://github.com/beeax/beeax/discussions) para ajudar a priorizar esta funcionalidade.
