---
title: Calendário
description: Entendendo os recursos de integração do calendário no BeeAX.
---
...
O BeeAX sincroniza automaticamente os eventos do seu calendário e os vincula aos registros relevantes do CRM, oferecendo uma visão completa do seu histórico de reuniões com contatos e empresas.
