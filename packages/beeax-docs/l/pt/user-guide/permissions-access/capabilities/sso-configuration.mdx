...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no BeeAX usando o provedor de identidade da sua organização. Isso oferece:
...
O BeeAX oferece suporte a SSO com:
...
* Acesso de administrador ao workspace do BeeAX

<Note>
**Para usuários de auto-hospedagem que desejam configurar SSO**, entre em contato pelo contact@beeax.com
</Note>
...
* Remova-os do workspace do BeeAX
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do BeeAX (se disponível)
* **Processo de desligamento**: Inclua o BeeAX no seu fluxo de trabalho de desprovisionamento
