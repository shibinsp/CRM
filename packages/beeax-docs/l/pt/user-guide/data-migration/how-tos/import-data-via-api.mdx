...
description: Quando e como usar as APIs da BeeAX para importações de dados em larga escala.
---

## Visão Geral

A BeeAX oferece tanto **GraphQL** como **APIs REST** para a importação programática de dados. Use a API quando a importação por CSV não for prática para o seu volume de dados ou quando precisar de importações automatizadas e recorrentes.
...
A BeeAX impõe limites de taxa para assegurar a estabilidade do sistema:
...
A BeeAX suporta dois tipos de API:
...
* Verifique se os formatos correspondem aos requisitos da BeeAX (veja [Mapeamento de Campos](/l/pt/user-guide/data-migration/capabilities/field-mapping))
...
* Verifique se os dados aparecem corretamente na BeeAX
...
Contacte-nos em [contact@beeax.com](mailto:contact@beeax.com) ou explore os nossos [Serviços de Implementação](/l/pt/user-guide/getting-started/capabilities/implementation-services).
