...
description: Guia passo a passo para migrar a sua instância BeeAX auto-hospedada para a BeeAX Cloud.
---

## Visão Geral

Este guia orienta-o na migração dos seus dados de uma instância BeeAX auto-hospedada para a BeeAX Cloud. O processo envolve configurar o seu espaço de trabalho na cloud, exportar os seus dados e voltar a importá-los.
...
1. Aceda a [app.beeax.com](https://app.beeax.com) e crie um novo espaço de trabalho
...
Para migrações complexas ou conjuntos de dados grandes, contacte-nos em [contact@beeax.com](mailto:contact@beeax.com) ou explore os nossos [Serviços de Implementação](/l/pt/user-guide/getting-started/capabilities/implementation-services).
