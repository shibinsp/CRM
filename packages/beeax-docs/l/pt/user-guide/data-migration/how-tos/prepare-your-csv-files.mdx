...
description: Guia completo passo a passo para formatar seus dados para importação no BeeAX.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o BeeAX espera.
...
O BeeAX impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no BeeAX
...
* Deve ser exclusivo (sem duplicados no arquivo ou no BeeAX)
...
* Deve ser exclusivo dentro do seu arquivo e no BeeAX
...
* **Links / Rótulo do Link**: `BeeAX`
* **Links / URL do Link**: `https://beeax.com`
...
* **Opcional**: a BeeAX gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na BeeAX
...
## Etapa 6: Garanta que os campos existam na BeeAX
