...
Depois de carregar o seu ficheiro e mapear os campos, o BeeAX valida os seus dados **antes** de os importar. Isto permite detetar e corrigir erros sem afetar os seus dados existentes.

## Como Funciona

1. **Carregue** o seu ficheiro CSV
2. **Mapeie** as suas colunas para os campos do BeeAX
...
**Causa**: Um campo único (email, domínio) já existe no BeeAX ou aparece duas vezes no seu ficheiro.
