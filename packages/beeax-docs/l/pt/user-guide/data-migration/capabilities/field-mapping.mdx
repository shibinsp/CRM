...
Ao fazer upload de um arquivo, a BeeAX analisa as suas colunas e tenta associá-las aos campos existentes.

### Mapeamento automático

A BeeAX tenta associar as colunas com base em:
...
<Note>**Dica rápida:** Exporte algumas linhas do objeto que você deseja importar. O arquivo exportado terá exatamente os nomes de coluna que a BeeAX espera, facilitando o mapeamento automático durante a importação.</Note>

### Opções de mapeamento manual

Para cada coluna, você pode:

* **Mapear para um campo**: selecione o campo correspondente da BeeAX em um menu suspenso
...
Especificar um `id` durante a importação é opcional. A BeeAX gera um automaticamente se não for fornecido.
