...
O BeeAX suporta a importação de relações entre objetos durante a importação por CSV. Isto permite-lhe ligar registos (por exemplo, associar Pessoas a Empresas) como parte da sua migração de dados.
...
## Como funcionam as relações no BeeAX

### Um para Muitos / Muitos para Um

O BeeAX suporta relações padrão em que um registo se liga a muitos outros:
...
Antes de importar o lado "muitos", os registos do lado "um" já devem existir no BeeAX.
...
4. O BeeAX ligará automaticamente cada registo ao pai correspondente
...
<Note>**Ligação a Membros do Espaço de Trabalho**: Quando a relação aponta para Membros do Espaço de Trabalho (a sua equipa que inicia sessão no BeeAX), refira-os pelo seu **endereço de email**, não pelo nome.</Note>
