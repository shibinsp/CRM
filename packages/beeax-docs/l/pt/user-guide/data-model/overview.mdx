...
O BeeAX vem com objetos padrão:
...
Cada empresa trabalha de maneira diferente. Personalizar seu modelo de dados significa que você pode moldar o BeeAX em torno dos **seus** processos, em vez de forçar os seus a caber em um sistema rígido.

O BeeAX oferece total flexibilidade:
...
Identifique os principais conceitos com os quais você trabalha. O BeeAX já oferece:
