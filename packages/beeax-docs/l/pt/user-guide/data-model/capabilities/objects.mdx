---
title: Objetos
description: Saiba mais sobre objetos padrão e personalizados no BeeAX.
---
...
Objetos padrão são entidades predefinidas no seu espaço de trabalho para ajudar você a começar. Eles fazem parte de um modelo de dados compartilhado acessível a todos os usuários do BeeAX. Você pode usá-los como estão, personalizá-los ou desativá-los.
