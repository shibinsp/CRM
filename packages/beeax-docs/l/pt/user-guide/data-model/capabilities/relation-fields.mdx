...
As relações muitos-para-muitos utilizam um padrão de **objeto de junção**: um objeto intermediário que conecta ambos os lados. Com o recurso de relação de junção, BeeAX exibe diretamente os registros finais vinculados, ocultando o objeto intermediário da IU.
...
O BeeAX inclui relações pré-criadas entre objetos padrão:
