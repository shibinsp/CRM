...
description: Perguntas frequentes sobre o modelo de dados do BeeAX.
---
...
Você pode renomear o rótulo dos objetos padrão (Pessoas, Empresas, Oportunidades), mas não seus nomes de API. Os nomes de API são fixos para manter a consistência em todos os espaços de trabalho do BeeAX.
</Accordion>
