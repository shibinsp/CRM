...
A BeeAX usa um padrão de **objeto de junção** para relações muitos-para-muitos. Um objeto de junção fica entre dois objetos e mantém as conexões:
...
Ao ativar o alternador de relação de junção, a BeeAX exibe os registros vinculados diretamente em vez de mostrar os registros intermediários de junção.
