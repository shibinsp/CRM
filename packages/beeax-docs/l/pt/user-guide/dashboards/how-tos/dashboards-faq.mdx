...
description: Perguntas frequentes sobre painéis na BeeAX.
---

<AccordionGroup>
  <Accordion title="Posso criar painéis privados?">
    Não, os painéis atualmente são visíveis para todos que têm acesso ao seu espaço de trabalho da BeeAX. Painéis privados ainda não estão disponíveis.
  </Accordion>
  ...
  <Accordion title="Posso compartilhar painéis com usuários externos?">
    Não, compartilhar painéis com usuários fora do seu espaço de trabalho da BeeAX (usuários que não são da BeeAX) não é suportado no momento.
  </Accordion>
