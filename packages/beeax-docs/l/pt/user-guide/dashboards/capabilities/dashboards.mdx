...
Os painéis no BeeAX são organizados em uma hierarquia: **Painéis → Abas → Widgets**. Cada painel pode conter várias abas, e cada aba contém widgets (gráficos, números, iFrames).
...
Os painéis são visíveis para todos que têm acesso ao seu espaço de trabalho da BeeAX. No momento, não há opção de painel privado.
