---
title: Painéis
description: Aprenda o básico sobre relatórios e painéis no BeeAX.
---
...
Os painéis no BeeAX oferecem uma forma visual de acompanhar suas principais métricas de desempenho e obter insights dos seus dados de CRM.
...
<Note>
**Limitações atuais**:
* A exportação de painéis e o compartilhamento com usuários externos (usuários não-BeeAX) não estão disponíveis no momento.
