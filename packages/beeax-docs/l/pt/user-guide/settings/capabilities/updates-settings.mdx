...
description: Ative recursos de Acesso antecipado no BeeAX.
---
...
<Note>
Os recursos de Acesso antecipado podem mudar com base no feedback dos usuários. Seu feedback ajuda a melhorar o BeeAX!
</Note>

## Comentários sobre os recursos

Seu feedback ajuda a melhorar o BeeAX:
