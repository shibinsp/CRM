...
description: Perguntas frequentes sobre as configurações do BeeAX.
---
...
Para alterar seu endereço de e-mail, entre em contato pelo [contact@beeax.com](mailto:contact@beeax.com).
</Accordion>
...
* **Subdomínio**: Use um subdomínio do BeeAX como `yourcompany.beeax.com`
