...
description: Saiba mais sobre os planos de preços do BeeAX e como alternar entre eles.
---

## Visão Geral

O BeeAX oferece preços flexíveis para atender equipes de todos os tamanhos, quer você prefira hospedagem em nuvem ou auto-hospedagem.
...
Hospede o BeeAX na sua própria infraestrutura sem custo:
