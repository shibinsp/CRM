...
description: Perguntas frequentes sobre preços e faturação da BeeAX.
---

## Preços

<AccordionGroup>
<Accordion title="Posso usar a BeeAX gratuitamente enquanto hospedo por conta própria?">
Sim, você pode usar a BeeAX gratuitamente enquanto hospeda por conta própria. Você terá acesso a tudo incluído no plano Pro (Cloud), exceto o suporte da nossa equipe central. O suporte está acessível por meio da nossa comunidade no Discord.

Se você quiser hospedar por conta própria e precisar dos recursos Premium (SSO e permissões em nível de linha), pode escolher a licença paga Organization (Self-Hosted). Isso também inclui suporte da equipe da BeeAX e remove a exigência de publicar código personalizado como código aberto antes de distribuir.
</Accordion>
...
Não oferecemos assentos gratuitos. A precificação é por usuário e cada usuário precisa de uma licença para acessar a BeeAX.
</Accordion>
