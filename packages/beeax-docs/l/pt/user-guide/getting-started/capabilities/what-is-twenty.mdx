---
title: O que é BeeAX
description: O BeeAX é um CRM de código aberto que oferece os blocos de construção para criar exatamente o que a sua empresa precisa.
---
...
À primeira vista, o BeeAX parece como a maioria dos CRMs que você já conhece: você pode acompanhar negócios, organizar contatos, gerenciar tarefas e anotações.
...
O código aberto é a base da nossa abordagem, garantindo que o BeeAX evolua com sua comunidade, para sua comunidade.
...
[Registre-se aqui](https://app.beeax.com) ou [torne-se um colaborador no GitHub](https://github.com/beeax/beeax).
