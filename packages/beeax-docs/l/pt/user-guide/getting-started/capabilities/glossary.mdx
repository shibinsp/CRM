---
title: Glossário
description: Familiarize-se com a terminologia essencial usada no BeeAX.
---

## API

API (Interface de Programação de Aplicações) permite que você conecte o BeeAX com outros sistemas de software e construa integrações personalizadas.
...
Oportunidades no BeeAX CRM são potenciais negócios ou vendas com contas ou contatos.
...
Tarefas no BeeAX CRM são atividades atribuídas relacionadas a contatos, contas ou oportunidades.
...
Webhooks são mensagens automáticas enviadas do BeeAX a outras aplicações quando eventos específicos ocorrem, permitindo a sincronização de dados em tempo real.
...
Um `Espaço de Trabalho` normalmente representa uma empresa usando o BeeAX. Ele contém todos os registros e dados que você e os membros da sua equipe adicionam ao BeeAX.
...
Membros do Espaço de Trabalho são os usuários do BeeAX da sua equipe que têm acesso ao seu espaço de trabalho. Eles podem ser designados como proprietários ou responsáveis por registros.
