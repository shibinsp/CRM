...
O menu de comandos oferece **acesso rápido a ações** no BeeAX. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (BeeAX dá suporte a exclusões lógicas e permanentes)
