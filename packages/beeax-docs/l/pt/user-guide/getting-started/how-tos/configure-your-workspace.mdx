...
description: Cada empresa trabalha de maneira diferente. Comece com estas 3 etapas para adaptar o BeeAX às suas necessidades.
---

<Note>**Ganho Rápido**: Comece conectando sua caixa de correio. Isso lhe dá um valor imediato e ajuda sua equipe a ver o BeeAX em ação com dados reais. Você pode fazer isso em Configurações → Contas.</Note>

## 1. Personalize seu modelo de dados

O BeeAX oferece a flexibilidade que você precisa para moldar o modelo de dados que melhor dará suporte ao seu dia a dia.
...
Trazer seus dados existentes para o BeeAX dá à sua equipe contexto desde o início.

### Conecte sua caixa de correio

Se você não fez isso ao criar seu espaço de trabalho, conecte sua **conta do Google ou Microsoft** em Configurações → Contas. Isso permite que o BeeAX:
