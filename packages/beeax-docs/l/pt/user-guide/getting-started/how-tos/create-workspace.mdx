...
description: Siga um guia passo a passo sobre como se registrar na BeeAX, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro BeeAX](https://app.beeax.com).
...
Para dúvidas ou ajuda, conecte-se com a equipe de suporte dedicada em [contact@beeax.com](mailto:contact@beeax.com) ou envie uma mensagem no [Discord](https://discord.gg/cx5n4Jzs57).
