---
title: IA
description: Funcionalidades com IA chegando em breve ao BeeAX.
---
...
A BeeAX está desenvolvendo capacidades de IA para ajudar sua equipe a trabalhar de forma mais inteligente. Estamos nos concentrando em duas áreas principais:

### 1. Chatbot de IA

Um assistente conversacional que entende seu contexto e tem acesso a todos os seus dados do BeeAX.

**Principais capacidades:**

* **Acesso completo aos dados**: Consulte qualquer registro, relacionamento ou métrica no seu espaço de trabalho
* **Consciência do contexto da página**: Faça referência a "esta empresa" ou "esta oportunidade" com base em onde você está no BeeAX
...
* Siga nosso [GitHub](https://github.com/beeax/beeax) para atualizações de desenvolvimento
