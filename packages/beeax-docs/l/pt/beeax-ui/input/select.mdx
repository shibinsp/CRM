...
<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="Cabeçalho" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Opção A', Icon: IconBeeAXStar },
        { value: 'option2', label: 'Opção B', Icon: IconBeeAXStar },
      ]}
      value="option1"
    />
  );
