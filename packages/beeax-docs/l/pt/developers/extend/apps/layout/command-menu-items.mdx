...
Um **item de menu de comando** é a ponte entre o usuário e um [front component](/l/pt/developers/extend/apps/layout/front-components). Ele registra o componente no menu de comandos (Cmd+K) do BeeAX e, opcionalmente, como um botão fixado de ação rápida no canto superior direito da página.
