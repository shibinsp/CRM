...
<Note>
Se o Docker não estiver instalado ou em execução, a ferramenta de scaffolding informará o comando de inicialização correto para o seu sistema operacional. Quando o Docker estiver ativo, você pode retomar com `yarn beeax docker:start` — sem necessidade de recriar o scaffolding.
</Note>
...
| `yarn beeax dev --once --dry-run` | Compila e imprime as alterações de metadados **sem aplicá-las**.                                                                 | Inspecionar o que uma sincronização mudaria antes de confirmá-la.                |
