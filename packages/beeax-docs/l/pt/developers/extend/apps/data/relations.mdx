...
As relações conectam dois objetos entre si. No BeeAX, as relações são sempre **bidirecionais** — cada relação tem dois lados, e cada lado é declarado como um campo que faz referência ao outro.
