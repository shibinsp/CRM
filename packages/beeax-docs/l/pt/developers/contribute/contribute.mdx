---
title: Contribuir
description: Contribua para o desenvolvimento de código aberto do BeeAX.
---
...
O BeeAX é de código aberto e recebe contribuições da comunidade. Seja corrigindo bugs, adicionando funcionalidades ou aprimorando a documentação, suas contribuições ajudam a tornar o BeeAX melhor para todos.
