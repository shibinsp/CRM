...
info: Saiba como você pode colaborar com o Figma da BeeAX
---
...
1. **Acesse o link compartilhado:** Você pode acessar o arquivo do projeto no Figma [aqui](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/BeeAX).
...
Na barra lateral esquerda, você pode acessar as diferentes páginas do Figma da BeeAX. É assim que elas estão organizadas:
