...
As flags de recurso são usadas para ocultar recursos experimentais. Para a BeeAX, eles são definidos no nível do espaço de trabalho e não no nível do usuário.
