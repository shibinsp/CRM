...
* 프레디킷은 앱에서 소유한 오브젝트와 필드뿐만 아니라 BeeAX의 표준 오브젝트가 소유한 오브젝트와 필드를 참조할 수 있습니다.
...
* 동작 예제를 참조하세요: [`hello-world/src/roles/function-role.ts`](https://github.com/beeax/beeax/blob/main/packages/beeax-apps/hello-world/src/roles/function-role.ts).
