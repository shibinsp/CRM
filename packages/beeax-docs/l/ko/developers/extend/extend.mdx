---
title: 확장
description: API, 웹훅 및 맞춤형 앱으로 BeeAX의 기능을 확장하세요.
---
...
BeeAX는 확장 가능하도록 설계되었습니다. 당사의 API, 웹훅 및 앱 프레임워크를 사용하여 기존 도구와 통합하고 맞춤형 기능을 구축하세요.

## 가능한 작업

* **API**: REST 또는 GraphQL을 사용해 프로그래밍 방식으로 CRM 데이터를 쿼리하고 수정하세요
* **웹훅**: BeeAX에서 이벤트가 발생하면 실시간 알림을 받으세요
* **앱**: BeeAX의 기능을 확장하는 맞춤형 앱을 구축하세요

## 시작하기

<CardGroup cols={2}>
  <Card title="API" icon="코드" href="/l/ko/developers/extend/api">
    프로그래밍 방식으로 BeeAX에 연결하세요
  </Card>
