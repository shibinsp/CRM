---
title: 핵심 기능
description: 커스텀 데이터 모델부터 AI 기반 자동화까지, BeeAX로 할 수 있는 모든 것을 둘러보세요.
icon: 별
---

import { CardTitle } from "/snippets/card-title.mdx"

BeeAX는 완전한 기능을 갖춘 CRM 플랫폼입니다. 이를 통해 무엇을 구축할 수 있는지 살펴보세요.
...
<CardGroup cols={2}>
  ...
  <Card href="/l/ko/developers/self-host/self-host" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    단일 Docker Compose 명령으로 자체 인프라에서 BeeAX를 실행하세요.
