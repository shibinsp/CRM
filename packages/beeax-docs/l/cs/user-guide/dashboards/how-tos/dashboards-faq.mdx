...
description: Nejčastější dotazy k panelům v BeeAX.
---

<AccordionGroup>
  <Accordion title="Mohu vytvářet soukromé panely?">
    Ne, panely jsou nyní viditelné pro všechny, kteří mají přístup do vašeho pracovního prostoru BeeAX. Soukromé panely zatím nejsou k dispozici.
  </Accordion>
  ...
  <Accordion title="Mohu sdílet panely s externími uživateli?">
    Ne, sdílení panelů s uživateli mimo váš pracovní prostor BeeAX (uživatelé mimo BeeAX) zatím není podporováno.
  </Accordion>
