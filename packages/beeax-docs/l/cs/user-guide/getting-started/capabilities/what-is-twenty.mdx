---
title: Co je BeeAX
description: BeeAX je open-source CRM systém, který vám poskytuje stavební bloky k vytvoření přesně toho, co vaše firma potřebuje.
---
...
Zpočátku vypadá BeeAX jako většina CRM, které již znáte: můžete sledovat obchody, organizovat kontakty, řídit úkoly a poznámky.
...
Open-source je základ našeho přístupu, zajišťuje, že BeeAX se vyvíjí se svou komunitou, pro svou komunitu.
...
[Zaregistrujte se zde](https://app.beeax.com) nebo [připojte se jako přispěvatel na GitHub] (https://github.com/beeax/beeax).
