---
title: Glosář
description: Seznamte se se základní terminologií používanou v aplikaci BeeAX.
---

## API

API (rozhraní pro programování aplikací) umožňuje propojení BeeAX s dalšími softwarovými systémy a vytváření vlastních integrací.
...
Příležitosti v BeeAX CRM jsou potenciální obchody nebo prodeje s účty či kontakty.
...
Úkoly v BeeAX CRM jsou přiřazené aktivity týkající se kontaktů, účtů nebo příležitostí.
...
Webhooky jsou automatizované zprávy odesílané z BeeAX na jiné aplikace při výskytu specifických událostí, což umožňuje synchronizaci dat v reálném čase.
...
"Pracovní prostor" obvykle představuje společnost používající BeeAX. Obsahuje všechny záznamy a data, která vy a členové vašeho týmu do BeeAX přidáte.
...
Členové pracovního prostoru jsou uživatelé BeeAX z vašeho týmu, kteří mají přístup k vašemu pracovnímu prostoru. Mohou být u záznamů přiřazeni jako vlastníci nebo přiřazené osoby.
