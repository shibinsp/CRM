...
description: Sledujte podrobný návod, jak se zaregistrovat na BeeAX, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace BeeAX](https://app.beeax.com).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@beeax.com](mailto:contact@beeax.com) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
