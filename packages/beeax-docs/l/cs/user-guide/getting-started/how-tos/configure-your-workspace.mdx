...
description: Každý podnik funguje jinak. Začněte těmito 3 kroky, abyste přizpůsobili BeeAX svým potřebám.
---

<Note>**Rychlý úspěch**: Začněte připojením své poštovní schránky. To vám dává okamžitou hodnotu a pomáhá vašemu týmu vidět BeeAX v akci s reálnými daty. Můžete to udělat v Nastavení → Účty.</Note>

## 1. Přizpůsobte si svůj datový model

BeeAX nabízí flexibilitu, kterou potřebujete pro tvarování datového modelu, který nejlépe podpoří vaši každodenní práci.
...
Přinesení vašich stávajících dat do BeeAX dává vašemu týmu od začátku kontext.

### Připojte svou e-mailovou schránku

Pokud jste tak neučinili při vytváření svého pracovního prostoru, připojte svůj **Google nebo Microsoft účet** v Nastavení → Účty. To umožňuje BeeAX:
