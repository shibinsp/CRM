---
title: Orientace v prostředí BeeAX
...
Nabídka příkazů vám v BeeAX poskytuje **rychlý přístup k akcím**. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (BeeAX podporuje logické i trvalé mazání)
