...
description: Podrobný průvodce krok za krokem pro migraci vaší instance BeeAX hostované na vlastním serveru do BeeAX Cloud.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z instance BeeAX hostované na vlastním serveru do BeeAX Cloud. Proces zahrnuje zřízení vašeho cloudového pracovního prostoru, export dat a jejich opětovný import.
...
1. Přejděte na [app.beeax.com](https://app.beeax.com) a vytvořte nový pracovní prostor
...
U složitých migrací nebo velkých datových sad nás kontaktujte na [contact@beeax.com](mailto:contact@beeax.com) nebo si prohlédněte naše [Implementační služby](/l/cs/user-guide/getting-started/capabilities/implementation-services).
