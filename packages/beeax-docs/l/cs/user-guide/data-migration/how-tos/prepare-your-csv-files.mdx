...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do BeeAX.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který BeeAX očekává.
...
BeeAX vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v BeeAX existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v BeeAX)
...
* Musí být jedinečné v rámci vašeho souboru i v BeeAX
...
* **Odkazy / Štítek odkazu**: `BeeAX`
* **Odkazy / URL odkazu**: `https://beeax.com`
...
* **Volitelné**: BeeAX automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v BeeAX již existovat
...
## Krok 6: Ujistěte se, že pole v BeeAX existují
