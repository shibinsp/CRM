...
Po nahrání souboru a namapování sloupců BeeAX vaše data ověří:

1. **Proběhne validace** — BeeAX zkontroluje každý řádek na chyby
...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Duplicitní hodnoty zvýrazněné žlutě                                   | Hodnota již existuje v BeeAX nebo se ve vašem souboru vyskytuje dvakrát |
...
**Možnost 3: Nechte BeeAX aktualizovat existující záznam**
...
3. BeeAX aktualizuje existující záznam místo vytvoření duplicity
...
Pokud se shoduje alespoň jeden jedinečný identifikátor, BeeAX záznam aktualizuje.
</Note>
...
3. Zkontrolujte, zda záznamy v BeeAX již existují
...
To znamená, že v BeeAX neexistuje společnost s tímto konkrétním identifikátorem.
...
Pokoušíte se propojit se záznamem, který v BeeAX neexistuje.
...
Sloupec ve vašem souboru nelze namapovat, protože pole v BeeAX neexistuje.
...
1. **Uživatel nepřijal pozvánku** — uživatel zatím v BeeAX neexistuje
2. **Používáte uživatelské ID ze starého systému** — BeeAX nedokáže spárovat ID z jiného systému
3. **Nesprávný formát e-mailu** — e-mail neodpovídá účtu uživatele v BeeAX

### Jak to opravit

1. Ujistěte se, že všichni uživatelé **přijali svou pozvánku** do vašeho pracovního prostoru BeeAX
2. Použijte **e-mailovou adresu** uživatele (ne jeho jméno nebo ID ze starého systému)
3. Použijte stejný e-mail, jaký použili k připojení do BeeAX
...
<Check>Formát domény přesně odpovídá formátu BeeAX</Check>
...
1. **Stáhněte si ukázkový soubor** — uvidíte přesný formát, který BeeAX očekává
