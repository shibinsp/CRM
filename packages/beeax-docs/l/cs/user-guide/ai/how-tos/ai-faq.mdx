...
description: Často kladené otázky k funkcím AI v BeeAX.
---
...
<AccordionGroup>
  ...
  <Accordion title="Jaké možnosti AI jsou plánovány?">
    ...
    1. **AI Chatbot**: Asistent s kontextovým povědomím, který může přistupovat k vašim datům v BeeAX a pomůže vám s dotazy
  ...
  <Accordion title="Mohu používat vlastní modely AI?">
    Zpočátku bude BeeAX používat vestavěné modely AI. Podpora vlastních nebo externích modelů AI může být přidána v budoucích verzích na základě zpětné vazby od uživatelů.
  </Accordion>
