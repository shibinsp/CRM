...
<AccordionGroup>
<Accordion title="Jaké role jsou ve BeeAX ve výchozím nastavení?">
BeeAX ve výchozím stavu obsahuje role **Administrátor** a **Člen**. Můžete vytvářet další vlastní role podle potřeb vašeho týmu (např. obchodní zástupce, manažer, uživatel pouze pro čtení).
</Accordion>
...
Můžete řídit:
* **Odeslat e-mail**: Možnost odesílat e-maily z BeeAX
...
Při zřizování JIT se uživatelské účty v BeeAX vytvoří automaticky, když se někdo poprvé přihlásí přes SSO. Automaticky jim je přiřazena výchozí role.
</Accordion>
