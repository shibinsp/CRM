...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do BeeAX pomocí poskytovatele identity vaší organizace. To přináší:
...
* Administrátorský přístup k pracovnímu prostoru BeeAX

<Note>
**Pro uživatele vlastního hostování, kteří chtějí nastavit SSO**, obraťte se na contact@beeax.com
</Note>
...
* Odeberte je z pracovního prostoru BeeAX
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v BeeAX (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte BeeAX do svého pracovního postupu deprovisioningu
