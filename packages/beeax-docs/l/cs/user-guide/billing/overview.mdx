---
title: Fakturace
description: Seznamte se s cenami BeeAX a spravujte své předplatné.
---

BeeAX nabízí flexibilní cenové plány, které vyhoví potřebám vašeho týmu. Spravujte své předplatné, sledujte kredity pracovních postupů a přistupujte k fakturám — to vše v **Nastavení → Fakturace**.

## Co najdete v této sekci

<CardGroup cols={2}>
  <Card title="Cenové plány" icon="tags" href="/l/cs/user-guide/billing/capabilities/pricing-plans">
    Zjistěte více o cenových plánech BeeAX a o tom, co je zahrnuto.
  </Card>
...
| **Organizace (vlastní hosting)** | Vše z Pro + funkce Premium (SSO, oprávnění na úrovni řádků), podpora týmu BeeAX, není vyžadováno publikování vašeho vlastního kódu jako open-source před distribucí |
...
**Mohu používat BeeAX zdarma?**
Ano! Hostujte BeeAX sami a získejte všechny funkce Pro zdarma.
