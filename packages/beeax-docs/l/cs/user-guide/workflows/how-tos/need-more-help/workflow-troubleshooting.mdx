...
**Proč k tomu dochází**: BeeAX ukládá vše v reálném čase — neexistuje oddělený režim "edit" vs "read". Když vytvoříte záznam, ihned se uloží, což vyvolá událost "Record is created" dříve, než stihnete vyplnit další pole.
...
* Nejprve otestujte volání API mimo BeeAX
