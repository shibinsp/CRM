---
title: Přeneste produktová data do BeeAX
description: Synchronizujte data produktového katalogu z datového skladu do svého CRM podle plánu.
---

Použijte tento vzor k udržení synchronizace BeeAX s produktovými daty z vašeho datového skladu (např. Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Vytvořte nebo aktualizujte záznam v BeeAX
