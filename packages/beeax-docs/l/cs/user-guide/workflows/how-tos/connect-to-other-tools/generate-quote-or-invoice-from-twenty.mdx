---
title: Vytvořte nabídku nebo fakturu z BeeAX
...
* [Vygenerovat PDF z BeeAX](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — připojte vygenerované soubory PDF k záznamům
