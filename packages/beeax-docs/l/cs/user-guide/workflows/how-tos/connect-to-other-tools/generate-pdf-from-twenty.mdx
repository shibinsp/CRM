---
title: Vygenerovat PDF z BeeAX
description: Vytvořte pracovní postup pro generování a připojení PDF (například nabídky) k záznamu.
---

Automaticky vygenerujte nebo získejte PDF a připojte ho k záznamu v BeeAX. To se běžně používá k vytváření nabídek, faktur nebo reportů, které jsou propojené se společnostmi, příležitostmi nebo jinými objekty.
...
* [Vygenerujte nabídku nebo fakturu z BeeAX](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
