...
BeeAX obsahuje standardní objekty:
...
Každý podnik funguje jinak. Přizpůsobením datového modelu můžete přetvořit BeeAX podle **svých** procesů namísto toho, abyste své procesy nutili do rigidního systému.

BeeAX nabízí plnou flexibilitu:
...
Identifikujte hlavní pojmy, se kterými pracujete. BeeAX již poskytuje:
