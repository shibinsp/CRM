...
Vztahy typu mnoho-na-mnoho používají vzor zvaný **spojovací objekt**: zprostředkující objekt, který propojuje obě strany. S funkcí spojovacího vztahu zobrazuje BeeAX přímo výsledné propojené záznamy a zprostředkující objekt v UI skrývá.
...
BeeAX obsahuje předpřipravené relace mezi standardními objekty:
