---
title: Objekty
description: Zjistěte více o standardních a vlastních objektech v BeeAX.
---
...
Standardní objekty jsou předdefinované entity ve vašem pracovním prostoru, které vám pomáhají začít. Jsou součástí sdíleného datového modelu přístupného všem uživatelům BeeAX. Můžete je používat tak, jak jsou, přizpůsobit je nebo je deaktivovat.
