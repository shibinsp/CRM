...
Levý postranní panel je váš hlavní způsob, jak se v BeeAX orientovat. Je plně přizpůsobitelný — můžete jej přeuspořádat tak, aby odpovídal vašemu pracovnímu postupu, aniž byste museli otevřít jakoukoli stránku s nastavením.
