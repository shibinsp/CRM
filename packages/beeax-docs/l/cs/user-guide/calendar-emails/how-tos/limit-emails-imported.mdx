...
description: Ovládejte, které emaily se importují do BeeAX.
---

## Přehled

Ve výchozím nastavení BeeAX synchronizuje všechny externí emaily z vaší připojené poštovní schránky. Můžete omezit, co se importuje, pomocí **výběru složek** a **nastavení viditelnosti**.
