...
description: Porozumění funkcím e-mailové integrace v BeeAX.
---
...
BeeAX automaticky propojuje emaily z vašich připojených schránek s příslušnými CRM záznamy, udržuje historii komunikace na jednom místě.
...
BeeAX importuje e-maily rychlostí přibližně **400 zpráv za minutu**. Tato rychlost je v současnosti omezena omezením rychlosti Gmail API (a podobně to platí i pro další poskytovatele).
...
* **Chybějící emaily**: Zkontrolujte, zda:
  ...
  * Automatické vytváření kontaktů je deaktivováno (emaily potřebují existující záznamy BeeAX)
