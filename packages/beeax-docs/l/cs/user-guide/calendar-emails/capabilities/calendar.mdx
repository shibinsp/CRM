---
title: Kalendář
description: Přehled funkcí integrace kalendáře v BeeAX.
---
...
BeeAX automaticky synchronizuje vaše události v kalendáři a propojuje je s příslušnými záznamy v CRM, čímž poskytuje úplný přehled o historii vašich schůzek s kontakty a společnostmi.
