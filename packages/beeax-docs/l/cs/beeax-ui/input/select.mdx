...
<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="Hlavička" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Možnost A', Icon: IconBeeAXStar },
        { value: 'option2', label: 'Možnost B', Icon: IconBeeAXStar },
      ]}
      value="option1"
    />
  );
