...
* `objectUniversalIdentifier` identifikuje cílový objekt. Pro standardní objekty BeeAX importujte konstantu z `beeax-sdk`:
...
* Chcete-li přidat kartu ke standardnímu rozvržení stránky (např. na detailní stránku Task nebo Company), použijte [`definePageLayoutTab`](/l/cs/developers/extend/apps/layout/page-layouts#definepagelayouttab) s `STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS` z `beeax-sdk/define`.
