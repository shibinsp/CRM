---
title: Přispět
description: Přispějte k open-source vývoji BeeAX.
---
...
BeeAX je open-source a vítá příspěvky od komunity. Ať už opravujete chyby, přidáváte funkce nebo zlepšujete dokumentaci, vaše příspěvky pomáhají zlepšovat BeeAX pro všechny.
