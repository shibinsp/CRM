---
title: Práce s Figma
info: Zjistěte, jak můžete spolupracovat s Figmou BeeAX
---
...
1. **Přístup ke sdílenému odkazu:** K Figma souboru projektu můžete přistoupit [zde](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/BeeAX).
...
Na levém postranním panelu můžete přistupovat k různým stránkám Figmy společnosti BeeAX. Takto jsou organizovány:
