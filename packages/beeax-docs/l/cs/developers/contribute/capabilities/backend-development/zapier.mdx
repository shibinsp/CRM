...
Snadno synchronizujte BeeAX s více než 3000 aplikacemi pomocí [Zapier](https://zapier.com/). Automatizujte úkoly, zvyšte produktivitu a zlepšete vztahy se zákazníky!
...
Z adresáře `packages/beeax-zapier` spusťte:
