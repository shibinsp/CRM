...
لا يدعم BeeAX حقول الصيغ الأصلية بعد (قادمة في 2026)، لكن يمكنك تحقيق النتيجة نفسها باستخدام سير العمل. يتيح لك هذا الحل البديل حساب قيم الحقول وملؤها تلقائيًا — من عمليات الربط البسيطة إلى منطق الأعمال المعقّد.
