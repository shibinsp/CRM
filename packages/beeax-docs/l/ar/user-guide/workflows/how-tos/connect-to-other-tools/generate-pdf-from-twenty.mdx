---
title: إنشاء ملف PDF من BeeAX
description: أنشئ سير عمل لإنشاء ملف PDF (مثل عرض سعر) وإرفاقه بسجل.
---

أنشئ أو اجلب ملف PDF تلقائيًا وأرفقه بسجل في BeeAX. يُستخدم هذا عادةً لإنشاء عروض أسعار أو فواتير أو تقارير مرتبطة بالشركات أو الفرص أو كائنات أخرى.
...
* [إنشاء عرض سعر أو فاتورة من BeeAX](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
