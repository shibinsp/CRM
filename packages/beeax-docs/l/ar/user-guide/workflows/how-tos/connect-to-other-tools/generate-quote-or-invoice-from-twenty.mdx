---
title: إنشاء عرض سعر أو فاتورة من BeeAX
...
* [Generate a PDF from BeeAX](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — attach generated PDFs to records
