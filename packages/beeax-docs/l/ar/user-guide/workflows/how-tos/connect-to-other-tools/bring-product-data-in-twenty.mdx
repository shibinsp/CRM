---
title: جلب بيانات المنتج إلى BeeAX
description: زامِن بيانات كتالوج المنتجات من مستودع بيانات إلى نظام إدارة علاقات العملاء (CRM) لديك وفق جدول زمني.
---

استخدم هذا النمط للحفاظ على مزامنة BeeAX مع بيانات المنتجات من مستودع البيانات لديك (مثل Snowflake وBigQuery وPostgreSQL).
...
5. **Upsert Record**: أنشئ أو حدّث في BeeAX
