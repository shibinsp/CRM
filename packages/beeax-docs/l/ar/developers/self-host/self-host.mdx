...
description: قم بنشر BeeAX وإدارته على البنية التحتية الخاصة بك.
---

<Frame>
  <img src="/images/user-guide/what-is-beeax/20.png" alt="الذكاء الاصطناعي" />
</Frame>

## نظرة عامة

يمكن استضافة BeeAX ذاتيًا على البنية التحتية الخاصة بك، مما يمنحك تحكمًا كاملاً في بياناتك وعمليات النشر.
