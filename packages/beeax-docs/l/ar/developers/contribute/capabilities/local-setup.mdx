...
icon: laptop-code
description: الدليل للمساهمين (أو المطورين الفضوليين) الذين يرغبون في تشغيل BeeAX محلياً.
---
...
قبل أن تتمكن من تثبيت واستخدام BeeAX، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب BeeAX مخزن بيانات Redis لتقديم أفضل أداء.
...
## الخطوة الثامنة: استخدم BeeAX

**الواجهة الأمامية**

ستكون واجهة BeeAX الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم BeeAX متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
