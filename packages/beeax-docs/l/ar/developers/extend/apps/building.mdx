---
title: الهيكلية
description: كيف تعمل تطبيقات BeeAX — العزل، دورة الحياة، واللبنات الأساسية.
icon: sitemap
---
...
التطبيق عبارة عن مجموعة من **الكيانات** يتم إعلانها باستخدام دوال `defineEntity()` من حزمة `beeax-sdk`. يكتشف SDK هذه التصريحات عبر تحليل AST وقت البناء وينتج **ملف بيان** — وصفًا كاملًا لما يضيفه تطبيقك إلى مساحة العمل.
...
| **مكوّن أمامي**        | واجهة مستخدم React معزولة داخل صفحة BeeAX.            | [المكوّنات الأمامية](/l/ar/developers/extend/apps/front-components) |
...
* **`yarn beeax build`** — يجمّع TypeScript، ويضمّن الدوال المنطقية والمكوّنات الأمامية باستخدام esbuild، وينتج ملف بيان.
...
<CardGroup cols={٢}>
  ...
  <Card title="المكوّنات الأمامية" icon="window-maximize" href="/l/ar/developers/extend/apps/front-components">
    مكوّنات React معزولة داخل واجهة مستخدم BeeAX.
  </Card>
