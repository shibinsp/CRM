...
طبقة **الإعدادات (config layer)** لتطبيق BeeAX هي ما يصف التطبيق *للمنصة* — هويته، والأذونات التي يمتلكها، والكود الذي يعمل أثناء التثبيت أو الترقية. هذه التصريحات لا تضيف أشكال بيانات جديدة أو سلوكًا وقت التشغيل؛ بل تخبر BeeAX *من هو التطبيق* و*كيفية إعداده*.
