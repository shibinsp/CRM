...
**طبقة العمليات** هي كل ما تفعله *على* تطبيقك وليس *به*: استدعاء أوامر CLI، وتشغيل اختبارات التكامل على خادم BeeAX حقيقي، وإعداد CI، وإطلاق الإصدارات — إما كملف tarball يُنشر على خادم واحد أو كحزمة npm مُدرجة في المتجر.
...
<CardGroup cols={٢}>
  <Card title="CLI" icon="الطرفية" href="/l/ar/developers/extend/apps/operations/cli">
    مرجع `yarn beeax` — exec، logs، uninstall، remotes.
  </Card>
