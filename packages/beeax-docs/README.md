...
Official documentation for BeeAX CRM, powered by [Mintlify](https://mintlify.com).

## 🌐 Live Site

Visit the documentation at [docs.beeax.com](https://docs.beeax.com)

## 📚 Content

This repository contains:
- **User Guide** (46 pages) - Complete guide for BeeAX users
- **Developers** (24 pages) - Technical documentation for developers
- **BeeAX UI** (25 pages) - UI component library documentation
...
```bash
# From the beeax monorepo root
npx nx run beeax-docs:dev
```
...
1. Edit MDX files in the appropriate directory:
   ...
   - `beeax-ui/` - Component documentation
...
4. For each translated locale pulled from Crowdin, ensure a `packages/beeax-docs/l/<language>/navigation.json` file exists. These files contain **labels only**; page slugs always come from the base structure.
...
npx nx run beeax-docs:validate
```

## 🔗 Links

- [BeeAX Website](https://beeax.com)
- [GitHub Repository](https://github.com/beeax/beeax)
...
2. Make your changes in the `packages/beeax-docs` directory
3. Test locally with `npx nx run beeax-docs:dev`
4. Submit a pull request

## 📄 License

This documentation is part of the BeeAX project and is licensed under [AGPL-3.0](../../LICENSE).
