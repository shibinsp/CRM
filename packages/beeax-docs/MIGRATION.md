...
### Documentation Files
- **69 MDX files** copied from beeax-website to beeax-docs
...
3. Set subdirectory to `packages/beeax-docs`
4. Mintlify will auto-deploy and generate search embeddings

## Status

This migration has been completed. The legacy `packages/beeax-website` package
has been removed, and documentation now lives in `packages/beeax-docs`.
