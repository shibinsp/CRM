...
Single Sign-On (SSO) allows your team members to log into BeeAX using your organization's identity provider. This provides:
...
- Admin access to BeeAX workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@beeax.com
</Note>
...
- Remove them from the BeeAX workspace
...
- **Group mapping**: Map IdP groups to BeeAX roles (if available)
- **Offboarding process**: Include BeeAX in your deprovisioning workflow
