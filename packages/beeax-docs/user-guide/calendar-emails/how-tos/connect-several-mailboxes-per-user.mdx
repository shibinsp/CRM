...
BeeAX supports **unlimited email accounts per user**. This is useful if you manage multiple inboxes, such as:
...
Emails from all your connected mailboxes are synced to BeeAX and appear on:
