...
description: Control which emails are imported into BeeAX.
---

## Overview

By default, BeeAX syncs all external emails from your connected mailbox. You can limit what gets imported using **folder selection** and **visibility settings**.
