---
title: Can I Send Emails from BeeAX?
description: Information about sending emails directly from BeeAX.
---

## Current Status

BeeAX's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from BeeAX's interface.
...
While you can't send emails manually from BeeAX, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect BeeAX to a dedicated email marketing tool.
...
Native email composition from within BeeAX is on our roadmap. Join our [GitHub discussions](https://github.com/beeax/beeax/discussions) to share your use case and help prioritize this feature.
