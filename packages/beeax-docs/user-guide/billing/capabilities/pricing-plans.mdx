---
title: Pricing Plans
description: Learn about BeeAX's pricing plans and how to switch between them.
---

## Overview

BeeAX offers flexible pricing to fit teams of all sizes, whether you prefer cloud hosting or self-hosting.
...
### Free (Self-Hosted)
Host BeeAX on your own infrastructure at no cost:
