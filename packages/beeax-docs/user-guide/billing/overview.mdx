---
title: Billing
description: Understand BeeAX pricing and manage your subscription.
---

BeeAX offers flexible pricing plans to fit your team's needs. Manage your subscription, track workflow credits, and access invoices all from **Settings → Billing**.

## What's in this section

<CardGroup cols={2}>
  <Card title="Pricing Plans" icon="tags" href="/user-guide/billing/capabilities/pricing-plans">
    Learn about BeeAX's pricing plans and what's included.
  </Card>
...
| **Organization (Self-Hosted)** |All from Pro + the Premium features (SSO, row-level permissions), BeeAX team support, not required to publish your custom code as open-source before distributing |
...
**Can I use BeeAX for free?**
Yes! Self-host BeeAX and get all Pro features at no cost.
