...
The left sidebar is your primary way to move around BeeAX. It's fully customizable — you can reorganize it to match your workflow without touching any settings page.
