---
title: AI
description: AI-powered features coming soon to BeeAX.
---
...
BeeAX is building AI capabilities to help your team work smarter. We're focusing on two major areas:

### 1. AI Chatbot

A conversational assistant that understands your context and has access to all your BeeAX data.

**Key capabilities:**
- **Full data access**: Query any record, relationship, or metric in your workspace
- **Page context awareness**: Reference "this company" or "this opportunity" based on where you are in BeeAX
...
- Follow our [GitHub](https://github.com/beeax/beeax) for development updates
