...
description: When and how to use BeeAX's APIs for large-scale data imports.
---

## Overview

BeeAX provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
BeeAX enforces rate limits to ensure system stability:
...
- Verify formats match BeeAX's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in BeeAX
...
Contact us at [contact@beeax.com](mailto:contact@beeax.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
