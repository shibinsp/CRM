...
description: Step-by-step guide to migrate your BeeAX self-hosted instance to BeeAX Cloud.
---

## Overview

This guide walks you through migrating your data from a BeeAX self-hosted instance to BeeAX Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.beeax.com](https://app.beeax.com) and create a new workspace
...
For complex migrations or large datasets, contact us at [contact@beeax.com](mailto:contact@beeax.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
