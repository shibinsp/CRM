...
description: Complete step-by-step guide to format your data for import into BeeAX.
---
...
**This is the most important step.** The sample file shows you the exact column names and format BeeAX expects.
...
BeeAX enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in BeeAX
...
- Must be unique (no duplicates in file or in BeeAX)
...
- Must be unique within your file and in BeeAX
...
### ID Fields
- **Optional**: BeeAX auto-generates IDs if not provided
...
- The parent record must already exist in BeeAX
...
## Step 6: Ensure Fields Exist in BeeAX
