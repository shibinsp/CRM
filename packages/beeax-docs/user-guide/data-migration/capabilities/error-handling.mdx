...
After uploading your file and mapping fields, BeeAX validates your data **before** importing. This allows you to catch and fix errors without affecting your existing data.

## How It Works

1. **Upload** your CSV file
2. **Map** your columns to BeeAX fields
...
### Duplicate Values
**Cause**: A unique field (email, domain) already exists in BeeAX or appears twice in your file.
