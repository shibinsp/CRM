...
BeeAX supports importing relationships between objects during CSV import. This allows you to link records (e.g., attach People to Companies) as part of your data migration.
...
## How Relations Work in BeeAX

### One to Many / Many to One

BeeAX supports standard relations where one record links to many others:
...
Before importing the "many" side, the "one" side records must already exist in BeeAX.
...
4. BeeAX will automatically link each record to the matching parent
...
<Note>**Linking to Workspace Members**: When the relation points to Workspace Members (your team logging into BeeAX), reference them by their **email address**, not their name.</Note>
