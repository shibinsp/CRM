...
You want to tag a colleague in a note so they receive a notification to review it. Today, BeeAX doesn't support @mentions in notes or tasks.
...
<Note>
Replace `yourSubDomain` with your actual BeeAX workspace subdomain.
</Note>
