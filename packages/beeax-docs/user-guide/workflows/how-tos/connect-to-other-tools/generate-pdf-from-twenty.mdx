---
title: Generate a PDF from BeeAX
description: Create a workflow to generate and attach a PDF (such as a quote) to a record.
---

Automatically generate or fetch a PDF and attach it to a record in BeeAX. This is commonly used to create quotes, invoices, or reports that are linked to Companies, Opportunities, or other objects.
...
- [Generate a Quote or Invoice from BeeAX](/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax)
