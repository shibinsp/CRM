---
title: Bring Product Data into BeeAX
description: Sync product catalog data from a data warehouse into your CRM on a schedule.
---

Use this pattern to keep BeeAX in sync with product data from your data warehouse (e.g., Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Create or update in BeeAX
