---
title: Generate a Quote or Invoice from BeeAX
...
- [Generate a PDF from BeeAX](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax) — attach generated PDFs to records
