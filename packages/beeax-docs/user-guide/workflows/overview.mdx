---
title: Workflows
description: Learn how to build automations in BeeAX.
---

## Why Workflows Matter

BeeAX was built to bring maximum flexibility to its users. Rather than forcing you to adapt your business processes to rigid, pre-built features, workflows enable you to build automations that create the CRM that best supports your unique business use cases.

Workflows are BeeAX's in-app feature for building these automations. They give you the building blocks to create exactly what your business needs, when it needs it.
...
2. **Bring data in and out of BeeAX**: Connect BeeAX via API calls and webhooks to your database and other tools.
...
- **Form**: Get inputs from users within BeeAX UI at the time of execution
