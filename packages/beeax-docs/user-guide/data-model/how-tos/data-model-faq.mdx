...
description: Frequently asked questions about BeeAX's data model.
---
...
You can rename the label of standard objects (People, Companies, Opportunities), but not their API names. The API names are fixed for consistency across all BeeAX workspaces.
</Accordion>
