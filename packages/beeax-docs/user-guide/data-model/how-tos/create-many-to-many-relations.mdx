...
BeeAX uses a **junction object** pattern for many-to-many relations. A junction object sits between two objects and holds the connections:
...
When you enable the junction relation toggle, BeeAX displays linked records directly instead of showing the intermediate junction records.
