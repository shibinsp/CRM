...
Many-to-many relations use a **junction object** pattern: an intermediate object that connects both sides. With the junction relation feature, BeeAX displays the final linked records directly, hiding the intermediate object from the UI.
...
BeeAX comes with pre-built relations between standard objects:
