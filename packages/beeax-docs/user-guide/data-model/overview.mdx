...
BeeAX comes with standard objects:
...
Every business works differently. Customizing your data model means you can shape BeeAX around **your** processes instead of forcing yours into a rigid system.

BeeAX offers full flexibility:
...
Identify the main concepts you work with. BeeAX already provides:
