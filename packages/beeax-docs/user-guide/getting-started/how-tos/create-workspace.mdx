...
description: Follow a step-by-step guide on how to register on BeeAX, choose a subscription plan, and set up your account.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

## Step 1: Registration
1. Navigate to [BeeAX Sign Up](https://app.beeax.com).
...
## Support
For queries or help, connect with the dedicated support team at [contact@beeax.com](mailto:contact@beeax.com) or send a message on [Discord](https://discord.gg/cx5n4Jzs57).
