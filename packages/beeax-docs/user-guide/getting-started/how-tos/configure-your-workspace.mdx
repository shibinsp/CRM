...
description: "Every business works differently. Start with these 3 steps to shape BeeAX around your needs."
---

<Note>**Quick Win**: Start with connecting your mailbox. This gives you immediate value and helps your team see BeeAX in action with real data. You can do so under Settings → Accounts.</Note>

## 1. Customize your data model
BeeAX offers the flexibility you need to shape the data model that will best support your day-to-day.
...
Bringing your existing data into BeeAX gives your team context from the start.

### Connect your mailbox
If you have not done so when creating your workspace, connect your **Google or Microsoft account** under Settings → Accounts. This allows BeeAX to:
