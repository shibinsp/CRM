...
The command menu gives you **quick access to actions** in BeeAX. You can access it in two ways:
...
- Create new views
- Access deleted records (BeeAX supports soft and hard deletes)
