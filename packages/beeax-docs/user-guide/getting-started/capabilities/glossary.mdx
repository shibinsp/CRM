---
title: Glossary
description: Get familiar with essential terminology used in BeeAX.
---

## API
API (Application Programming Interface) allows you to connect BeeAX with other software systems and build custom integrations.
...
## Opportunities
Opportunities in BeeAX CRM are potential deals or sales with accounts or contacts.
...
## Tasks
Tasks in BeeAX CRM are assigned activities relating to contacts, accounts, or opportunities.
...
## Webhooks
Webhooks are automated messages sent from BeeAX to other applications when specific events occur, enabling real-time data synchronization.
...
## Workspace
A `Workspace` typically represents a company using BeeAX. It holds all the records and data that you and your team members add to BeeAX.
It has a single domain name, which is typically the domain name your company uses for employee email addresses.

## Workspace Members
Workspace Members are the BeeAX users from your team who have access to your workspace. They can be assigned as owners or assignees for records.
