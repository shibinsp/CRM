---
title: Dashboards
description: Learn the basics of reporting and dashboards in BeeAX.
---
...
Dashboards in BeeAX provide a visual way to track your key performance metrics and gain insights from your CRM data.
...
<Note>
**Current limitations**:
- Exporting dashboards and sharing with external users (non-BeeAX users) are not available at the moment.
