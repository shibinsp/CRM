...
description: Frequently asked questions about dashboards in BeeAX.
---

<AccordionGroup>
  <Accordion title="Can I create private dashboards?">
    No, dashboards are currently visible to everyone with access to your BeeAX workspace. Private dashboards are not yet available.
  </Accordion>
  ...
  <Accordion title="Can I share dashboards with external users?">
    No, sharing dashboards with users outside your BeeAX workspace (non-BeeAX users) is not currently supported.
  </Accordion>
