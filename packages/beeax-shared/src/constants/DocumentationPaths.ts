 ...
 *                              |___/
 *
 * This file is generated from packages/beeax-docs/navigation/base-structure.json
...
export const DOCUMENTATION_PATHS = {
  ...
  USER_GUIDE_CALENDAR_EMAILS_HOW_TOS_CAN_I_BOOK_MEETINGS_FROM_TWENTY:
    '/user-guide/calendar-emails/how-tos/can-i-book-meetings-from-beeax',
  USER_GUIDE_CALENDAR_EMAILS_HOW_TOS_CAN_I_SEND_EMAILS_FROM_TWENTY:
    '/user-guide/calendar-emails/how-tos/can-i-send-emails-from-beeax',
  ...
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_BRING_PRODUCT_DATA_IN_TWENTY:
    '/user-guide/workflows/how-tos/connect-to-other-tools/bring-product-data-in-beeax',
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_BRING_TYPEFORM_SUBMISSIONS_IN_TWENTY:
    '/user-guide/workflows/how-tos/connect-to-other-tools/bring-typeform-submissions-in-beeax',
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_GENERATE_PDF_FROM_TWENTY:
    '/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-beeax',
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_GENERATE_QUOTE_OR_INVOICE_FROM_TWENTY:
    '/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-beeax',
