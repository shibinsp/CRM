...
describe('buildSignedPath', () => {
  ...
  it('should ignore absolute https urls', () => {
    expect(
      buildSignedPath({
        path: 'https://beeax.github.io/placeholder-images/workspaces/beeax-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'https://beeax.github.io/placeholder-images/workspaces/beeax-logo.png',
    );
  });
  ...
  it('should ignore absolute http urls', () => {
    expect(
      buildSignedPath({
        path: 'http://beeax.github.io/placeholder-images/workspaces/beeax-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'http://beeax.github.io/placeholder-images/workspaces/beeax-logo.png',
    );
  });
});
