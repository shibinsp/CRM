...
import { type CommandConfirmationModalResult } from 'beeax-sdk/front-component';
...
// Must match COMMAND_MENU_ITEM_CONFIRMATION_MODAL_RESULT_BROWSER_EVENT_NAME in beeax-front
