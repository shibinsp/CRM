...
import { type FrontComponentExecutionContext } from 'beeax-sdk/front-component';
...
const rewriteSdkImports = (
  ...
  const specifierToBlobUrl: Record<string, string> = {
    'beeax-client-sdk/core': sdkClientUrls.core,
    'beeax-client-sdk/metadata': sdkClientUrls.metadata,
  };
