...
const TwentyUiComponent = () => {
  ...
  return (
    <ThemeProvider colorScheme="light">
      <div data-testid="beeax-ui-component" style={CARD_STYLE}>
        <H2Title
          title="BeeAX UI"
...
export default defineFrontComponent({
  ...
  name: 'beeax-ui-component',
  description: 'A front component using BeeAX UI remote components',
