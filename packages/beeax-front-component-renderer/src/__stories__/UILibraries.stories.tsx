...
const twentyUiTest: Story['play'] = async ({ canvasElement }) => {
  ...
  await canvas.findByTestId('beeax-ui-component', {}, { timeout: 30000 });
...
export const TwentyUiReact: Story = createComponentStory('beeax-ui-example', {
  play: twentyUiTest,
});
export const TwentyUiPreact: Story = createComponentStory('beeax-ui-example', {
  runtime: 'preact',
  play: twentyUiTest,
});
