...
import { getFrontComponentBuildPlugins } from 'beeax-sdk/front-component-renderer/build';
...
const twentyUiIndividualIndex = path.resolve(
  dirname,
  '../../../beeax-ui/dist/individual/individual-entry.js',
);

const sdkDefineIndex = path.resolve(
  dirname,
  '../../../beeax-sdk/dist/define/index.mjs',
);

const sdkFrontComponentIndex = path.resolve(
  dirname,
  '../../../beeax-sdk/dist/front-component/index.mjs',
);

const twentySharedIndividualDir = path.resolve(
  dirname,
  '../../../beeax-shared/dist/individual',
);
...
const storyAlias = {
  ...
  'beeax-sdk/define': sdkDefineIndex,
  'beeax-sdk/front-component': sdkFrontComponentIndex,
  'beeax-sdk/ui': twentyUiIndividualIndex,
  ...twentySharedAliases,
};
