...
const REQUIRED_REFERENCES = [
  ...
  'references/use-beeax-mcp/setup.md',
  'references/use-beeax-mcp/result-formatting.md',
];
...
const assertHowAppsWork = (fail) => {
  ...
  // use-beeax-mcp is intentionally excluded: it covers consuming the BeeAX MCP
