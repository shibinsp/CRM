...
const PUBLIC_DOCS_MCP_SERVER_NAME = 'beeax-docs';
const PUBLIC_DOCS_MCP_URL = 'https://docs.beeax.com/mcp';
...
const isAllowedDocumentationHost = (hostname) => {
  ...
  return (
    ...
    host === 'example.beeax.com' ||
    host === 'myworkspace.beeax.com' ||
    host === 'myworkspace.customdomain.com' ||
    host === 'your-beeax-server.com' ||
    host === 'app.beeax.com' ||
    host === 'beeax.com' ||
    host === 'docs.beeax.com' ||
    host === 'www.docker.com' ||
