...
Use this reference for BeeAX app views, navigation, page layouts, page layout tabs, and front component registration. Use `standalone-pages.md` when a page layout is meant to host a full-page custom UI.
...
- Keep list, board, and detail surfaces consistent with existing BeeAX patterns.
