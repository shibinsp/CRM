...
Use this reference for BeeAX app objects, fields, relations, roles, and permissions.
...
- Prefer generated app entity patterns from `yarn beeax dev:add`.
...
- Avoid duplicating data that already exists on core BeeAX objects.
