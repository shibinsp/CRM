...
const PACKAGE_TAG_MAP: Record<string, string[]> = {
  'beeax-front': ['scope:frontend'],
  'beeax-server': ['scope:backend'],
  'beeax-ui': ['scope:shared'],
  'beeax-shared': ['scope:shared'],
  'beeax-emails': ['scope:backend'],
  'beeax-sdk': ['scope:sdk', 'scope:shared'],
  'beeax-zapier': ['scope:zapier'],
  'beeax-oxlint-rules': ['scope:shared'],
  'beeax-docs': ['scope:docs'],
  'beeax-e2e-testing': ['scope:testing'],
  'create-beeax-app': ['scope:create-app'],
};
