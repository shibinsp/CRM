...
// stay in `beeax-sdk/define` — they are build-time metadata factories that
// the SDK CLI stubs out before bundling. Logic-function source files keep
// importing them from `beeax-sdk/define`, but should reach for *types* (and
// future runtime helpers) here, never directly from `beeax-shared/*`.
...
export type { RunAgentInput, RunAgentResult } from 'beeax-shared/application';
