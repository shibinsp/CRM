...
export const CONTAINER_NAME = 'beeax-app-dev';
export const TEST_CONTAINER_NAME = 'beeax-app-dev-test';
export const IMAGE = 'beeaxcrm/beeax-app-dev:latest';
...
export const getImageForVersion = (version = 'latest'): string => {
  ...
  return `beeaxcrm/beeax-app-dev:${tag}`;
};
