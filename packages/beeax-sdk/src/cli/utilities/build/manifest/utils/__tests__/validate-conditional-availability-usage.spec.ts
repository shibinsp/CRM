...
describe('validateConditionalAvailabilityUsage', () => {
  describe('valid usage', () => {
    it('should allow a variable inside a bare conditionalAvailabilityExpression', () => {
      const source = `
        import { defineCommandMenuItem } from 'beeax-sdk/define';
        import { objectMetadataItem } from 'beeax-sdk/define';
    ...
    it('should allow operators inside the expression', () => {
      const source = `
        import { defineCommandMenuItem } from 'beeax-sdk/define';
        import { objectPermissions, everyEquals } from 'beeax-sdk/define';
    ...
    it('should not flag same-named helpers imported from beeax-shared/utils', () => {
      const source = `
    ...
    it('should not flag Array.prototype.includes property access', () => {
      const source = `
        import { includes } from 'beeax-sdk/define';
        import { defineCommandMenuItem } from 'beeax-sdk/define';
    ...
    it('should trust files that define an expression (runtime placeholder is the backstop for in-file misuse)', () => {
      const source = `
        import { defineCommandMenuItem } from 'beeax-sdk/define';
        import { numberOfSelectedRecords } from 'beeax-sdk/define';
    ...
    it('should not flag a type-only import declaration', () => {
      const source = `
        import type { objectMetadataItem } from 'beeax-sdk/define';
  ...
  describe('invalid usage', () => {
    ...
    it('should flag an operator called at runtime', () => {
      const source = `
        import { isDefined } from 'beeax-sdk/define';
    ...
    it('should flag a variable imported from the beeax-sdk root entry', () => {
      const source = `
        import { objectMetadataItem } from 'beeax-sdk';
    ...
    it('should flag namespace-import runtime use with no expression', () => {
      const source = `
        import * as sdk from 'beeax-sdk/define';
