...
describe('extractDefineEntity', () => {
  it('should detect defineApplication in default export', () => {
    const fileContent = `
      import { defineApplication } from 'beeax-sdk/define';
  ...
  it('should detect defineField in default export', () => {
    const fileContent = `
      import { defineField } from 'beeax-sdk/define';
  ...
  it('should detect defineObject in default export', () => {
    const fileContent = `
      import { defineObject } from 'beeax-sdk/define';
  ...
  it('should detect defineRole in default export', () => {
    const fileContent = `
      import { defineRole } from 'beeax-sdk/define';
  ...
  it('should detect defineApplicationRole in default export', () => {
    const fileContent = `
      import { defineApplicationRole } from 'beeax-sdk/define';
  ...
  it('should not detect non-target function in default export', () => {
    const fileContent = `
      import { someOtherFunction } from 'beeax-sdk/define';
