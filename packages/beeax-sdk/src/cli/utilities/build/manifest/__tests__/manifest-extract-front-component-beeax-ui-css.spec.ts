...
describe('extractManifestFromFile - front component importing beeax-ui', () => {
  it('extracts the config from a front component that side-effect imports beeax-ui/style.css', async () => {
