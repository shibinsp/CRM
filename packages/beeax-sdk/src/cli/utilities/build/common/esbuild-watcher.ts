...
import { createStubTwentySdkDefinePlugin } from '@/cli/utilities/build/common/plugins/stub-beeax-sdk-define.plugin';
import {
...
import { NODE_ESM_CJS_BANNER, OUTPUT_DIR } from 'beeax-shared/application';
import { FileFolder } from 'beeax-shared/types';

export const LOGIC_FUNCTION_EXTERNAL_MODULES: string[] = [
  'beeax-client-sdk/core',
  'beeax-client-sdk/metadata',
  'path',
  'fs',
  'crypto',
  'stream',
