...
} from '@/cli/utilities/build/common/plugins/stub-beeax-sdk-define.plugin';

describe('stub-beeax-sdk-define plugin', () => {
  ...
  it('classifies every beeax-sdk/define value-export', () => {
