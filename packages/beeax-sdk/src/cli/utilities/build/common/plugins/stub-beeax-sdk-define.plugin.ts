...
// Everything in beeax-sdk/define is build-time metadata for the manifest
// extractor and is dead code in the user-app bundle. Stubbing it drops zod,
// beeax-shared and ~1MB per logic-function bundle.
//
...
const VIRTUAL_NAMESPACE = 'beeax-sdk-define-stub';
const STUB_RESOLVED_PATH = '__beeax-sdk-define-stub__';

const STUB_PRELUDE = `
// Auto-generated stub for beeax-sdk/define injected by the SDK CLI build.
// Real implementations would pull in zod, beeax-shared and ~1MB of code; at
...
export const createStubTwentySdkDefinePlugin = (): esbuild.Plugin => ({
  name: 'beeax-sdk-define-stub',
  setup(build) {
    build.onResolve({ filter: /^beeax-sdk\/define$/ }, () => ({
