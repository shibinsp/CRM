...
import { getImageAbsoluteURI } from 'beeax-shared/utils';
...
export const SendInviteLinkEmail = ({
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      <Title value={i18n._('Join your team on BeeAX')} />
      <MainText>
        <Trans
