...
// before the date if BeeAX is not the right fit. This is intentionally not a dark pattern.
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      ...
      <MainText>
        ...
        <br />
        <br />
        <Trans id="If BeeAX is working for you, you're all set — there's nothing to do. If it's not the right fit, you can cancel in one click before then and you won't be charged." />
      </MainText>
      <br />
      <CallToAction
