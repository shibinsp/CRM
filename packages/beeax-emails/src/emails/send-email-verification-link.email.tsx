...
export const SendEmailVerificationLinkEmail = ({
  ...
  const bodyId = isEmailUpdate
    ? 'We received a request to change the email address associated with your BeeAX account. Click below to confirm this change.'
    : 'Thanks for registering for an account on BeeAX! Before we get started, we just need to confirm that this is you. Click below to verify your email address.';
...
SendEmailVerificationLinkEmail.PreviewProps = {
  link: 'https://app.beeax.com/verify-email/123',
  locale: 'en',
  isEmailUpdate: false,
};
