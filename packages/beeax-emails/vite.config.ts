...
import { APP_LOCALES } from 'beeax-shared/translations';
import { defineConfig, type Plugin } from 'vite';

// beeax-emails bundles its deps (the Node server that consumes it doesn't have
...
export default defineConfig({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/packages/beeax-emails',
