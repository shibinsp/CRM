# Contributing to BeeAX

Thanks for considering contributing to BeeAX!

Please make sure to go through the [documentation](https://docs.beeax.com) before.
...
```shell
git clone https://github.com/yourusername/beeax.git
cd beeax
```
...
4. **Make Changes:** Make your desired changes and ensure that your code adheres to BeeAX's coding standards.
...
8. **Create a Pull Request:** Go to the original BeeAX repository and create a pull request. Please provide a detailed description of your changes. Submitting a PR means you agree to the CLA.
...
If you face any issues or have suggestions, please feel free to [create an issue on BeeAX's GitHub repository](https://github.com/beeax/beeax/issues/new). Please provide as much detail as possible.
