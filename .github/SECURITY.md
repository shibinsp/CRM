...
- Contact the team at `security at beeax.com`.
- Include a comprehensive description of the potential vulnerability and steps to reproduce the issue, if possible. The more information you can provide, the quicker BeeAX can address the problem.
...
While BeeAX doesn't have a formal bug bounty program right now due to the project's nascent stage, rest assured that:
...
- Your contribution is greatly appreciated, and BeeAX would acknowledge your role in the vulnerability fix, if you opt for identification.
- BeeAX will grant you permission to publicly discuss your findings once users have had a reasonable time to apply the patch after it becomes available.
- BeeAX guarantees not to pursue any legal action as long as the vulnerability is not exploited.
